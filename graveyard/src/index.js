  ...
  [
    ...
    [
      ...
      (context, primitive) =>
        ...
        global_Reflect_apply(global_RegExp_prototype_test, /^[a-z]+$/, [
          primitive,
        ]),
    ],
  ],
...
const get_advice_extractor = (
  context,
  node,
  expression1,
  expression2,
  expressions,
) => Tree.extract(null, expressions[1], "primitive", primitive_extractor);
...
const unmangle_instrument_options = {
  ...
  identifier: (identifier, _type) => (
    (_type = Variable.IsMeta(identifier)
      ? // console.assert(Variable.IsBase(Variable.GetBody(identifier)))
        "deadzone"
      : Variable.IsBase(identifier)
      ? Variable.IsMeta(Variable.GetBody(identifier))
        ? "meta"
        : "base"
      : "input"),
    {
      ...
      name:
        _type === "input"
          ? null
          : Variable.GetBody(Variable.GetBody(identifier)),
    }
  ),
};
...
const prototype = {
  ...
  weave(input, options, _serials) {
    return (
      ...
      this.generate(
        this.instrument(
          this.transpile(
            typeof input === "string" ? this.parse(input, options) : input,
            global_Object_assign(
              {
                __proto__: null,
                serials: _serials,
  ...
  IntrinsicExpression: {
    ...
    ObjectExpression: {
      ...
      ["aran.deadzoneMarker"]: Symbol("deadzone-placeholder"),
      ["aran.asynchronousGeneratorPrototype"]: Reflect.getPrototypeOf(
        /* istanbul ignore next */ async function* () {}.prototype,
      ),
      ["aran.generatorPrototype"]: Reflect.getPrototypeOf(
      ...
      ["Function.prototype.arguments@get"]: Reflect.getOwnPropertyDescriptor(
        Function["prototype"],
        "arguments",
      ).get,
      ["Function.prototype.arguments@set"]: Reflect.getOwnPropertyDescriptor(
        Function["prototype"],
        "arguments",
      ).set,
          ...
          expression: {
            ...
            properties: [
              ...
              },
              {
                ...
                value: {
                  ...
                  arguments: [
                    {
                      type: "Literal",
                      value: "deadzone-placeholder",
                      raw: '"deadzone-placeholder"',
                    },
                  ],
                  optional: false,
                },
              ...
              },
              {
                ...
                key: {
                  type: "Literal",
                  value: "aran.asynchronousGeneratorPrototype",
                  raw: '"aran.asynchronousGeneratorPrototype"',
                },
                value: {
                  type: "CallExpression",
                  callee: {
              ...
              },
              {
                ...
                key: {
                  type: "Literal",
                  value: "aran.generatorPrototype",
                  raw: '"aran.generatorPrototype"',
                },
                value: {
                  type: "CallExpression",
                  callee: {
  ...
  UnaryExpression: {
    ...
    ClosureExpression: (operator, argument) => {
      switch (operator) {
        case "-":
          return -argument;
        case "+":
  ...
  BinaryExpression: {
    ...
    ClosureExpression: (operator, argument1, argument2) => {
      switch (operator) {
        case "==":
  ...
  ObjectExpression: {
    __proto__: null,
    ClosureExpression: (prototype, entries) => {
      ...
      return prototype === null
        ? object
        : Object.assign({ __proto__: prototype }, object);
    },
    script:
