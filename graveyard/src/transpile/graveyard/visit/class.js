...
exports.visitClass = (scope, node, context) => (
  ...
  (context = global_Object_assign({ name: null }, context)),
          ...
          Tree.SequenceExpression(
            Tree.ConditionalExpression(
              ...
              Intrinsic.makeConstructExpression(
                ...
                Intrinsic.makeObjectExpression(Tree.PrimitiveExpression(null), [
                  [
...
const stage2 = (scope, node, sort, super_constructor_box, name_nullable_box) =>
  Scope.makeBoxExpression(
    scope,
    false,
    "ClassPrototype",
      ...
      Scope.makeBoxExpression(
        ...
        (super_box) =>
          Scope.makeBoxExpression(
            ...
            false,
            "ClassConstructor",
            ArrayLite.some(node.body.body, is_constructor_method)
              ? Visit.visitClosure(
                  scope,
                  ArrayLite.find(node.body.body, is_constructor_method).value,
                  {
                    sort,
                    super: super_box,
                                  ...
                                  Tree.CompletionStatement(
                                    Tree.ConditionalExpression(
                                      ...
                                      Intrinsic.makeThrowTypeErrorExpression(
                                        "Generated closure must be invoked as a constructor",
                                      ),
                                    ),
                                  ),
                              ),
