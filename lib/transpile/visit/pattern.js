...
const sequence = (kind, node1, node2) => (
  ...
  Tree.ListStatement([node1, node2]));

const boxify = (kind, scope, writable, identifier, expression, callback) => Scope[kind === null ? "makeBoxExpression" : "makeBoxStatement"](
  scope,
  writable,
  identifier,
  expression,
                      ...
                      [
                        ...
                        Tree.ClosureExpression(
                          ...
                          Scope.makeHeadClosureBlock(
                            ...
                            (scope) => Scope.makeOpenExpression(scope, iterator_box)))]])) :
                Intrinsic.makeGetExpression(
                  Tree.ApplyExpression(
                    Intrinsic.makeGetExpression(
                      Scope.makeOpenExpression(scope, iterator_box),
