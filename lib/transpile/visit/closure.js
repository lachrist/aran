              ...
              Scope.Initialize(
                ...
                (
                  ...
                  (
                    ...
                    Scope.input(scope, "new.target")))) :
                Tree.BundleStatement([])), // console.assert(context.sort === "function")
            (
              _has_this ?
              Scope.Initialize(
                scope,
            ...
            (
              ...
              Scope.Box(
                ...
                Intrinsic.construct_object(
                  Tree.PrimitiveExpression(null),
                  []),
                (marker_box) => Tree.BundleStatement(
                    [
                      Scope.Box(
                        scope,
                        false,
                        ...
                        Intrinsic.get(
                          ...
                          Tree.PrimitiveExpression("length"),
                          null),
                        (length_box) => Tree.BundleStatement(
                          ArrayLite.map(
                                      ...
                                      (target_box) => Scope.Box(
                                        ...
                                        (key_box) => Scope.Box(
                                          ...
                                          (new_descriptor_box) => Scope.Box(
                                            ...
                                            (old_descriptor_box) => Tree.ReturnStatement(
                                      ...
                                      (target_box) => Scope.Box(
                                        ...
                                        (key_box) => Scope.Box(
                                          ...
                                          Intrinsic.get_own_property_descriptor(
                                            Scope.get(scope, target_box),
                                            Scope.get(scope, key_box)),
                                          (descriptor_box) => Tree.BundleStatement(
                                            [
                                              Tree.ExpressionStatement(
                                                Tree.ConditionalExpression(
                                                  Tree.BinaryExpression(
                                      ...
                                      (target_box) => Scope.Box(
                                        ...
                                        (key_box) => Scope.Box(
                                          ...
                                          (receiver_box) => Scope.Box(
                                            ...
                                            (value_box) => Tree.ReturnStatement(
                                              Tree.ConditionalExpression(
                                                Tree.BinaryExpression(
                                                  "===",
