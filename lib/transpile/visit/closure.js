  ...
  (
                ...
                Intrinsic.define_property(
                  Intrinsic.define_property(
                    ...
                    (
                      ...
                      {
                        __proto__: null,
                        get: Intrinsic.grab("Function.prototype.arguments@get"),
                        set: Intrinsic.grab("Function.prototype.arguments@set"),
                        enumerable: false,
                        configurable: false} :
                      {
                        __proto__: null,
                                                            ...
                                                            Tree.sequence(
                                                              ArrayLite.reduce(
                                                                ...
                                                                (expression, pattern, index) => Tree.conditional(
                                                                  ...
                                                                  expression),
                                                                Tree.throw(
                                                                  Tree.primitive("Arguments link marker out of bounds (defineProperty-write), this should never happen please consider submitting a bug report"))),
                                                              Tree.conditional(
                                                                Tree.conditional(
                                                                  Intrinsic.get_own_property_descriptor(
                                                                    Scope.get(scope, new_descriptor_box),
                                                                  ...
                                                                  [
                                                                    ...
                                                                    ArrayLite.reduce(
                                                                      ...
                                                                      (expression, pattern, index) => Tree.conditional(
                                                                        ...
                                                                        expression),
                                                                      Tree.throw(
                                                                        Tree.primitive("Arguments link marker out of bounds (defineProperty-read), this should never happen please consider submitting a bug report")))]]))))))))]))))))))],
                              [
    ...
    _expression = (
      ...
      Intrinsic.define_property(
        ...
        {
          __proto__: null,
          value: Intrinsic.construct_object(
            (
              node.async ?
              Intrinsic.grab("aran.asynchronousGeneratorPrototype") :
              Intrinsic.grab("aran.generatorPrototype")),
            []),
          writable: true,
          enumerable: false,
          configurable: false},
