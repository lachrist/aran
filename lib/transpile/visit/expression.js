...
exports.member = (scope, node, context) => (
  ...
  context = global_Object_assign({normal:null, super:null}, context),
  (
  ...
  (
    (closure) => (
      ...
      Visit.member(
        ...
        node.tag,
        {
          normal: (box, expression) => Tree.apply(
            expression,
            Scope.get(scope, box),
            closure()),
          super: (expression) => Scope.super(
            scope,
            expression,
            closure())}) :
      Tree.apply(
...
visitors.MemberExpression = (scope, node, context) => Visit.member(
  ...
  {
    normal: second,
    super: (expression) => Scope.super(scope, expression, null)});
