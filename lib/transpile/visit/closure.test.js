  ...
  require("./closure.js"),
  {
    visitExpression: (scope, node, context) => {
      ...
      if (node.type === "CallExpression") {
        ...
        return Scope.makeEvalExpression(scope, Visit.visitExpression(scope, node.arguments[0], null));
      }
      Assert.fail("Unexpected expression");
    },
    visitClosureBody: (scope, node, context) => (
      ...
      (
        ...
        Scope.makeBodyClosureBlock(
          ...
          (
            ...
            ArrayLite.some(node.body, Query.hasDirectEvalCall)),
                  ...
                  (node) => (
                    ...
                    (
                      ...
                      Visit.visitPattern(
                        ...
                        {
                          kind: node.kind,
                          expression: Visit.visitExpression(scope, node.declarations[0].init, null)}) :
      ...
      #Object.defineProperty(
        #Object.defineProperty(
          arrow () {
            ...
            $$x = (
              ($_assignment === void 0) ?
              eval §$_head_frame §$$x §$_assignment "yolo" :
              $_assignment);
            {
              let $_body_frame;
              $_body_frame = {__proto__:null};
              eval §$_body_frame §$_head_frame §$$x §$_assignment "swag" ;
              completion void 0; }
            completion void 0; },
          "length",
          {
          ...
          "constructor",
          {
            ...
            value: #Object.defineProperty(
              #Object.defineProperty(
                #Object.defineProperty(
                  constructor () {
                    let $$arguments, $$super, $$this, $$0newtarget;
                    $$super = "SUPER";
                    $$0newtarget = (
          ...
          #Object.defineProperty(
            ${asynchronous ? "async " : ""} function* () {
                  ...
                  configurable: true});
              {
                123;
                completion void 0; }
              completion ($$0newtarget ? $$this : void 0); },
            "length",
            {
              __proto__: null,
              value: 0,
  ...
  success(
    ...
    `
      #Object.defineProperty(
        #Object.defineProperty(
          method () {
            let $$f, $$arguments, $$super, $$this, $$0newtarget, $$x, $_binding_1, $_binding_2;
            $$f = void 0;
            $$super = "SUPER";
            $$0newtarget = void 0;
              ...
              #Object.defineProperty(
                #Object.defineProperty(
                  #Object.defineProperty(
                    #Object.defineProperty(
                      function () {
                        let $$arguments, $$this, $$0newtarget, $$x, $_marker, $_length;
                        $$0newtarget = #Reflect.get(input, "new.target");
                        $$this = (
                          #Reflect.get(input, "new.target")  ?
                          {__proto__: #Reflect.get(#Reflect.get(input, "new.target"), "prototype")} :
                        ...
                        $$arguments = new #Proxy(
                          $$arguments,
                          {
                            ...
                            defineProperty: arrow () {
                              ...
                              completion #Reflect.defineProperty(
                                target,
                                key,
                                (
