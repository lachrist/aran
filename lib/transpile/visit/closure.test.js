...
const success = (strict, context, code1, code2) => Lang._match(
  Visit.closure(
    (
      strict ?
      Scope._use_strict(
...
const success_block = (strict, context, code1, code2) => Lang._match(
  Scope.MODULE(
    (
      strict ?
      Scope._use_strict(
...
State._run_session({nodes:[], serials:new Map(), scopes:{__proto__:null}}, () => {
  ...
  success(
    ...
    {
      sort: "arrow",
      name: Scope._primitive_box("NAME")},
    `(() => { "use strict"; eval("qux"); });`,
    `
      #Object.defineProperty(
        #Object.defineProperty(
  ...
  success(
    true,
    {
      sort: "constructor",
      name: Scope._primitive_box("NAME"),
      super: Scope._primitive_box("SUPER"),
      prototype: Scope._primitive_box("PROTOTYPE")},
    `(function () { 123; });`,
    `
      #Reflect.get(
        #Object.defineProperty(
                            ...
                            defineProperty: arrow () {
                              ...
                              return (
                                (
                                        ...
                                        (
                                          (
                                            ...
                                            (
                                              (key === "0") ?
                                              $$x = #Reflect.get(new_descriptor, "value") :
                                              throw "Arguments link marker out of bounds (defineProperty), this should never happen please consider submitting a bug report")),
                                          (
                                            #Reflect.get(new_descriptor, "writable") ?
                                            (
                                              #Reflect.get(new_descriptor, "enumerable") ?
                                              #Reflect.get(new_descriptor, "configurable") :
                                              false) :
                                            false)) :
                                        false) :
                                      false) :
                                  ...
                                  false) ?
                                true :
                                #Reflect.defineProperty(target, key, new_descriptor)); },
