...
exports._get_pattern_identifier_array = collect;
...
exports._get_shallow_hoisting = shallow_hoisting;
...
// type Node = estree.BlockStatement | estree.Program
exports._get_deep_hoisting = deep_hoisting;

//////////////////////////////
// Exports._populateExportLink //
//////////////////////////////

exports._completeExportLinks = (node, variables) => (
  node.type === "ExportNamedDeclaration" &&
  node.source === null &&
  ArrayLite.forEach(
    node.specifiers,
