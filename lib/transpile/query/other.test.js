...
Assert.deepEqual(Other.hasUseStrictDirective(ParseExternal(`
  "foo";
  "bar";
  "use strict";
...
Other.getValuation(ParseExternal(`let x = 1;`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`debugger;`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`function f () {}`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`;`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`class C {};`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`123;`, {source:"module"}).body[0], true);
Other.getValuation(ParseExternal(`{; 123; }`, {source:"module"}).body[0], true);
Other.getValuation(ParseExternal(`{;;}`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`l: break l;`, {source:"module"}).body[0].body, "l");
Other.getValuation(ParseExternal(`l: break l;`, {source:"module"}).body[0], false);
Other.getValuation(ParseExternal(`l: k : break l;`, {source:"module"}).body[0].body, "l");
Other.getValuation(ParseExternal(`while (123) break;`, {source:"module"}).body[0].body, null);
