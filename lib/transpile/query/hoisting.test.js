...
///////////////////////////////////
// getPatternIdentifierArray //
///////////////////////////////////

{
  const test = (code, identifiers) => Assert.deepEqual(
    Hoisting.getPatternIdentifierArray(
...
/////////////////////////////
// getParameterHoisting //
/////////////////////////////

  Assert.deepEqual(
    Hoisting.getParameterHoisting(
      {
        type: "Identifier",
        name: "x"}),
    [
...

{
  const test = (code, variables, _nodes, _variables) => (
    ...
    _variables = ArrayLite.flatMap(_nodes, Hoisting.getShallowHoisting),
    ArrayLite.forEach(_nodes, (node) => Hoisting.setVariableExports(node, _variables)),
  ...
  test(
    ...
    [
      ...
      {kind:"import", name:"import1", ghost:true, exports:["import1", "import1_spc"], import:"default", source:"source1"},
      {kind:"import", name:"import2", ghost:true, exports:[], import:"key1", source:"source2"},
      {kind:"import", name:"import3", ghost:true, exports:[], import:"key2", source:"source2"},
      {kind:"import", name:"import4", ghost:true, exports:[], import:"default", source:"source2"},
      {kind:"import", name:"import5", ghost:true, exports:[], import:null, source:"source3"},
...

{
  const test = (code, variables, _nodes, _variables) => (
    _nodes = ParseExternal(code, {source:"module"}).body,
    _variables = ArrayLite.flatMap(_nodes, Hoisting.getDeepHoisting),
    ArrayLite.forEach(_nodes, (node) => Hoisting.setVariableExports(node, _variables)),
    Assert.deepEqual(_variables, variables));
  test(
    `
