  ...
  () => {
    ...
    Lang.match(
      Core.makeBlock(
        ...
        (scope) => (
          Assert.deepEqual(
            Core.declareStatic(scope, "identifier1", false, "data1"),
            void 0),
          Assert.deepEqual(
            Core.declareStatic(scope, "identifier2", false, "data2"),
            void 0),
          Tree.CompletionStatement(
    ...
    Lang.match(
      Core.makeBlock(
        ...
        (scope) => (
          Assert.deepEqual(
            Core.declareStatic(scope, "identifier", true, "data"),
            void 0),
          Assert.deepEqual(
            ...
            Tree.BranchStatement(
              Tree.Branch(
                ...
                Core.makeEmptyBlock(
                  ...
                  (scope) => (
                    Assert.deepEqual(
                      Core.declareStatic(scope, "identifier", false, "data"),
                      void 0),
                    Assert.deepEqual(
                      Core.getStaticData(scope, "identifier"),
                      "data"),
...
visitor(
  {type:"Program", body:[]},
  {locations:[], serials:new global.Map(), annotations: new global.Map()},
  "context");
