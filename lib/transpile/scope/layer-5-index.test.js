        ...
        [
          (
            Assert.throws(
              () => Scope.super(
                ...
                Tree.primitive("foo"),
                null),
              new global.Error("Super identifier in deadzone")),
            Tree.Lift(
              Scope.initialize(
                scope,
                "const",
          ...
          Tree.Lift(
            Scope.super(
              scope,
              Tree.primitive("KEY3"),
              Tree.primitive("ARGUMENTS3")))])),
    Lang.PARSE_BLOCK(`{
      let _this, $this, $super, $0newtarget;
      $super = "SUPER";
      $this = "THIS";
      $0newtarget = "NEW_TARGET";
      (
      ...
      (
        $this ?
        (
          _this = #Reflect.getPrototypeOf(
            #Reflect.get($super, "prototype")),
          #Reflect.apply(
            #Reflect.get(_this, "KEY3"),
            _this,
            "ARGUMENTS3")) :
        throw new #ReferenceError("Super constructor must be called before accessing super property")); }`),
    Assert);
