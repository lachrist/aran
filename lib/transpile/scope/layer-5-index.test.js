...
State._run_session(state, () => {
  ...
  Lang._match_block(
    Scope.MODULE(
      Scope._make_root(),
      [
        {kind: "var", ghost:false, name: "VAR", specifiers:[]},
        {kind: "function", ghost:false, name:"FUNCTION", specifiers:[]},
        {kind: "let", ghost:false, name: "LET", specifiers:[]},
        {kind: "const", ghost:false, name: "CONST", specifiers:[]},
        {kind: "class", ghost:false, name: "CLASS", specifiers:[]},
        {kind: "import", ghost:false, name: "IMPORT", specifiers:[]}],
      (scope) => (
        Assert.deepEqual(
  ...
  Lang._match_block(
    Scope.MODULE(
      Scope._make_root(),
      [
        {kind:"let", ghost:false, name:"x", specifiers:[]}],
      (scope) => Tree.Lone(
        [],
        Scope.CASE(
          scope,
      ...
      () => Scope.MODULE(
        ...
        (scope) => Tree.Lone(
          ...
          Scope.BLOCK(
            scope,
            [
              {kind:kind, ghost:false, name:"foo", specifiers:[]}],
            (scope) => Assert.fail()))),
      new global.Error("Invalid variable")));
  Lang._match_block(
    Scope.MODULE(
          ...
          (scope) => Scope.Box(
            ...
            (box) => Tree.Lone(
              ...
              Scope.BLOCK(
                ...
                [
                  {kind:"let", ghost:true, name:"LET", specifiers:[]},
                  {kind:"const", ghost:true, name:"CONST", specifiers:[]},
                  {kind:"class", ghost:true, name:"CLASS", specifiers:[]}],
                (scope) => Tree.Bundle(
                  [
                    Tree.Lift(
    ...
    Scope.SCRIPT(
      ...
      (scope) => Tree.Lone(
        ...
        Scope.CLOSURE_HEAD(
          ...
          true,
          [
            {kind:"param", ghost:false, name:"PARAM", specifiers:[]},
            {kind:"var", ghost:false, name:"HEAD_VAR", specifiers:[]},
            {kind:"function", ghost:false, name:"HEAD_FUNCTION", specifiers:[]}],
          (scope) => (
            Assert.deepEqual(
              Scope._is_strict(scope),
              true),
              ...
              [
                ...
                Tree.Lone(
                  ...
                  Scope.EVAL(
                    scope,
                    [
                      {kind:"var", ghost:false, name:"EVAL_HEAD_VAR", specifiers:[]},
                      {kind:"function", ghost:false, name:"EVAL_HEAD_FUNCTION", specifiers:[]}],
                    (scope) => Tree.Lift(
                      Tree.primitive(456)))),
                Tree.Lone(
                  [],
                  Scope.CLOSURE_BODY(
                    ...
                    true,
                    [
                      {kind:"var", ghost:false, name:"BODY_VAR", specifiers:[]},
                      {kind:"function", ghost:false, name:"BODY_FUNCTION", specifiers:[]},
                      {kind:"let", ghost:false, name:"LET", specifiers:[]},
                      {kind:"const", ghost:true, name:"CONST", specifiers:[]},
                      {kind:"class", ghost:true, name:"CLASS", specifiers:[]}],
                    (scope) => Tree.Bundle(
                      [
                        ...
                        Tree.Lone(
                          ...
                          Scope.EVAL(
                            scope,
                            [
                              {kind:"var", ghost:false, name:"EVAL_BODY_VAR", specifiers:[]},
                              {kind:"function", ghost:false, name:"EVAL_BODY_FUNCTION", specifiers:[]}],
                            (scope) => Tree.Lift(
                              Tree.primitive(456))))])))]))))),
    Lang.PARSE_BLOCK(
      `{
    ...
    Scope.SCRIPT(
      ...
      (scope) => Tree.Lone(
        ...
        Scope.CLOSURE_HEAD(
          ...
          false,
          [
            {kind:"param", ghost:true, name:"PARAM", specifiers:[]},
            {kind:"var", ghot:false, name:"VAR", specifiers:[]},
            {kind:"function", ghost:false, name:"FUNCTION", specifiers:[]}],
          (scope) => Tree.Lone(
            [],
            Scope.CLOSURE_BODY(
  ...
  Assert.deepEqual(
    state.scopes[global.Reflect.ownKeys(state.scopes)[0]].info,
    {
      "strict-mode": true,
      "new-target": true,
      "super-property": true,
      "super-call": true});
  Assert.deepEqual(typeof state.scopes[global.Reflect.ownKeys(state.scopes)[0]].data, "string");
  // _is_available //
  Lang._match_block(
    Scope.SCRIPT(
      Scope._extend_dynamic_global(
  ...
  Lang._match_block(
    Scope.MODULE(
      Scope._extend_dynamic_global(
        Scope._make_root()),
      [
        {kind:"var", ghost:false, name:"x", specifiers:[]},
        {kind:"import", ghost:true, name:"z", source:"src", specifier:"spc"}],
      (scope) => Tree.Bundle(
        [
          Tree.Lift(
  ...
  Lang._match_block(
    Scope.MODULE(
      ...
      [
        {kind:"var", ghost:false, name:"x", specifiers:[]},
        {kind:"import", ghost:true, name:"z", source:"src", specifier:"spc"},
        {kind:"let", ghost:true, name:"t", specifiers:[]}],
      (scope) => Tree.Bundle(
        [
          Tree.Lift(
  ...
  Lang._match_block(
    Scope.MODULE(
      Scope._extend_dynamic_global(
        Scope._make_root()),
      [
        {kind:"var", ghost:false, name:"x", specifiers:["foo", "bar"]},
        {kind:"const", ghost:false, name:"y", specifiers:[]}],
      (scope) => Tree.Bundle(
        [
          Tree.Lift(
            Scope.write(
  ...
  Lang._match_block(
    Scope.MODULE(
      ...
      [
        {kind:"var", ghost:false, name:"x", specifiers:["foo", "bar"]},
        {kind:"const", ghost:false, name:"y", specifiers:[]},
        {kind:"const", ghost:true, name:"z", specifiers:[]}],
      (scope) => (
