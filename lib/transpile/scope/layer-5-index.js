...
const populate = (scope, variables, configurable, callback) => Tree.BundleStatement(
  [
...
const undefined_completion_callback = (scope) => Tree.PrimitiveExpression(void 0);
...
exports.makeEvalBlock = (scope, variables, callback1, callback2) => (
  ...
  Base.makeBlock(
    ...
    (scope) => populate(scope, variables, true, callback1),
    callback2));
...
exports.makeHeadClosureBlock = (scope, sort, dynamic, variables, callback1, callback2, _box) => (
      ...
      Base.makeBlock(
        ...
        (scope) => Base.makeBoxStatement(
          ...
          (box) => (
            ...
            populate(scope, variables, false, callback1))),
        callback2)) :
    Base.makeBlock(
      scope,
