...
exports.CLOSURE_HEAD = (scope, sort, dynamic, variables, callback, _box) => (
  ...
  scope = Base._extend_binding(
    ...
    (
      ...
      {
        arrow: true,
        function: Base._get_binding(scope, SORT_KEY).function} :
      {
        arrow: false,
        function: sort})),
  (
...
exports._get_sort = (scope, _sort) => (
  _sort = Base._get_binding(scope, SORT_KEY),
...
exports.eval = (scope, expression) => (
  ...
  State._register_scope(
    {
      context: {
        strict: Base._get_binding(scope, STRICT_KEY),
        sort: Base._get_binding(scope, SORT_KEY).function },
...
const regular_delete_callback_prototype = {
  on_miss () { return (
    Throw.assert(
      !Base._get_binding(this.scope, ENCLAVE_KEY),
...
const special_read_callback_prototype = {
  ...
  on_static_live_hit (variable, read, write) { return (
    (
      ...
      Base._get_binding(this.scope, SORT_KEY).function === "derived-constructor") ?
    Tree.conditional(
      read(),
      read(),
...
const super_callback_prototype_helper = {
...
const super_callback_prototype = {
  on_miss () { return (
    Throw.assert(
      Base._get_binding(this.scope, ENCLAVE_KEY),
      null,
    ...
    (
      ...
      (
        ...
        Tree.__enclave_super_invoke__(this.key, this.arguments)))); },
  on_static_dead_hit (variable) { return (
    Throw.abort(
      null,
      `Super identifier in deadzone`)); },
  on_static_live_hit (variable, read, write) { return (
    (
      (expression) => (
        Base._get_binding(this.scope, SORT_KEY).function === "derived-constructor" ?
        Tree.conditional(
          Base.lookup(
            ...
            "this",
            {
              __proto__: super_callback_prototype_helper,
              right: null}),
          (
            this.key === null ?
          ...
          (
            this.key === null ?
            expression :
            Intrinsic.throw_reference_error(`Super constructor must be called before accessing super property`))) :
        expression))
    (
      (
        this.key === null ?
...
exports.super = (scope, nullable_expression_1, nullable_expression_2) => (
  Throw.assert(
    nullable_expression_1 !== null || nullable_expression_2 !== null,
    null,
    `key and arguments cannot be both null`),
  Base.lookup(
    scope,
    "super",
    {
      __proto__: super_callback_prototype,
      scope,
      key: nullable_expression_1,
      arguments: nullable_expression_2}));
