...
const forbidden_enclave_read_identifier_array = [
  "await",
  "let",
  "static",
  "yield",
...
const forbidden_enclave_write_identifier_array = ArrayLite.concat(
  ["eval", "arguments"],
  forbidden_enclave_read_identifier_array);
...
const typeof_callback_prototype = {
  on_miss () { return (
    ...
    (
      Throw.assert(
        !ArrayLite.has(forbidden_enclave_read_identifier_array, this.identifier),
        Throw.EnclaveLimitationAranError,
...
const write_callback_prototype = {
  ...
  on_miss () { return (
    ...
    (
      Throw.assert(
        !ArrayLite.has(forbidden_enclave_write_identifier_array, this.identifier),
        Throw.EnclaveLimitationAranError,
...
exports.write = (scope, identifier, expression) => {
  try {
    return Base.lookup(
      ...
      identifier,
      {
        __proto__: write_callback_prototype,
        optimistic: true,
        scope,
        identifier,
        right: expression}); }
