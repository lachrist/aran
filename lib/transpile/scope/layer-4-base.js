      ...
      Tree.conditional(
        ...
        Tree.conditional(
          ...
          Builtin.define_property(
            ...
            false,
            Builtin._success_result),
          Builtin.throw_syntax_error(`Variable named '${identifier}' has already been initialized (this should never happen, please consider submitting a bug repport)`)),
        Builtin.throw_syntax_error(`Variable named '${identifier}' has not yet been declared (this should never happen, please consider submitting a bug repport)`)))));
