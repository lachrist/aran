    ...
    Tree.Lift(
      Tree.conditional(
        ...
        (
          ...
          Intrinsic.throw_syntax_error(`Variable named '${variable.name}' has already been declared (this should have been signaled as an early syntax error, please consider submitting a bug repport)`)),
