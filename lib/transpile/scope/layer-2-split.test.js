...
State._run_session({nodes: [], serials: new Map(), scopes: {__proto__:null}}, () => {
  Lang._match(Split.EXTEND_STATIC(Split._make_root(), [], ["kind-base"], ["kind-meta"], (scope) => {
    // Declare //
    Assert.deepEqual(Split._declare_base(scope, {kind:"kind-base", ghost:false, name:"x_base"}), {type:"static", conflict:null});
    Assert.deepEqual(Split._declare_meta(scope, {kind:"kind-meta", ghost:false, name:"x_meta"}), {type:"static", conflict:null});
    // Initialize //
    Assert.deepEqual(
    ...
    // Lookup //
    Assert.deepEqual(Split._declare_base(scope, {kind:"kind-base", ghost:true, data:"foo", name:"y_base"}), {type:"static", conflict:null});
    Assert.deepEqual(Split._declare_base(scope, {kind:"kind-base", ghost:true, data:"bar", name:"y_base"}), {type:"static", conflict:{kind:"kind-base", ghost:true, data:"foo", name:"y_base"}});
    Assert.deepEqual(Split._declare_meta(scope, {kind:"kind-meta", ghost:true, data:"foo", name:"y_meta"}), {type:"static", conflict:null});
    Assert.deepEqual(Split._declare_meta(scope, {kind:"kind-meta", ghost:true, data:"bar", name:"y_meta"}), {type:"static", conflict:{kind:"kind-meta", ghost:true, data:"foo", name:"y_meta"}});
    ...
    return Tree.BundleStatement([
      ...
      Tree.ExpressionStatement(Split.lookup_base(Split._extend_dynamic(scope, [], [], "dynamic-frame"), "z_base", {
      ...
      Tree.ExpressionStatement(Split.lookup_meta(Split._extend_dynamic(scope, [], [], "dynamic-frame"), "z_meta", {
        __proto__: lookup_callback_prototype,
        on_miss: function () {
          Assert.deepEqual(this.foo, "bar");
      ...
      // Lookup >> Dead Hit //
      Tree.ExpressionStatement(Split.lookup_base(scope, "y_base", {
        __proto__: lookup_callback_prototype,
      ...
      Tree.ExpressionStatement(Split.lookup_meta(scope, "y_meta", {
        __proto__: lookup_callback_prototype,
        on_static_dead_hit: function (variable) {
          Assert.deepEqual(this.foo, "bar");
      ...
      // Lookup >> Live Hit
      Tree.ExpressionStatement(Split.lookup_base(scope, "x_base", {
        __proto__: lookup_callback_prototype,
      ...
      Tree.ExpressionStatement(Split.lookup_meta(scope, "x_meta", {
        __proto__: lookup_callback_prototype,
        on_static_live_hit: function (variable, read, write) {
          Assert.deepEqual(this.foo, "bar");
          Assert.deepEqual(variable, {kind:"kind-meta", ghost:false, name:"x_meta"});
