...
State._run_session({nodes:[], serials:new Map(), scopes:{__proto__:null}}, () => {
  ...
  Lang._match_block(
    Base.EXTEND_STATIC(
      ...
      (scope) => Tree.Bundle(
        [
          Base.Declare(scope, {kind:"let", ghost:true, name:"x"}),
          (
            Assert.throws(() => Base.Declare(scope, {kind:"let", ghost:false, name:"x"}), new global.Error("Duplicate variable declaration")),
            Tree.Bundle([])),
          Base.Declare(scope, {kind:"var", ghost:false, name:"y", specifiers:[]}),
          Base.Declare(scope, {kind:"var", ghost:false, name:"y", specifiers:[]}),
          Base.Box(
            scope,
            false,
            ...
            (box) => Tree.Bundle(
              [
                Base.Declare(
                  ...
                  {kind:"const", ghost:false, name:"z", specifiers:[]}),
                Base.Declare(
                  Base._extend_dynamic(scope, ["var"], "tag", false, box),
                  {kind:"var", ghost:false, name:"t", specifiers:[]})]))])),
    Lang.PARSE_BLOCK(
      `{
        let $$y;
        $$y = void 0;
        (
          #Reflect.has(123, "z") ?
          throw new #SyntaxError("Variable named 'z' has already been declared (this should have been signaled as an early syntax error, please consider submitting a bug repport)") :
            ...
            Tree.Lift(
              Base.initialize(
                ...
                (scope, identifier, expression) => (
                  ...
                  expression))),
            Base.Declare(scope, {kind:"let", ghost:false, name:"y", specifiers:["foo", "bar"]}),
            Tree.Lift(
              Base.initialize(
                scope,
                "let",
          ...
          (
            ...
            #Reflect.defineProperty(
              ...
              "z",
              {
                __proto__: null,
                value: 901}) :
            throw new #SyntaxError("Variable 'z' has already been initialized (this should never happen, please consider submitting a bug repport)")) :
          throw new #SyntaxError("Variable 'z' has not yet been declared (this should never happen, please consider submitting a bug repport)")); }`),
    Assert);
  // // ImportInitialize //
  // Lang._match_block(
  //   Base.EXTEND_STATIC(
  ...
  Lang._match_block(
    Base.EXTEND_STATIC(
      ...
      (scope) => (
        ...
        Tree.Bundle(
          [
            Base.Declare(scope, {kind:"var", ghost:false, name:"x", specifiers:[]}),
            Base.Declare(scope, {kind:"let", ghost:true, name:"y", specifiers:[]}),
            (
              Assert.deepEqual(
  ...
  Lang._match_block(
    Base.EXTEND_STATIC(
      ...
      (scope) => Tree.Bundle(
        [
          Base.Declare(scope, {kind:"let", ghost:false, name:"x", specifiers:[]}),
          Tree.Lift(
            Base.initialize(
              scope,
              "let",
              ...
              false,
              () => Assert.fail())),
          Base.Declare(scope, {kind:"const", ghost:false, name:"this", specifiers:[]}),
          Tree.Lift(
            Base.initialize(
              scope,
              "const",
            ...
            Base.lookup(
              ...
              "x",
              {
                ...
                on_static_live_hit: function (variable, read, write) { return (
                  Assert.deepEqual(this.foo, "bar"),
                  Assert.deepEqual(variable, {kind:"let", ghost:false, name:"x", specifiers:[]}),
                  write(
                    Tree.primitive(789))) },
                on_static_dead_hit: () => Assert.fail(),
                on_dynamic_dead_hit: () => Assert.fail(),
          ...
          Tree.Lift(
            Base.lookup(
              ...
              "this",
              {
                ...
                on_static_live_hit: function (variable, read, write) { return (
                  Assert.deepEqual(this.foo, "bar"),
                  Assert.deepEqual(variable, {kind:"const", ghost:false, name:"this", specifiers:[]}),
                  write(
                    Tree.primitive(901))) },
                on_static_dead_hit: () => Assert.fail(),
                on_dynamic_dead_hit: () => Assert.fail(),
  ...
  Lang._match_block(
    Base.EXTEND_STATIC(
      ...
      (scope) => Tree.Bundle(
        [
          Base.Declare(scope, {kind:"let", ghost:true, name:"x", specifiers:[]}),
          Base.Declare(scope, {kind:"const", ghost:true, name:"this", specifiers:[]}),
          Tree.Lift(
            Base.lookup(
              scope,
              "x",
              {
                ...
                on_static_dead_hit: function (variable) { return (
                  Assert.deepEqual(this.foo, "bar"),
                  Assert.deepEqual(variable, {kind:"let", ghost:true, name:"x", specifiers:[]}),
                  Tree.primitive(123)) },
                on_dynamic_dead_hit: () => Assert.fail(),
                on_dynamic_live_hit: () => Assert.fail()})),
          (
  ...
  Lang._match_block(
    Base.EXTEND_STATIC(
      ...
      (scope) => Tree.Bundle(
        [
          Base.Declare(scope, {kind:"var", ghost:false, name:"this", specifiers:[]}),
          Tree.Lift(
            Base.lookup(
              Base._extend_dynamic(
                scope,
              ...
              "this",
              {
                ...
                on_static_live_hit: function (variable, read, write) { return (
                  Assert.deepEqual(this.foo, "bar"),
                  Assert.deepEqual(variable, {kind:"var", ghost:false, name:"this", specifiers:[]}),
                  write(
                    Tree.primitive(456))) },
                on_dynamic_dead_hit: () => Assert.fail(),
                on_dynamic_live_hit: () => Assert.fail()}))])),
