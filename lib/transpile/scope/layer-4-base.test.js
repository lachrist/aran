      ...
      [
        ...
        Tree.ExpressionStatement(
          Base.makeLookupExpression(
            ...
            "x",
            {
              onMiss: () => Tree.PrimitiveExpression(456),
              onStaticLiveHit: () => Assert.fail(),
              onStaticDeadHit: () => Assert.fail(),
              onDynamicLiveHit: () => Assert.fail(),
              onDynamicDeadHit: () => Assert.fail()}))]),
    Lang.parseStatement(`
      enclave var x = 123;
      456;`),
    Assert);
          ...
          Tree.ExpressionStatement(
            Base.makeLookupExpression(
              ...
              "x",
              {
                onMiss: () => Assert.fail(),
                onStaticDeadHit: () => Assert.fail(),
                onStaticLiveHit: (read, write) => Tree.SequenceExpression(
                  read(),
                  write(
        ...
        [
          ...
          Tree.ExpressionStatement(
            Base.makeLookupExpression(
              ...
              {
                onMiss: () => Assert.fail(),
                onStaticDeadHit: () => Tree.PrimitiveExpression(123),
                onStaticLiveHit: () => Assert.fail(),
                onDynamicDeadHit: () => Assert.fail(),
                onDynamicLiveHit: () => Assert.fail()})),
          Base.makeInitializeStatement(
