...
const callbacks = {
  ...
  //   /* istanbul ignore if */
  //   if (Identifier._is_meta(stratified_stratified_identifier)) {
  //     return declare_initialize(context, expression);
  //   }
  //   // console.assert(Identifier._is_base(stratified_stratified_identifier)); // read TDZ variables only appears in conditional expressions
  //   const stratified_identifier = Identifier._get_body(stratified_stratified_identifier);
  //   const identifier = Identifier._get_body(stratified_identifier);
  //   if (Identifier._is_meta(stratified_identifier) ? Split._is_writable_meta(context.scope, identifier) : Split._is_writable_base(context.scope, identifier)) {
  //     return declare_initialize(context, expression);
  //   }
  //   return {
  //     remainder: null,
  //     box: {
  //       type: Identifier._is_meta(stratified_identifier) ? META_IDENTIFIER_TYPE : BASE_IDENTIFIER_TYPE,
  //       value: Identifier._get_body(stratified_identifier)
  //     }
  //   };
  // },
  // Consumers //
  ...
  await: declare_initialize,
  yield: declare_initialize,
  eval: declare_initialize,
  // enclave //
  enclave_read: declare_initialize,
  enclave_write: declare_initialize,
  enclave_super_call: declare_initialize,
  enclave_super_invoke: declare_initialize,
  enclave_super_member: declare_initialize,
  // Combiners //
