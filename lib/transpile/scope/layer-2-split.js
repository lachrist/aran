...
exports.lookupAll = Core.lookupAll;
...
exports.BaseDynamicScope = (scope, kinds, frame) => Core.DynamicScope(
  scope,
  ArrayLite.map(kinds, Variable.Base),
  {
    type: "base",
    data: frame});

exports.MetaDynamicScope = (scope, kinds, frame) => Core.DynamicScope(
  scope,
  ArrayLite.map(kinds1, Variable.Meta),
  {
    type: "base",
    data: frame});
