...
exports.getDynamicFrame = Core.getDynamicFrame;
exports.getStaticData = Core.getStaticData;

///////////////////
// getStaticData //
///////////////////

const makeGetStaticData = (name) => (scope, identifier) => Core.getStaticData(
  scope,
  Identifier[name](identifier));

exports.getBaseStaticData = makeGetStaticData("makeBase");

exports.getMetaStaticData = makeGetStaticData("makeMeta");
