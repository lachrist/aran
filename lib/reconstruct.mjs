...
const encodeRegular = (prefix, variable) =>
  encodeInternal(prefix, "reg", variable);
...
const encodeArgument = (prefix, variable) =>
  encodeInternal(prefix, "arg", variable);

/////////////
// Builder //
/////////////

/** @type {(node: estree.Statement, label: string) => estree.Statement} */
...
/** @type {(nodes: Node<unknown>[], context: Context) => estree.Statement[]} */
...
/** @type {(node: Program<unknown>, context: Context) => estree.Program} */
...
/** @type {(node: ControlBlock<unknown>, context: Context) => estree.Statement} */
...
/** @type {(node: PseudoBlock<unknown>, context: Context) => estree.Statement[]} */
...
/** @type {(link: Link<unknown>, context: Context) => estree.ProgramStatement[]} */
...
/** @type {(node: Statement<unknown>, context: Context) => estree.Statement} */
...
/** @type {(node: Effect<unknown>, context: Context) => estree.Expression} */
...
/** @type {(node: Expression<unknown>, context: Context) => estree.Expression} */
      ...
      switch (node.kind) {
        case "function":
          return {
            ...
            body: reconstructClosureBlock(node.body, context, "closure"),
          };
        case "arrow":
          if (node.generator) {
