...
module.exports = (program, options, _counter) => visit_program(
  program,
  global_Object_assign({__proto__:null}, default_context, options));
...
build.code._program = (source, local, namespace_builtin, builtin, codes, code) => (
  `"use strict";` +
  (
    local ?
    `` :
  ...
  code);
buid.estree._program = (source, local, namespace_builtin, builtin, estreess, estree) => ({
  type: "Program",
  sourceType: source,
          ...
          declarations: [
            {
              ...
              init: {
                ...
                key: {
                  type: "Literal",
                  value: builtin}}}]}]),
    ArrayLite.flaten(estrees),
    [estree])});

const program_callback_object = {
  __proto__: null,
  _program: (context, node, preludes, block) => context.build._program(
...
build.code._export = (identifier, specifier) => (
  `let ${identifier}; export {${identifier} as ${specifier}};`);
...
build.estree._aggregate = (specifier, source, specifier2) => [
  (
    specifier1 === null ?
    {
...
const prelude_callback_object = {
  ...
  _import: (context, node, specifier, source) => context.build._import(
    specifier,
    context.namespace.import(specifier, source),
    source),
  _export: (context, node, specifier) => context.build._export(
...
const block_estree_variable_declarator = (identifier) => ({
  type: "VariableDeclarator",
  id: {
    type: "Identifier",
    name: identifier},
...
build.code.BLOCK = (sort, namespace_error, namespace_arguments, input_identifier, callee, identifiers, codes) => (
  ...
  (
    sort === "arrow" ?
    `${input_identifier} = {__proto__:null, callee:${callee === null ? "null" : callee}, arguments:${namespace_arguments}};` :
    (
      sort === "method" ?
      `${input_identifier} = {__proto__:null, callee:${callee === null ? "null" : callee}, arguments:${namespace_arguments}, this:this};` :
      (
        sort === "constructor" ?
        `${input_identifier} = {__proto__:null, callee:${callee === null ? "null" : callee}, arguments:${namespace_arguments}, "new.target":new.target};` :
        (
          sort === "function" ?
          `${input_identifier} = {__proto__:null, callee:${callee === null ? "null" : callee}, arguments:${namespace_arguments}, this:this, "new.target":new.target};` :
          (
            sort === "catch" ?
      ...
      [
        {
          type: "VariableDeclaration",
          kind: "let",
          declarations: ArrayLite.map(identifiers, block_estree_variable_declarator)},
        {
          type: "ExpressionStatement",
          expression: {
...
build.estree.Lone = (labels, estree) => ArrayLite.map(labels, labelize_estree, estree);
...
const make_closure_callback = (sort) => (context, node, block, _identifier) => (
  ...
  (
    _identifier = `${context.namespace.callee}_${context.namespace.counter++}`,
...
build.code.closure = (sort, callee, namespace_arguments, code) => (
  code = (
    sort === "arrow" ?
  ...
  (
    ...
    (
      ...
      `(${_code})` :
      `(${callee} = ${code})`)));
build.estree.closure = (sort, callee, namespace_arguments, estree) => (
  estree = {
...
build.estree.wite = (usage, identifier, estree) => (
  estree = {
    type: "AssignmentExpression",
    operator: "=",
    left: {
...
build.code.import = build.estree.read;
...
build.code.unary = (opertor, code) => `(${operator}${code})`;
...
build.estree.binary = (opeator, estree1, estree2) => ({
...
const object_property_estree = ({0:estree1, 2:estree2}) => ({
  type: "Property",
  kind: "init",
  method: false,
  shorthand: false,
...
build.estree.object = (estree, estreesss) => ({
  type: "ObjectExpression",
  properties: ArrayLite.concat(
    [
      {
...
const expression_callback_object = {
  ...
  construct: (context, node, expression, expressions, _code, _codes) => (
    ...
    (
      context.construct(expression, expressions, _code, _codes) ||
      context.build.construct(_code, _codes))),
  apply: (context, node, expression1, expression2, expressions, _is_this_undefined, _code1, _code2, _codes) => (
    ...
    _code = visit_expression(expression1, context, _is_this_undefined ? CALLEE_USAGE : NORMAL_USAGE),
    _nullable_code = (
      _is_this_undefined ?
      null :
      visit_expression(expression2, context, NORMAL_USAGE)),
    _codes = ArrayLite.map(
      ...
      (expression) => visit_expression(expression, context, NORMAL_USAGE)),
    (
      context.apply(expression1, expression2, expressions, _code, _nullable_code, _codes),
      context.build.apply(context.namespace.builtin, _code, _nullable_code, _codes)))};
