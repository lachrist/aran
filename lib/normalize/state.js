...
exports._get_background = (index) => session.state.backgrounds[index];

exports._new_background = () => {
  session.state.backgrounds[session.state.backgrounds.length++] = [];
  return session.state.backgrounds.length - 1;
};
