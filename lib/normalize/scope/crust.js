...
exports._is_strict = (scope) => Mantle._get_binding(scope, STRICT_MODE_BINDING_KEY);
exports._get_super_box = (scope) => Mantle._get_binding(scope, SUPER_BOX_BINDING_KEY);
exports._get_self_box = (scope) => Mantle._get_binding(scope, SELF_BOX_BINDING_KEY);
exports._get_closure_kind = (scope) => Mantle._get_binding(scope, CLOSURE_KIND_BINDING_KEY);
exports._get_function_expression_ancestor = (scope) => Mantle._get_binding(scope, FUNCTION_EXPRESSION_ANCESTOR_BINDING_KEY);
exports._get_completion_box = (scope) => Mantle._get_completion_box(scope, COMPLETION_BOX_BINDING_KEY);
...
exports.initialize = (scope, kind, identifier, expression) => (
  ...
  Mantle.initialize(
    (
      Mantle._get_binding(scope, BACKGROUND_BINDING_KEY) ?
      Mantle._get_background(scope) :
      scope),
    kind,
    identifier,
    expression));
...
exports.GLOBAL = (strict, hoisting1, hoisting2, callback, _scope) => (
  _scope = Mantle._make_root(),
  _scope = Mantle._extend_binding(_scope, BACKGROUND_BINDING_KEY, false),
  _scope = (
    strict ?
    Mantle._extend_binding(_scope, STRICT_MODE_BINDING_KEY) :
    strict),
  _scope = Mantle._extend_binding(
    _scope,
  ...
  _scope = Mantle._extend_dynamic_local(
    _scope,
    Mantle._builtin_box("#globalObjectRecord")),
  _scope = Mantle._extend_dynamic_global(_scope),
  _scope = Mantle._extend_horizon(_scope),
  horizon(
    scope,
    hoisting1,
    hoisting2,
...
exports.HORIZON = (scope, hoisting1, hoisting2, callback) => Scope.EXTEND_STATIC(
  ...
  (scope) => Mantle.Box(
    ...
    (box) => Tree.Lone(
      [],
      horizon(
        Mantle._extend_horizon(
          Mantle._extend_dynamic_local(scope, box)),
        hoisting1,
        hoisting2,
        callback))));
...
exports.CLOSURE = (scope, strict, context, callback) => (
  ...
  scope = (
    strict ?
    Mantle._extend_binding(scope, STRICT_MODE_BINDING_KEY, true) :
    scope),
...
exports.eval = Mantle.eval;

exports.parameter = Mantle.parameter;
