...
exports.ImportInitializeBase = (scope, kind, identifier, source, maybe) => Core.ImportInitialize(
  scope,
  Stratum._base(kind),
  Stratum._base(identifier),
  source,
  maybe);
exports.ImportInitializeMeta = (scope, kind, identifier, source, maybe) => Core.ImportInitialize(
  scope,
  Stratum._meta(kind),
  Stratum._meta(identifier),
  source,
