...
const lookup_callback_object = {
  on_miss: function () {
    return this.callbacks.on_miss();
  },
  on_live_hit: function (kind, access) {
    return this.callbacks.on_live_hit(Stratum._get_body(kind), access);
  },
  on_dead_hit: function (kind) {
    return this.callbacks.on_dead_hit(Stratum._get_body(kind));
  },
  on_dynamic_frame: function (frame, expression) {
    return this.callbacks.on_dynamic_frame(frame, expression);
  };
};
