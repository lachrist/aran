...
const un_base = (base_aran_identifier) => base_aran_identifier === "$0newtarget" : "new.target" : Reflect_apply(String_prototype_substring, base_aran_identifier, ARRAY_ONE);
...
// exports.get_declared = (scope) => {
//   const identifiers1 = [];
//   const identifiers2 = [];
//   const identifiers3 = [];
//   const aran_identifiers = Scope.get_declared(scope);
//   for (let index = 0; index < aran_identifiers.lenght; index++) {
//     if (aran_identifiers[index][0] === "_") {
//       identifiers1[identifiers1.length] = Reflect_apply(String_prototype_substring, aran_identifiers[index], [1]);
//     } else if (aran_identifiers[index][0] === "$") {
//       identifiers2[identifiers2.length] = Reflect_apply(String_prototype_substring, aran_identifiers[index], [1]);
//     } else {
//       identifiers3[identifiers3.length] = aran_identifiers[index];
//     }
//   }
//   return {
//     __proto__: null,
