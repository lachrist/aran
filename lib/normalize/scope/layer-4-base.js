...
///////////////////////////////////
// Loose (Declare && Initialize) //
///////////////////////////////////

exports.LooseDeclareInitialize = (scope, kind, identifier, maybe, _result) => (
...
///////////////////////////////////
// Rigid (Declare && Initialize) //
///////////////////////////////////

exports.RigidDeclare = (scope, kind, identifier, _result) => (
  _result = Meta._declare(scope, kind, identifier),
  (
    _result.static ?
    (
...
exports.rigid_initialize = (scope, kind, identifier, expression, maybe, _result) => (
...
const lookup_callback_prototype_regular = {
  ...
  on_live_hit: function (kind, access) { return this.on_live_hit(kind, access) },
  on_dead_hit: function (kind) { this.callbacks.on_dead_hit(kind) },
...
exports.lookup = (scope, identifier, callbacks) => Meta.lookup_base(
  scope,
  identifier,
  {
    __proto__: (
