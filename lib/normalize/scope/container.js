...
exports.get = (scope, {nullable_identifier, primitive}) => {
  ...
  return Layer.lookup_meta(scope, nullable_identifier, null);
};
...
exports.set = (scope, {nullable_identifier, primitive}, aran_expression) => {
  ...
  return Layer.lookup_meta(scope, nullable_identifier, aran_expression);
};
...
const make = (scope, identifier, either_primitive_aran_expression) => {
  ...
  identifier = Layer.declare_meta(scope, identifier);
  return {
    __proto__: null,
    nullable_aran_expression: Layer.initialize_meta(scope, identifier, either_primitive_aran_expression),
    container: {
      __proto__: null,
...
exports.make_as_aran_expression = (scope, identifier, either_primitive_aran_expression, kontinuation) => {
...
exports.make_as_aran_statement_array = (scope, identifier, either_primitive_aran_expression, kontinuation) => {
  const {nullable_aran_expression, container} = make(scope, identifier, either_primitive_aran_expression);
  if (nullable_aran_expression === null) {
    return kontinuation(container);
  }
