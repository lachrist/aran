...
State.session({nodes:[], serials:new Map(), evals:{__proto__:null}}, {
  ...
  Assert.deepEqual(
    Scope.GLOBAL(
      false,
      {__proto__:null, x1:false, y1:true},
      (scope) => [
        Build.Lift(
        ...
        Build.Lone(
          ...
          Scope.CLOSURE(
            scope,
            false,
            {__proto__:null, x2:false, y2:true},
            (scope) => [
              Build.Lift(
              ...
              Build.Lone(
                ...
                Scope.REGULAR(
                  scope,
                  {__proto__:null, x3:false, y3:true},
                  (scope) => [
                    Build.Lift(
