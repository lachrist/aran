...
exports._make_global = () => Base._extend_dynamic(
  Outer._make_root(),
  Meta._builtin_box("global"),
  null);
...
exports._get_data = Outer._get_data;

exports._is_root = Outer._is_root;
...
const delete_callbacks = {
  ...
  // console.assert(identifier !== "this" && identifier !== "new.target");
  on_dynamic_hit: (scope, identifier, delete_right, box) => Builtin.delete_property(
    Meta.get(scope, box),
...
const read_callbacks = {
  ...
  // console.assert(identifier !== "this" && identifier !== "new.target");
  on_dynamic_hit: (scope, identifier, read_right, box) => Builtin.get(
    Meta.get(scope, box),
    Tree.primitive(identifier),
    null)};
...
const pessimistic_write_callbacks = {
  ...
  on_live_hit: (scope, identifier, pessimistic_write_right, writable, access) => (
    ...
    Builtin.throw_type_error("Assignment to constant variable.")),
  // console.assert(identifier !== "this" && identifier !== "new.target");
  on_dynamic_hit: (scope, identifier, pessimistic_write_right, box) => Builtin.set(
    Meta.get(scope, box),
    Tree.primitive(identifier),
    Meta.get(scope, pessimistic_write_right),
    null,
