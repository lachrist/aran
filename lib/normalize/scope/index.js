...
exports._make_global = () => Base._extend_dynamic_closure(
  Base._extend_dynamic_block(
    Outer._extend_binding(
      Outer._make_root(),
      "strict",
      false),
    Meta._builtin_box("#globalObject")),
  Meta._builtin_box("#globalLexicalFrame"));
