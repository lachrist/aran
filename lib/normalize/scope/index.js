...
exports.container = Container.make_as_aran_expression;

exports.Container = Container.make_as_aran_statement_array;
...
exports.GLOBAL = (is_use_strict, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => {
  return Layer.extend_global(is_use_strict, hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));
};

exports.DYNAMIC = (scope, dynamic, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => {
  return Layer.extend_dynamic(scope, dynamic, hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));
};

exports.REGULAR = (scope, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => {
  return Layer.extend_regular(scope, hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));
};

exports.EVAL = (frame_array, is_use_strict, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => {
  return Layer.extend_eval(frame_array, is_use_strict, hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));
};

exports.CLOSURE = (scope, is_use_strict, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => {
  return Layer.extend_closure(scope, is_use_strict, hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));
};
...
const make_on_dynamic = (make_aran_expression) => (context, aran_expression, dynamic) => Build.conditional(
  Build.conditional(
    Object.has(
      Container.get(context.scope, dynamic.object),
      ...
      Build.conditional(
        Build.conditional(
          Build.binary(
            ...
            Build.unary(
              "typeof",
              Container.get(context.scope, dynamic.unscopables)),
...
const delete_callbacks = {
  ...
  on_miss: (context) => Object.del(
    ...
    Layer.access_meta(context.scope, dynamic.object, null),
    Build.primitive(context.identifier)),
...
exports.write = (scope, identifier, aran_expression) => {
  try {
    ...
    const identifier = Layer.declare_meta(scope, "right_hand_side");
    return Build.sequence(
      Layer.initialize_meta(scope, identifier, aran_expression),
      Layer.lookup_base(scope, identifier, pessimistic_write_regular_callbacks, {scope, identifier, right:identifier}));
  }
};
