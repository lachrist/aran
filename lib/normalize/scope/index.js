...
const hoisting = (extended_identifier_array_1, extended_identifier_array_2, kontinuation) => (scope) => {
  for (let index = 0; index < extended_identifier_array_1.length; index++) {
    Layer._declare_base(scope, extended_identifier_array_1[index], false);
  }
  for (let index = 0; index < extended_identifier_array_2.length; index++) {
    Layer._declare_base(scope, extended_identifier_array_2[index], true);
  }
  return kontinuation(scope);
};

exports.GLOBAL = (is_use_strict, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => Layer.GLOBAL(
  is_use_strict,
  hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));

exports.CLOSURE = (scope, is_use_strict, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => Layer.CLOSURE(
  scope,
  is_use_strict,
  hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));

exports.REGULAR = (scope, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => Layer.REGULAR(
  scope,
  hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));

exports.DYNAMIC = (scope, dynamic, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => Layer.DYNAMIC(
  scope,
  dynamic,
  hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));

exports.EVAL = (frame_array, is_use_strict, extended_identifier_array_1, extended_identifier_array_2, kontinuation) => Layer.EVAL(
  frame_array,
  is_use_strict,
  hoisting(extended_identifier_array_1, extended_identifier_array_2, kontinuation));
