...
State._run_session({nodes:[], serials:new Map(), scopes:{__proto__:null}}, [], () => {
  ...
  Assert.throws(
    ...
    new global.Error("Module block should not contain parameter variables"));
  Lang._match_block(
    Scope.MODULE(
      false,
      [
  ...
  // SCRIPT //
  Assert.throws(
    () => Scope.SCRIPT(false, [{kind:"param", name:"x"}], () => Assert.fail()),
    new global.Error("Script block should not contain parameter variables"));
  Assert.throws(
    () => Scope.SCRIPT(false, [{kind:"import", name:"x"}], () => Assert.fail()),
    new global.Error("Script block should not contain import variables"));
  Lang._match_block(
    Scope.SCRIPT(
      false,
      [
      ...
      (scope) => Tree.Lone(
        ...
        Scope.EVAL(
          ...
          [
            {kind:"param", name:"x"}],
          () => Assert.fail()))),
    new global.Error("Eval block should not contain parameter variables"));
  Assert.throws(
    () => Scope.SCRIPT(
      false,
      [],
      (scope) => Tree.Lone(
        ...
        Scope.EVAL(
          ...
          [
            {kind:"import", name:"x"}],
          () => Assert.fail()))),
    new global.Error("Eval block should not contain import variables"));
  Lang._match_block(
    Scope.SCRIPT(
      false,
      [],
    ...
    () => Scope.MODULE(
      ...
      (scope) => Tree.Lone(
        ...
        Scope.NORMAL(
          ...
          (scope) => Assert.fail()))),
    new global.Error("Normal block should only contain block variables"));
  Lang._match_block(
    Scope.MODULE(
      false,
      [],
    ...
    () => Scope.MODULE(
      ...
      (scope) => Tree.Lone(
        ...
        Scope.CLOSURE(
          ...
          [],
          (scope) => Assert.fail()))),
    new global.Error("Closure head block should not contain block variables"));
  Assert.throws(
    () => Scope.MODULE(
      false,
      [],
      (scope) => Tree.Lone(
        ...
        Scope.CLOSURE(
          ...
          [],
          (scope) => Assert.fail()))),
    new global.Error("Closure head block should not contain import variables"));
  Assert.throws(
    () => Scope.MODULE(
      false,
      [],
      (scope) => Tree.Lone(
        ...
        Scope.CLOSURE(
          ...
          [
            {kind:"param", name:"x"}],
          (scope) => Assert.fail()))),
    new global.Error("Closure body block should not contain parameter variables"));
  Assert.throws(
    () => Scope.MODULE(
      false,
      [],
      (scope) => Tree.Lone(
        ...
        Scope.CLOSURE(
          ...
          [
            {kind:"import", name:"x"}],
          (scope) => Assert.fail()))),
    new global.Error("Closure body block should not contain import variables"));
  ...
  Lang._match_block(
    ...
    Lang.PARSE_BLOCK(
      ...
      {
        {
          let $_DynamicHeadClosureFrame_10_1;
          $_DynamicHeadClosureFrame_10_1 = {__proto__:null};
          {
            let $$PARAM, $_DynamicBodyClosureFrame_12_1;
            $$PARAM = 123;
