...
const make_block = (scope, identifiers1, identifiers2, optionals, kontinuation) => {
  ArrayLite.forEach([true, false], (writable) => {
    ArrayLite.forEach(writable ? identifiers1 : identifiers2, (identifier1) => {
      const {identifier:identifier2, aran_expression} = Split.declare_initialize_meta(scope, "tdz_" + identifier, Build.primitive(false));
      optionals[optionals.length] = {
        __proto__: null,
        statement: Build.Expression(aran_expression),
        kind: "meta",
        identifier: identifier2
      };
      Split.declare_base(scope, identifier1, identifier2, REGULAR_TAGS[writable]);
    });
  });
...
exports.make_regular_block = (scope, identifiers1, identifiers2, kontinuation) => {
  ...
  return make_block(scope, identifiers1, identifiers2, [], kontinuation);
};
...
exports.make_catch_block = (scope, identifiers1, identifiers2, kontinuation) => {
  scope = Core.extend(scope, false, false, null);
  Split.declare_initialize_para(scope, "error");
  return make_block(scope, identifiers1, identifiers2, [], kontinuation);
};
