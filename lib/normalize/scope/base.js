...
exports._extend_eval = (scope, box) => Outer._extend_dynamic(scope, {
  object_box: box,
  unscopables_box: null
});
...
exports._get_ = (scope, _nullable_dynamic_frame) => {
        ...
        Tree.conditional(
          ...
          Tree.sequence(
            Meta.set(
              ...
              Mop.get(
                Meta.get(context.scope, dynamic_frame.object_box),
                Tree.builtin("Symbol.unscopables"),
                null)),
            Tree.conditional(
              Tree.conditional(
                Tree.binary(
