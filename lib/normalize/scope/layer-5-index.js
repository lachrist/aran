...
const make_global = (scope, kinds, completion, variables, callback) => (
...
exports.GLOBAL_EVAL = (scope, completion, variables, callback) => (
  ArrayLite.forEach(variables, check_script_variable),
  make_global(
    scope,
    (
...
exports.LOCAL_EVAL = (scope, completion, variables, callback) => (
  ArrayLite.forEach(variables, check_script_variable),
  Base.EXTEND_STATIC(
    clean_case(scope),
    (
...
// const check_eval_variable = make_check_variable(eval_kind_array);
...
exports.BLOCK = (scope, nullable_box, variables, callback) => (
...
// exports.CATCH_HEAD = (scope, variables, callback1, callback2) => (
//   (
...
// exports.CATCH_BODY = exports.NORMAL;
