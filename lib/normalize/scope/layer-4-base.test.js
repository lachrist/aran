...
State._run_session({nodes:[], serials:new Map(), scopes:{__proto__:null}}, [], () => {
  // DeclareInitialize //
  Lang._match_block(Base.EXTEND_STATIC(Base._make_root(), ["kind"], (scope) => {
    // Assert.throws(
    ...
    return Tree.Bundle([
      Base.LooseDeclareInitialize(scope, "kind", "x"),
      Base.LooseDeclareInitialize(Base._extend_dynamic(scope, ["kind"], "foo", false, false, Base._primitive_box(123)), "kind", "y"),
    ]);
  }), Lang.PARSE_BLOCK(`{
    let $$x;
    $$x = void 0;
  ...
  Lang._match_block(Base.EXTEND_STATIC(Base._make_root(), (scope1) => {
    return Tree.Bundle([
      Base.LooseDeclareInitialize(scope1, "var", "x"),
