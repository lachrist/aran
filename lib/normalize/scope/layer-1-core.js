...
const initialize = (scope, kind, identifier, maybe, callbacks) => {
  while (scope !== ROOT_SCOPE) {
    if (ArrayLite.includes(scope.kinds, kind)) {
      ...
      callbacks.static(Stratum._base(identifier), nullable_expression);
    }
    scope = scope.parent;
  }
...
exports.ImportInitialize = (scope, kind, identifier, source, maybe) => initialize(scope, kind, identifier, {
...
const initialize_callback_prototype = {
  ...
  static: function (stratified_identifier, nullable_expression) => {
    let expression = Tree.write(stratified_identifier, this.expression);
    if (nullable_expression !== null) {
...
exports._initialize = (scope, kind, indeitifer, expression, maybe) => initialize(scope, kind, idenitfier, {
