...
const declare_initialize_meta = ({scope, writable, identifier}, expression) => {
  ...
  while (!Split._declare_meta(scope, kind, identifier + global_String(counter)).value) {
    counter++;
  }
...
exports.set = (scope, box, expression) => {
  if (box.type === META_IDENTIFIER_TYPE) {
    return Split.lookup_meta(scope, box.value, expression, {
