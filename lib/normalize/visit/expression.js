...
exports.visit = (scope, node, dropped, box) => State._visit(node, [scope, node, dropped, box], visitors[node.type]);
...
visitors.Identifier = (scope, node, dropped, box) => Scope.read(scope, identifier.name);
...
visitors.TaggedTemplateExpression = (scope, node, dropped, box) => Tree.apply(
...
visitors.MemberExpression = (scope, node, dropped, box) => Scope.box(
  scope,
