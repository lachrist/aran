...
visitors.YieldExpression = (scope, node, context) => { throw new global_Error("Unfortunately, Aran does not yet support yield expressions and generator closures.") };

visitors.AwaitExpression = (scope, node, context) => { throw new global_Error("Unfortunately, Aran does not yet support await expressions and asynchronous closures.") };
