...
exports.class = (scope, node, dropped, name) => { throw new global_Error("Unfortunately, Aran does not support class expressions (yet)...") };

/////////////
// Closure //
/////////////

exports.arrow = (scope, node, dropped, name) => (
  node.async ?
                        ...
                        (closure) => (
                          ...
                          Scope.Box(
                            ...
                            Tree.object(
                              ...
                              []),
                            (frame) => closure(
                              Scope._extend_dynamic(scope, frame, null))) :
                          closure(scope)))
                      (
                        (scope) => (
                          node.expression ?
