...
exports.REGULAR = (statements, scope, lexic) => Scope.EXTEND_STATIC(
  scope,
  ...
  (scope) => Lang.Bundle(
    ArrayLite.map(
      ...
      (statement, index, statements) => Statement.Visit(
        statement,
        scope,
        Lexic._extend(lexic, index, statements),
        []))));

exports.SWITCH = (switch_cases, scope, lexic, box1, box2) => Scope.EXTEND_STATIC(
  scope,
...
exports.CLOSURE = (statements, scope, lexic, _hoisting) => (
  _hoisting = Query._deep_hoisting(statements),
  Scope.EXTEND_STATIC(
    scope,
...
exports.PROGRAM = (statements, scope, lexic) => (
  Scope._is_strict(scope) ?
  exports.CLOSURE(statements, scope, lexic) :
  Scope.EXTEND_STATIC(
    scope,
    Query._shallow_hoisting(statements),
    (scope) => Lang.Bundle(
      ArrayLite.concat(
        ArrayLite.map(
          global_Reflect_ownKeys(
            Query._deep_hoisting(statements)),
          (identifier) => Lang.Lift(
            Lang.apply(
