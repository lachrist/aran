...
//   completion: boolean
// }
exports.PROGRAM = (scope, node, context, _variables1, _variables2) => (
  ...
  scope = (
    ...
    scope),
  _variables1 = Query._get_closure_hoisting(node.body),
  _variables2 = Query._get_block_hoisting(node.body),
  State._run_session(
    context.state,
        ...
        ArrayLite.forEach(
          (
            ...
            (
              ...
              ArrayLite.concat(_variables1, _variables2) :
