...
exports.BlockStatement = (node, scope, lexic, labels) => Build.Block(
  ...
  Scope.BLOCK(
    node,
    false,
    Collect.Lets(node.body),
    Collect.Consts(node.body),
    (scope) => Block.Body(node.body, scope, lexic)));

exports.ExpressionStatement = (node, scope, lexic, labels) => Build.Expression(
...
exports.LabeledStatement = (node, scope, lexic, labels) => Visit.Node(
  ...
  (
    ...
    labels :
    ArratLite.concat(labels, [node.label.name])));
