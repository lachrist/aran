...
exports.EmptyStatement = ({}, scope, lexic, labels) => [];

exports.BlockStatement = ({body:statements}, scope, lexic, labels) => Build.Block(
  labels,
  Scope.BLOCK(
    statements,
    false,
...
exports.ExpressionStatement = ({expression:expression}, scope, lexic, labels) => Build.Expression(
  Visit.node(expression, scope, true, null));

exports.LabeledStatement = ({label:{name:label}, body:statement}, scope, lexic, labels) => Visit.Node(
  statement,
  scope,
  lexic,
  (
    ...
    labels :
    ArratLite.concat(labels, [label])));

exports.SwitchStatement = (node, scope, lexic, labels) => Scope.Cache(
  scope,
...
exports.SwitchCase = (node, scope, lexic, labels) => Build.If(
  labels,
  Build.conditional(
    Scope.get(
      scope,
...
// set 123
// 129319
exports.WithStatement = (node, scope, lexic, labels, _nodes) => (
  _nodes = (
...
exports.IfStatement = (node, scope, lexic, labels, _nodes1, _nodes2) => (
  _nodes1 = (
...
exports.BreakStatement = (node, scope, lexic, labels, _label) => (
  _label = (
    node.label === null ?
    null :
    node.label.name),
...
exports.ContinueStatement = (node, scope, lexic, labels, _label) => (
  _label = (
    node.label === null ?
    null :
    node.label.name),
...
exports.TryStatement = (node, scope, lexic, labels) => Build.Try(
  labels,
  Scope.BLOCK(
    scope,
    false,
...
exports.VariableDeclaration = (node, scope, lexic, labels) => ArrayLite.flatMap(
  node.declarations,
...
exports.FunctionDeclaration = (node, scope, lexic, labels) => [];

exports.ClassDeclaration = ({id:{name:estree_identifier}, superClass:estree_nullable_expression, body:estree_class_body}, scope, dropped, cache) => Throw("Unfortunately, Aran does not support class declarations (yet)...");

exports.WhileStatement = (node, scope, lexic, labels, _nodes) => (
  _nodes = (
    node.body.type === "BlockStatement" ?
    node.body.body :
    [node.body]),
...
exports.DoWhileStatement = (node, scope, lexic, labels, _nodes) => (
  _nodes = (
    node.body.type === "BlockStatement" ?
    node.body.body :
    [node.body]),
...
exports.ForStatement = (node, scope, lexic, labels, _nodes) => (
  _nodes = (
    node.body.type === "BlockStatement" ?
    node.body.body :
    [node.body]),
...
exports.ForInStatement = (node, scope, lexic, labels, _nodes) => (
  _nodes = (
    node.body.type === "BlockStatement" ?
    node.body.body :
    [node.body]),
...
//   await: boolean;
// }
exports.ForOfStatement = (node, scope, lexic, labels, _nodes) => (
  _nodes = (
    node.body.type === "BlockStatement" ?
    node.body.body :
    [node.body]),
