...
const finalize_target = (expression, check, result) => (
  ...
  (
    (
      () => { throw new global_Error("Must check the result") })
    ()));
...
exports._builtin_name_array = ArrayLite.concat(
  grabbable,
  [
    // Convertion //
    "Object",
...
exports.grab = (name) => (
  ...
  (
    (
      () => { throw new global_Error("Cannot grab builtin") })
    ()));

// exports.object_prototype = () => Tree.__builtin__("Object.prototype");
//
// exports.global = () => Tree.__builtin__("global");
//
// exports.eval = () => Tree.__builtin__("eval");
//
// exports.symbol_unscopables = () => Tree.__builtin__("Symbol.unscopables");
//
// exports.symbol_iterator = () => Tree.__builtin__("Symbol.iterator");
//
// exports.array_prototype_values = () => Tree.__builtin__("Array.prototype.values");
//
// exports.function_prototype_arguments_getter = () => Tree.__builtin__("Function.prototype.arguments.__get__");
//
// exports.function_prototype_arguments_setter = () => Tree.__builtin__("Function.prototype.arguments.__set__");
...
exports.define_property = (target, key, descriptor, check, result, _descriptor) => (
...
exports.fill = (array, element, check, result) => finalize_target(
  Tree.apply(
...
exports.push = (array, element, check, result) => (
  ...
  (
    (
      () => { throw new global_Error("push cannot return the target") })
    ()) :
  finalize_target(
    Tree.apply(
