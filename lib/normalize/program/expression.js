    ...
    (
      ...
      ArrayLite.reduce(
        ...
        Builtin.construct_object(
          ...
          [])))),
  (
    ArrayLite.some(node.properties, (node) => node.method || node.kind !== "init") ?
    Scope.box(
      scope,
        ...
        Scope.write(
          ...
          (
            ...
            Builtin.construct(
              Scope.get(
                scope,
                Scope._get_binding_super(scope)), // console.assert(Scope._get_binding_super_nullable_box(scope) !== null)
              Builtin.concat(
                ArrayLite.map(
                  node.arguments,
                  (argument) => (
            ...
            Tree.construct(
              Scope.get(
                scope,
                Scope._get_binding_super(scope)),
              ArrayLite.map(
                node.arguments,
                (argument) => Expression.visit(scope, argument, Expression._default_context))))),
        Scope.read(scope, "this"))) :
