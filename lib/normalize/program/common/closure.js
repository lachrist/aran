...
exports.closure = (scope, node, context, _hoisting, _expression) => (
  ...
  _expression = Tree[context.sort](
    Scope.CLOSURE(
      scope,
      node.__sentry_use_strict__,
      context,
      {
        is_body_eval_free: !node.body.__sentry_direct_eval_call__,
        is_head_eval_free: !node.__sentry_direct_eval_call__,
        is_head_closure_free: !node.__sentry_closure__},
      ArrayLite.concat(
        (
          _has_callee ?
          [] :
          ...
          (
            ...
            (
              (
                _has_arguments &&
                ArrayLite.some(
                  node.body.__sentry_capture__,
                  is_arguments_closure_variable)) ?
              Meta.Box(
                scope,
                false,
            ...
            (scope) => (
              (
                (closure) => (
                  ...
                  Scope.Box(
                    scope,
                    "ProgramCommonClosureParamsEvalFrame",
                    false,
                    Builtin.create_object(
                      Tree.primitive(null),
                      []),
                    (frame_box) => closure(
                      Scope._extend_eval(scope, frame_box))) :
                  closure(scope)))
              (
                (scope) => Tree.Bundle(
                  [
                      ...
                      (
                        (
                          (closure) => (
                            ...
                            Scope.Box(
                              scope,
                              "ProgramCommonClosureBodyEvalFrame",
                              false,
                              Builtin.construct_object(
                                Tree.primitive(null),
                                []),
