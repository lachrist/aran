...
const Expression = {
  ...
  visit: (scope, expression, context) => {
    Assert.deepEqual(context, Expression._default_context);
    ...
    if (expression.type === "CallExpression") {
      ...
      return Scope.eval(scope, Expression.visit(scope, expression.arguments[0], Expression._default_context));
    }
...
const Statement = {
  _hoisted_context: {foobar:"statement-hoisted-context"},
    ...
    if (statement.type === "VariableDeclaration") {
      ...
      return Tree.Lift(
        Scope.write(
          ...
          Expression.visit(scope, statement.declarations[0].init, Expression._default_context)));
    }
