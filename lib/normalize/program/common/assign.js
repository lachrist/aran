...
const visit = (scope, kind, pattern, expression) => visitors[pattern.type](scope, kind, pattern, expression);
...
visitors.CallExpression = (scope, kind, pattern, expression) => Tree.sequence(
...
visitors.MemberExpression = (scope, kind, pattern, expression) => Scope.box(
  scope,
  false,
  "AssignMemberRight",
  expression,
...
visitors.Identifier = (scope, kind, pattern, expression) => (
  kind === null ?
  Scope.write(scope, pattern.name, expression) :
  Scope.initialize(scope, kind, pattern.name, expression));

visitors.AssignmentPattern = (scope, kind, pattern, expression) => Scope.box(
  scope,
  false,
...
visitors.ObjectPattern = (scope, kind, pattern, expression) => Scope.box(
  scope,
  false,
  "AssignObjectRight",
  expression,
...
visitors.ArrayPattern = (scope, kind, pattern, expression) => Scope.box(
  scope,
  false,
  "PatterArrayRight",
  expression,
