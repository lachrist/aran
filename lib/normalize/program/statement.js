...
const body = (nodes, completion) => (scope) => Tree.Bundle(
  ArrayLite.map(
    ArrayLite.concat(
      ArrayLite.filter(nodes, is_function_declaration_node),
      ArrayLite.filterOut(nodes, is_function_declaration_node)),
                ...
                ArrayLite.map(
                  ...
                  (node, index, nodes) => (
                    (
                      index === 0 ?
                      null :
                      _offset += ArrayLite.filterOut(nodes[index - 1].consequent, is_function_declaration_node).length),
                    (
                      node.test === null ?
                        ...
                        [
                          ...
                          Tree.Lone(
                            ...
                            Scope.CASE(
                              ...
                              (scope) => Tree.Bundle(
                                ArrayLite.map(
                                  ArrayLite.filterOut(node.consequent, is_function_declaration_node),
                                  (node, index, nodes) => Statement.Visit(
                                    scope,
                                    node,
                                    {
