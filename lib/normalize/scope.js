...
exports.get = (scope, cache) => {
  if ("identifier" in cache) {
    if (lookup(sope, cache.identifier) === null) {
...
exports.cache = (scope, $identifier, right, closure, _identifier) => (
  (
    typeof right === "object" &&
    right !== null) ?
  (
    _identifier = hide(scope, $identifier),
    Build.sequence(
      Build.write(_identifier, right),
      closure(
        {
          __proto__: null,
