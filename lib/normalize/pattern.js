...
exports.expression_assignment

exports.cache_assignment
...
visitors.ObjectPattern = ({properties:assignment_properties}, scope, cache1, is_initialization) => Build.conditional(
  Build.conditional(
    Build.binary(
      "===",
      Scope.get(scope, cache1),
  ...
  (
    (
      assignment_properties.length &&
      assignment_properties[assignment_properties.length-1].type === "RestElement") ?
    (
      (
        function self (index, list) { return (
          assignment_properties[index].type === "RestElement" ?
          Scope.cache(
            scope,
            "PatternObjectRest",
            Build.apply(
              ...
              (
                function self (list) { return (
                  ...
                  Build.sequence(
                    ...
                    self(list.cdr)) :
                  visit(scope, is_initialization, assignment_properties[index].argument)(cache2))})
              (list))) :
          Scope.cache(
            scope,
            "PatternObjectRestKey",
            (
              assignment_properties[index].key.type === "Literal" ?
              assignment_properties[index].key.value :
              (
                assignment_properties[index].computed ?
                Visit.node(assignment_properties[index].key, scope, false, null) :
                assignment_properties[index].key.name)),
              ...
              Scope.cache(
                ...
                Object.get(
                  Object.objectify(
                    () => Scope.get(scope, cache1)),
                  Scope.get(scope, cache2)),
                visit(scope, is_initialization, assignment_properties[index].value)),
              self(
                index + 1,
                {
                  __proto__: null,
    ...
    (
      (
        function self (index) { return (
          index === assignment_properties.length ?
          Build.primitive(void 0) :
          Build.sequence(
            Scope.cache(
              scope,
              ...
              Object.get(
                ...
                (
                  assignment_properties[index].computed ?
                  Visit.node(assignment_properties[index].key, scope, false, null) :
                  Build.primitive(assignment_properties[index].key.name))),
              visit(scope, assignment_properties[index][index].value, is_initialization)),
            self(index + 1)))})
      (0)));
...
visitors.ArrayPattern = ({elements:nullable_patterns}, scope, cache1, is_initialization) => Scope.cache(
  scope,
  ...
  (cache2) => (
    (
      (
        function self (index) { return (
          index === nullable_patterns.length ?
          Build.primitive(void 0) :
          (
            nullable_patterns[index].type === "RestElement" ?
            Scope.cache(
              scope,
              ...
              (cache3) => Build.sequence(
                Build.apply(
                  ...
                  Build.primitive(void 0),
                  []),
                visit(scope, is_initialization, nullable_patterns[index].argument)(cache3))) :
            Build.sequence(
              Scope.cache(
                scope,
                "PatternArrayChild",
                Object.get(
                  Build.apply(
                    ...
                    []),
                  Build.primitive("value")),
                visit(scope, is_initialization, nullable_patterns[index])),
              self(index + 1))))})
      (0))));
