...
Assert.deepEqual(Other._has_use_strict_directive(parse(`
  "foo";
  "bar";
  "use strict";
`).body), true);
...
Other._get_valuation(parse(`let x = 1;`).body[0], false);
Other._get_valuation(parse(`debugger;`).body[0], false);
Other._get_valuation(parse(`function f () {}`).body[0], false);
Other._get_valuation(parse(`;`).body[0], false);
Other._get_valuation(parse(`class C {};`).body[0], false);
Other._get_valuation(parse(`123;`).body[0], true);
Other._get_valuation(parse(`{; 123; }`).body[0], true);
Other._get_valuation(parse(`{;;}`).body[0], false);
Other._get_valuation(parse(`l: break l;`).body[0].body, "l");
Other._get_valuation(parse(`l: break l;`).body[0], false);
Other._get_valuation(parse(`l: k : break l;`).body[0].body, "l");
Other._get_valuation(parse(`while (123) break;`).body[0].body, null);
