...
// }) ());
exports._has_direct_eval_call = (statement) => {
    ...
    if (length1 > 0) {
      ...
      if (type === "ExpressionStatement") {
        ...
        if (statement.finalizer !== null) {
          statements[length1++] = statement.finalizer.body;
        }
      } else if (type === "VariableDeclaration") {
        for (let index = 0; index < statements.declarations.length; index++) {
        ...
        // console.assert(type === "FunctionDeclaration" || type === "ClassDeclaration" || type === "BreakStatement" || type === "ContinueStatement" || type === "EmptyStatement");
    ...
    if (length2 > 0) {
      ...
      if (type === "UpdateExpression") {
        ...
        if (expression.computed) {
          expressions[length2++] = expression.computed;
        }
