...
// }) ());
exports._has_direct_eval_call = (statements, expressions, patterns) => {
  statements = ArrayLite.concat(statements);
  expressions = ArrayLite.concat(expressions);
  patterns = ArrayLite.concat(patterns);
  let length1 = statements.length;
  let length2 = expressions.length;
  let length3 = patterns.length;
