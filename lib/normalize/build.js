...
ArrayLite.forEach(["block", "statement", "expression"], (type) => {
  ArrayLite.forEach(global_Reflect_ownKeys(Syntax[type]), (constructor) => {
    if (Syntax[type][constructor].length === 0) {
      exports[constructor] = () => State.associate_current_serial_to_node(Build[constructor]());
    } else if (Syntax[type][constructor].length === 1) {
      exports[constructor] = (field1) => State.associate_current_serial_to_node(Build[constructor](field1));
    } else if (Syntax[type][constructor].length === 2) {
      exports[constructor] = (field1, field2) => State.associate_current_serial_to_node(Build[constructor](field1, field2));
    } else if (Syntax[type][constructor].length === 3) {
      exports[constructor] = (field1, field2, field3) => State.associate_current_serial_to_node(Build[constructor](field1, field2, field3));
    } else {
      // console.assert(Syntax[type][constructor].length === 4);
      exports[constructor] = (field1, field2, field3, field4) => State.associate_current_serial_to_node(Build[constructor](field1, field2, field3, field4));
    }
  });
});
