...
const finalize = (expression, check, result, message) => (
...
exports.preventExtensions = (target, check, result) => (
  (
    !check &&
    result === TARGET_RESULT ?
  Tree.apply(
...
exports.setPrototypeOf = (target, prototype, check, result) => (
  (
    !check &&
    result === TARGET_RESULT) ?
  Tree.apply(
...
exports.defineProperty = (target, key, descriptor, check, result, _descriptor) => (
...
exports.set = (target, key, value, receiver, check, result) => finalize(
  Tree.apply(
...
exports.deleteProperty = (target, key, check, result) => finalize(
  Tree.apply(
