 ...
 * ) => Z[]}
 */
export const mapReduce = (xs, f, g, y) => {
  const { length: l } = xs;
 ...
 * ) => Z[]}
 */
export const mapReduceIndex = (l, f, g, y) => {
  const zs = new Array(l);
  for (let i = 0; i < l; i += 1) {
    zs[i] = f(y, i);
    y = g(y, i);
 ...
 * ) => Z[]}
 */
export const reduceMap = (xs, f, g, y) => {
  const { length: l } = xs;
  const zs = new Array(l);
  for (let i = 0; i < l; i += 1) {
    y = f(y, xs[i]);
 ...
 * ) => Z[]}
 */
export const reduceMapIndex = (l, f, g, y) => {
  const zs = new Array(l);
  for (let i = 0; i < l; i += 1) {
    y = f(y, i);
    zs[i] = g(y, i);
