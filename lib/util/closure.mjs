...
/**
 * @type {<B extends boolean, X, Y>(
 *   condition: B,
 *   x: X,
 *   y: Y,
 * ) => B extends true ? X : Y}
 */
export const conditional = (c, x, y) => /** @type {any} */ (c ? x : y);
 ...
 * ) => X | Y}
 */
export const guard = (guard, change, main) => (guard ? change(main) : main);

export const guardX = guard;
 ...
 * ) => X | Y}
 */
export const guardX_ = (guard, change, main, additional) =>
  guard ? change(main, additional) : main;
 ...
 * @type {<X>(x: X) => () => X}
 */
export const constant0 = (x) => () => x;

/**
 * @type {<X>(x: X) => <Y1>(y1: Y1) => X}
 */
export const constant1 = (x) => (_y1) => x;

/**
 * @type {<X>(x: X) => <Y1, Y2>(y1: Y1, y2: Y2) => X}
 */
export const constant2 = (x) => (_y1, _y2) => x;

/**
 * @type {<X>(x: X) => <Y1, Y2, Y3>(y1: Y1, y2: Y2, y3:Y3) => X}
 */
export const constant3 = (x) => (_y1, _y2, _y3) => x;

/**
 * @type {<X>(x: X) => <Y1, Y2, Y3, Y4>(y1: Y1, y2: Y2, y3:Y3, y4:Y4) => X}
 */
export const constant4 = (x) => (_y1, _y2, _y3, _y4) => x;

/**
 * @type {<X>(x: X) => <Y1, Y2, Y3, Y4, Y5>(y1: Y1, y2: Y2, y3:Y3, y4:Y4, y5:Y5) => X}
 */
export const constant5 = (x) => (_y1, _y2, _y3, _y4, _y5) => x;

/**
 * @type {<X>(x: X) => <Y1, Y2, Y3, Y4, Y5, Y6>(y1: Y1, y2: Y2, y3: Y3, y4: Y4, y5: Y5, y6: Y6) => X}
 */
export const constant6 = (x) => (_y1, _y2, _y3, _y4, _y5, _y6) => x;

/**
 * @type {<X>(x: X) => <Y1, Y2, Y3, Y4, Y5, Y6, Y7>(y1: Y1, y2: Y2, y3: Y3, y4: Y4, y5: Y5, y6: Y6, y7: Y7) => X}
 */
export const constant7 = (x) => (_y1, _y2, _y3, _y4, _y5, _y6, _y7) => x;
...
/**
 * @type {<X1, X2, Y>(f: (x1:X1, x2:X2) => Y) => ((x2:X2, x1:X1) => Y)}
 */
export const flip$$ = (f) => (x2, x1) => f(x1, x2);

/**
 * @type {<X1, X2, X3, Y>(f: (x1:X1, x2:X2, x3:X3) => Y) => ((x1:X1, x3:X3, x2:X2) => Y)}
 */
export const flip_$$ = (f) => (x1, x3, x2) => f(x1, x2, x3);

/**
 * @type {<X1, X2, X3, Y>(f: (x1:X1, x2:X2, x3:X3) => Y) => ((x3:X3, x2:X2, x1:X1) => Y)}
 */
export const flip$_$ = (f) => (x3, x2, x1) => f(x1, x2, x3);

/**
 * @type {<X1, X2, X3, Y>(f: (x1:X1, x2:X2, x3:X3) => Y) => ((x2:X2, x1:X1, x3:X3) => Y)}
 */
...
/**
 * @type {<X1, X2>(x1: X1, x2: X2) => X1}
 */
export const return$_ = (x1, _x2) => x1;

/**
 * @type {<X1, X2>(x1: X1, x2: X2) => X2}
 */
export const return_$ = (_x1, x2) => x2;

/**
 * @type {<X1, X2, X3>(x1: X1, x2: X2, x3: X3) => X1}
 */
export const return$__ = (x1, _x2, _x3) => x1;

/**
 * @type {<X1, X2, X3>(x1: X1, x2: X2, x3: X3) => X2}
 */
export const return_$_ = (_x1, x2, _x3) => x2;

/**
 * @type {<X1, X2, X3>(x1: X1, x2: X2, x3: X3) => X3}
 */
export const return__$ = (_x1, _x2, x3) => x3;

/**
 * @type {<X1, X2, X3, X4>(x1: X1, x2: X2, x3: X3, x4: X4) => X1}
 */
export const return$___ = (x1, _x2, _x3, _x4) => x1;

/**
 * @type {<X1, X2, X3, X4>(x1: X1, x2: X2, x3: X3, x4: X4) => X2}
 */
export const return_$__ = (_x1, x2, _x3, _x4) => x2;

/**
 * @type {<X1, X2, X3, X4>(x1: X1, x2: X2, x3: X3, x4: X4) => X3}
 */
export const return__$_ = (_x1, _x2, x3, _x4) => x3;

/**
 * @type {<X1, X2, X3, X4>(x1: X1, x2: X2, x3: X3, x4: X4) => X4}
 */
export const return___$ = (_x1, _x2, _x3, x4) => x4;

/**
 * @type {<X1, X2, X3, X4, X5>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5) => X1}
 */
export const return$____ = (x1, _x2, _x3, _x4, _x5) => x1;

/**
 * @type {< X1, X2, X3, X4, X5>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5) => X2}
 */
export const return_$___ = (_x1, x2, _x3, _x4, _x5) => x2;

/**
 * @type {<X1, X2, X3, X4, X5>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5) => X3}
 */
export const return__$__ = (_x1, _x2, x3, _x4, _x5) => x3;

/**
 * @type {<X1, X2, X3, X4, X5>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5) => X4}
 */
export const return___$_ = (_x1, _x2, _x3, x4, _x5) => x4;

/**
 * @type {<X1, X2, X3, X4, X5>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5) => X5}
 */
export const return____$ = (_x1, _x2, _x3, _x4, x5) => x5;

/**
 * @type {<X1, X2, X3, X4, X5, X6>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => X1}
 */
export const return$_____ = (x1, _x2, _x3, _x4, _x5, _x6) => x1;

/**
 * @type {<X1, X2, X3, X4, X5, X6>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => X2}
 */
export const return_$____ = (_x1, x2, _x3, _x4, _x5, _x6) => x2;

/**
 * @type {<X1, X2, X3, X4, X5, X6>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => X3}
 */
export const return__$___ = (_x1, _x2, x3, _x4, _x5, _x6) => x3;

/**
 * @type {<X1, X2, X3, X4, X5, X6>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => X4}
 */
export const return___$__ = (_x1, _x2, _x3, x4, _x5, _x6) => x4;

/**
 * @type {<X1, X2, X3, X4, X5, X6>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => X5}
 */
export const return____$_ = (_x1, _x2, _x3, _x4, x5, _x6) => x5;

/**
 * @type {<X1, X2, X3, X4, X5, X6>(x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => X6}
 */
...
/**
 * @type {<X1, X2, Y>(f: (x1: X1, x2: X2) => Y) => (x1: X1, x2: X2) => Y}
 */
