...
/**
 * @template X1
 * @type {(message: string) => (x1: X1) => never}
 */
...
/**
 * @template X1, X2
 * @type {(message: string) => (x1: X1, x2: X2) => never}
 */
...
/**
 * @template X1, X2, X3
 * @type {(message: string) => (x1: X1, x2: X2, x3: X3) => never}
 */
 ...
 * @type {(message: string) => (x1: X1, x2: X2, x3: X3, x4: X4) => never}
 */
 ...
 * @type {(message: string) => (x1: X1, x2: X2, x3: X3, x4: X4, x5: X5) => never}
 */
 ...
 * @type {(message: string) => (x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6) => never}
 */
...
/**
 * @template X1, X2, X3, X4, X5, X6, X7
 * @type {(message: string) => (x1: X1, x2: X2, x3: X3, x4: X4, x5: X5, x6: X6, x7: X7) => never}
 */
