...
module.exports = (block, {namespace, pointcut, nodes, serials, tag}) => Visit["block-" + tag](
  block,
  1 / 0,
  {
    __proto__: null,
    ...
    visitors: {
      __proto__: visitors,
      _trap: maketraps(namespace, pointcut, nodes)}});
...
const visitors = {
  ...
  // Statement //
  Expression: function (expression, serial) {
    return Build.Expression(this._traps.drop(expression), serial);
  },
  ...
  // Expression Consumer //
  sequence: function (expression1, expression2, serial) {
    return Build.sequence(this._traps.drop(expression1, serial), expression2);
  },
  throw: function (expression, serial) {
    return Build.throw(this._traps.throw(expression, serial));
  },
  write: function (identifier, expression1, expression2, serial) {
    return Build.write(identifier, this._traps.write(expression1, Build.primitive(identifier), serial), expression2);
  },
