...
const visit_block = (context, block) => Tree._dispatch_block(
  block_callback_object,
  context,
  block);

const visit_expression = (context, expression) => Tree._dispatch_expression(
  expression_callback_object,
  context,
  expression);

const visit_statement = (context, statement) => Tree._dispatch_statement(
    ...
    visit_expression(
      {
        ...
        dropped: node},
      expression)),
  Export: (context, node, key, argument_expression) => Tree.Export(
    key,
