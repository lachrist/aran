...
const make_trap = (unmangle, serials, _converters, _convert) => (
  _converters = {
                ...
                [
                  Tree.apply(
                    ...
                    [
                      ...
                      Tree.primitive("arguments")]),
                  Tree.primitive(0)])))])),
    "enclave-kind": (kind) => Tree.primitive(kind),
    "enclave-identifier": (identifier) => Tree.primitive(identifier),
    "perform-enclave-read": (identifier) => Tree.closure(
      "arrow",
      false,
      false,
      Tree.BLOCK(
    ...
    "perform-enclave-typeof": (identifier) => Tree.closure(
      "arrow",
      false,
      false,
      Tree.BLOCK(
    ...
    "perform-enclave-write": ({strict, identifier}) => Tree.closure(
      "arrow",
      false,
      false,
      Tree.BLOCK(
                ...
                [
                  Tree.apply(
                    ...
                    [
                      ...
                      Tree.primitive("arguments")]),
                  Tree.primitive(0)])))])),
    "perform-enclave-super-member": (unit) => Tree.closure(
      "arrow",
      false,
      false,
      Tree.BLOCK(
                ...
                [
                  Tree.apply(
                    ...
                    [
                      ...
                      Tree.primitive("arguments")]),
                  Tree.primitive(0)])))])),
    "perform-enclave-super-call": (unit) => Tree.closure(
      "arrow",
      false,
      false,
      Tree.BLOCK(
    ...
    "delegate": (delegate) => Tree.primitive(delegate),
    "asynchronous": (asynchronous) => Tree.primitive(asynchronous),
    "generator": (generator) => Tree.primitive(generator),
    "label": (label, _object) => (
...
const statement_callback_object = {
  __proto__: null,
  EnclaveDeclare: (context, node, kind, identifier, expression) => Tree.EnclaveDeclare(
    kind,
    identifier,
...
const update_callee_1 = (context, node, expression1, expression2, expressions) => Tree.apply(
  ...
  [
    ...
    expressions[1],
    expressions[2],
    Tree._extract(context, expressions[3], "closure", update_callee_2),
    expressions[4]]);

const update_callee_2 = (context, node, sort, asynchronous, generator, block) => Tree.closure(
  sort,
  asynchronous,
  generator,
...
const expression_callback_object = {
  ...
  closure: (context, node, sort, asynchronous, generator, block, _expression, _identifier) => check_dropped_1(
    context.weave,
    context.dropped,
    (
      _expression = context.weave.closure(
        ...
        node),
      (
        Tree._match(null, _expression, closure_matcher) ?
        _expression :
        (
          ...
          Tree.sequence(
            Tree.write(
              _identifier,
              Tree._extract(_identifier, _expression, "apply", update_callee_1)),
  ...
  intrinsic: (context, node, intrinsic) => check_dropped_1(
    ...
    context.weave.intrinsic(
      ...
      node)),
  // Consumer //
  await: (context, node, expression) => check_dropped_1(
    context.weave,
    context.dropped,
    Tree.await(
      context.weave.await(
        visit_expression(expression, context, null),
        node))),
  yield: (context, node, delegate, expression) => check_dropped_1(
    context.weave,
    context.dropped,
    Tree.yield(
      delegate,
