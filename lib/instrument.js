...
// type Identifier = (CalleeIdentifier, AdviceIdentifier, ParametersIdentifier)
// type CalleeIdentifier = aran.Identifier
// type AdviceIdentifier = aran.Identifier
// type ParametersIdentifier = aran.Identifier
module.exports = (block, {local, serials, pointcut, show, namespace}, _context) => (
  _context = {
    __proto__: {
      __proto__: null,
      weave: make_weave(
        make_cut(show, serials, pointcut),
        make_trap(show, serials, namespace.parameters, namespace.advice)),
      make_callee_identifier: namespace.callee,
      show},
  ...
  (
    local ?
    Tree._dispatch_block(block_callback_object, _context, block) :
    Tree.BLOCK(
    [],
    [
      Tree.Return(
        Tree.arrow(
          Tree.BLOCK(
            [namespace.advice, namespace.parameters],
            [
              Tree.Lift(
                Tree.write(
                  namespace.advice,
