        ...
        (
          ...
          (
            ...
            (
              ...
              (
                Throw.assert(
                  typeof options.pointcut === "object",
                  null,
                  `options.pointcut must either be: null, a boolean, a function, an array, or an object`),
                options.pointcut))))),
      make_trap(options.show, options.serials)),
...
const block_callback_object = {
  __proto__: null,
  BLOCK: (context, node, identifiers, statements, _identifiers, _statements, _expression1, _expression2, _expression3, _expression4) => (
...
const update_callee_3 = (context, node, identifiers, statements) => Tree.BLOCK(
  identifiers,
  ArrayLite.concat(
    [
      Tree.Lift(
