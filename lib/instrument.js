...
const program_callback_object = {
  __proto__: null,
  ScriptProgram: (context, node, block) => Tree.ScriptProgram(
    visit_block_from_program(
      block,
      context,
      "script"
      [])),
  ModuleProgram: (context, node, links, block) => Tree.ModuleProgram(
    visit_block_from_program(
      block,
      context,
      "module",
  ...
  EvalProgram: (context, node, identifiers, block) => Tree.EvalProgram(
    identifiers,
    visit_block_from_program(
      block,
      context,
...
const visit_block_from_program = (block, program_context, sort, links) => Tree.dispatch(
  {
