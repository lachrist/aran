...
/**
 * @template L
 * @typedef {import("../type/options.d.ts").RootOptions<L>} RootOptions
 */

/**
 * @template L
 * @typedef {import("../type/options.d.ts").NodeOptions<L>} NodeOptions
 */

const DEFAULT_GLOBAL = /** @type {estree.Variable} */ ("globalThis");
...
const DEFAULT_BASE = /** @type {Base} */ ("main");

/**
 * @type {Locate<string>}
 */
const locateDefault = (path, root) => `${root}.${path}`;
