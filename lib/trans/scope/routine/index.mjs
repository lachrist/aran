...
/**
 * @type {(
 *   routine: import("./index.d.ts").Routine,
 * ) => (
 *   | "illegal"
 *   | "simple"
 *   | "constructor"
 ...
 *   routine: import("./index.d.ts").ClosureRoutine,
 ...
 *   hash: import("../../hash.d.ts").Hash,
 *   routine: (
 *     | import("./index.d.ts").MethodRoutine
 *     | import("./index.d.ts").ConstructorRoutine
 *   ),
 * ) => import("../../atom.d.ts").Expression}
 */
...
/**
 * @type {import("./index.d.ts").RootRoutine}
 */
...
/**
 * @type {(
 *   closure: Exclude<import("./index.d.ts").Closure, import("./index.d.ts").ArrowClosure>,
 ...
 *   import("./index.d.ts").Closure,
 *   (
 *     | import("../../prelude/index.d.ts").PrefixPrelude
 *     | import("../../prelude/index.d.ts").MetaDeclarationPrelude
 *   ),
 *   import("./index.d.ts").RoutineScope,
 * >}
 */
...
/**
 * @type {<S extends import("./index.d.ts").RoutineScope>(
 *   scope: S,
 ...
 *   import("./index.d.ts").RoutineScope,
 *   import("./index.d.ts").ReadThisOperation,
 *   never,
 * >}
 */
 ...
 * @type {import("../api.d.ts").PerformExpression<
 *   import("./index.d.ts").RoutineScope,
 *   import("./index.d.ts").ReadNewTargetOperation,
 ...
 * @type {import("../api.d.ts").PerformExpression<
 *   import("./index.d.ts").RoutineScope,
 *   import("./index.d.ts").ReadInputOperation,
 *   import("../../prelude/index.d.ts").SyntaxErrorPrelude,
 * >}
 */
 ...
 * ) => import("./index.d.ts").GetSuperOperation}
 */
...
/**
 * @type {(
 *   result: null | import("../../atom.d.ts").Expression,
 * ) => import("./index.d.ts").FinalizeResultOperation}
 */
...
export const makeFinalizeResultExpression = (
  ...
  if (kind === "illegal") {
    ...
    return incorporateExpression(
      mapSequence(
        /**
         * @type {import("../../../util/sequence.d.ts").Sequence<
         *   import("../../prelude/index.d.ts").PrefixPrelude,
 ...
 * @type {import("../api.d.ts").PerformExpression<
 *   import("./index.d.ts").RoutineScope,
 *   import("./index.d.ts").ReadResultOperation,
 *   never,
 * >}
 */
 ...
 * ) => import("./index.d.ts").SetSuperOperation}
 */
...
/**
 * @type {(
 *   input: import("../../atom.d.ts").Expression,
 * ) => import("./index.d.ts").CallSuperOperation}
 */
 ...
 *   result: import("../../atom.d.ts").Expression | null,
 * ) => import("./index.d.ts").UpdateResultOperation}
 */
