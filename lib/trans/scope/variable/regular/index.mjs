 ...
 * >}
 */
const setupRegularFrame = (hash, meta, { schrodinger, frame, links }) => {
  const options = { schrodinger, links };
  return liftSequenceX(
    makeRegularFrame,
    flatSequence(
      map(listEntry(frame), (binding) =>
 ...
 *     frame: import("../../../annotation/hoisting").Frame,
 *   },
 *   (
 *     | import("../../../prelude").MetaDeclarationPrelude
 *     | import("../../../prelude").BaseDeclarationPrelude
 ...
 * >}
 */
export const setupModuleRegularFrame = (hash, meta, { links, frame }) =>
  setupRegularFrame(hash, meta, { schrodinger: false, frame, links });
 ...
 * >}
 */
export const setupSwitchRegularFrame = (hash, meta, { frame }) =>
  setupRegularFrame(hash, meta, { schrodinger: true, frame, links: EMPTY });
 ...
 * >}
 */
export const setupNormalRegularFrame = (hash, meta, { frame }) =>
  setupRegularFrame(hash, meta, { schrodinger: false, frame, links: EMPTY });
