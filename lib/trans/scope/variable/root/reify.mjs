...
export const setupReifyBinding = (
  ...
  if (
    ...
    return declareGlobal(hash, variable, {
      configurable: sort !== "module" && sort !== "script",
      conflict_with_global_constant: includes(kinds, "var"),
    });
  }
};
  ...
  incorporateEffect(
    thenSequence(
      declareGlobal(hash, variable, {
        configurable: true,
        conflict_with_global_constant: includes(kinds, "function-sloppy-away"),
      }),
      EMPTY_SEQUENCE,
    ),
    hash,
