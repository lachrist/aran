 ...
 * ) => kind is "var" | "function-sloppy-away"}
 */
const isLateDeclareKind = (kind) =>
  kind !== "var" && kind !== "function-sloppy-away";
 ...
 *   kinds: ("var" | "function-sloppy-away")[],
 * }}
 */
 ...
 * @type {(
 *   kind: import("../annotation/hoisting").Kind,
 * ) => kind is import("../scope/variable/root").RootKind}
 */
 ...
 *   [
 *     import("../scope/variable/root").RootKind,
 *     ... import("../scope/variable/root").RootKind[],
 *   ],
 * ]}
 */
 ...
 *   options: {
 *     unbound: import("../annotation/hoisting").FrameEntry[],
 *     global_declarative_record:
 *       import("../config").GlobalDeclarativeRecord,
