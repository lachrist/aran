...
/**
 * @type {{[key in import("./hoisting").Kind]: null}}
 */
const SCOPING = {
  "import": null,
  "var": null,
...
/**
 * @type {import("./hoisting").PreciseScoping<import("./hoisting").ModuleKind>}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").ScriptKind
 * >}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").SloppyEvalKind
 * >}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").StrictEvalKind
 * >}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<import("./hoisting").BlockKind>}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").ComplexClosureHeadKind,
 * >}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").ComplexClosureBodyKind
 * >}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").SimpleClosureKind
 * >}
 */
...
/**
 * @type {import("./hoisting").PreciseScoping<
 *   import("./hoisting").StaticBlockKind
 * >}
 */
