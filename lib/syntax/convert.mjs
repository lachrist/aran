...
import { slice, map, includes, join } from "../util/index.mjs";

import { INTRINSIC_ENUM, isParameter } from "../lang.mjs";
import { convertLabel, convertVariable } from "./identifier.mjs";
import { isBigIntLiteral, isRegExpLiteral } from "../estree/literal.mjs";
...
export const convertExpression = (node) => {
  if (node.type === "Literal") {
    ...
    } /** c8 ignore start */ else if (isRegExpLiteral(node)) {
      throw makeSyntaxError(node);
    } /** c8 ignore stop */ else {
      return {
        type: "PrimitiveExpression",
