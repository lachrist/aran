...
/** @type {(node: estree.VariableDeclaration) => Variable[]} */
...
/** @type {(node: estree.Program) => Program<Location>} */
...
/** @type {(node: estree.Node) => Link<Location>} */
...
/** @type {(nodes: estree.Node[]) => { head: Variable[], tail: estree.Node[]}} */
...
/** @type {(nodes: estree.Node[], parent: estree.Node) => PseudoBlock<Location>} */
...
/** @type {(node: estree.Node) => ClosureBlock<Location>} */
...
/** @type {(node: estree.Node, labels: Label[]) => ControlBlock<Location>} */
...
/** @type {(node: estree.Node) => ControlBlock<Location>} */
...
/** @type {(node: estree.BlockStatement) => ControlBlock<Location>} */
...
/** @type {(node: estree.Node) => Statement<Location>} */
...
/** @type {(node: estree.Node) => Specifier} */
...
/** @type {(node: estree.Node) => Effect<Location>[]} */
...
/** @type {(node: estree.Node) => Expression<Location>} */
...
/** @type {(node: estree.Program) => Node<Location>} */
