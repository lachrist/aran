...
ArrayLite.forEach(
  [
    ["import", {__proto__:prototype, isModule:true, isImport:true}],
    ["var", {__proto__:prototype, isModule:true, isStrictEval:true, isClosureBody:true, isWritable:true}],
    ["function", {__proto__:prototype, isModule:true, isStrictEval:true, isClosureBody:true, isWritable:true}],
    ["let", {__proto__:prototype, isModule:true, isSloppyEval:true, isStrictEval:true, isBlock:true, isClosureBody:true, isWritable:true}],
    ["const", {__proto__:prototype, isModule:true, isSloppyEval:true, isStrictEval:true, isBlock:true, isClosureBody:true}],
    ["class", {__proto__:prototype, isModule:true, isSloppyEval:true, isStrictEval:true, isBlock:true, isClosureBody:true}],
