...
exports.identifier = (identifier) => {
  ...
  // }
  if (identifier[0] === "%") {
    identifier = global_Reflect_call(global_String_prototype_substring, identifier, [1]);
  }
  if (identifier === "this" || identifier === "new.target") {
    return true;
  }
  // Credit: https://github.com/shinnn/is-var-name //
  if (global_Reflect_apply(global_String_prototype_trim, identifier, []) !== identifier) {
    return false;
  }
  try {
    new global_Function(identifier, "var "+identifier);
  } catch (error) {
    return false;
  }
  return true;
...
exports.label = exports.identifier;
...
//   }
//   // Credit: https://github.com/shinnn/is-var-name //
//   if (global_Reflect_apply(global_String_prototype_trim, label, []) !== label) {
//     return false;
//   }
//   try {
//     new global_Function(identifier, "var "+identifier);
