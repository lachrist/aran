...
import { listIntrinsicDeclaration } from "./intrinsic.mjs";
...
/**
 * @type {(
 *   header: import("../lang/header.d.ts").DeclareHeader,
...
/**
 * @type {(
 *   node: import("./atom.d.ts").RoutineBlock,
 *   config: import("./config-internal.d.ts").InternalConfig,
 *   makeCompletion: (
 *     expression: import("estree-sentry").Expression<{}>,
 *   ) => import("estree-sentry").Statement<{}>
...
/**
 * @type {(
 *   node: import("./atom.d.ts").Program,
 *   config: import("./config-internal.d.ts").InternalConfig,
 *   optimization: import("./optimize-external.d.ts").Optimization,
...
const makeModuleProgram = (node, config, optimization) => ({
  ...
  sourceType: "module",
  body: flatenTree([
    listIntrinsicDeclaration(node, config),
    map(
      /** @type {import("../lang/header.d.ts").Header[]} */ (node.head),
      (header) =>
