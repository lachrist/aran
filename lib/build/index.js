...
exports.BLOCK = (identifiers, statements) => {
  // Comment the line below to disable runtime build checks
  duck("BLOCK", Grammar.BLOCK, [identifiers, statements]);
  return ["BLOCK", identifiers, statements];
};

exports.SWITCH_BLOCK = (identifiers, statements) => {
  // Comment the line below to disable runtime build checks
  duck("SWITCH_BLOCK", Grammar.SWITCH_BLOCK, [identifiers, statements]);
  return ["SWITCH_BLOCK", identifiers, statements];
};

ArrayLite.forEach(Object_keys(Grammar.statement), (tag) => {
  exports[capitalize(tag)] = function () {
...
ArrayLite.forEach(Object_keys(Grammar.expression), (tag) => {
