 ...
 * ) => header is import("./header").ShallowDeclareHeader}
 */
export const isShallowDeclareHeader = (header) =>
  !header.deep && header.variable !== null;

/**
 * @type {(
 *   header: import("./header").DeclareHeader,
 * ) => header is import("./header").DeepDeclareHeader}
 */
export const isDeepDeclareHeader = (header) =>
  header.deep && header.variable !== null;

/**
 * @type {(
 *   header: import("./header").DeclareHeader,
 * ) => header is import("./header").PrepareDeepDeclareHeader}
 */
export const isPrepareDeepDeclareHeader = (header) =>
  header.type === "declare.sloppy" &&
  header.kind === "var" &&
  !header.deep &&
