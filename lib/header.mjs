 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").LinkHeader}
 */
export const isLinkHeader = (header) =>
  header.type === "import" ||
  header.type === "export" ||
 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").ScriptHeader}
 */
 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").GlobalEvalHeader}
 */
 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").RootLocalEvalHeader}
 */
 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").DeepLocalEvalHeader}
 */
