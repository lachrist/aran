 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").StaticDeclareHeader}
 */
export const isStaticDeclareHeader = (header) =>
  header.type === "declare" && header.variable !== null;

/**
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").EarlyStaticDeclareHeader}
 */
export const isEarlyStaticDeclareHeader = (header) =>
  header.type === "declare" &&
  header.variable !== null &&
  header.kind !== "eval";
 ...
 * @type {(
 *   header: import("./header").Header,
 * ) => header is import("./header").LateStaticDeclareHeader}
 */
export const isLateStaticDeclareHeader = (header) =>
  header.type === "declare" &&
  header.variable !== null &&
  header.kind === "eval";
