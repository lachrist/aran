...
NAMESPACE._builtin = function AranEnumerablePropertyNames (object) {
  const keys1 = [];
  while (object) {
...
//   let object = {};
//   for (let index = 0, length = arguments.length; index < length; index += 3) {
//     const descriptor = NAMESPACE._builtin_Object_create(null);
//     descriptor.configurable = true;
//     descriptor.enumerable = true;
//     if (arguments[index] === "init") {
//       descriptor.value = arguments[index+2];
//     } else {
//       descriptor[arguments[index]] = arguments[index+2];
//     }
//     NAMESPACE._builtin_Reflect_defineProperty(object, arguments[index+1], descriptor);
//   }
//   return object;
// };
