...
test(
  ...
  [
    ...
    ["sloppy-program", null],
    ["strict-program", `Illegal enclave_loose_variable`]]);
test(
  (_) => Tree.ScriptProgram(
    null,
    Tree.CompletionStatement(
...
ArrayLite.forEach(
  ...
  (constructor) => test(
    ...
    [
      ...
      ["sloppy-program", `Illegal enclave_new_target`],
      ["strict-program", `Illegal enclave_new_target`],
...
Assert.deepEqual(
  Tree.getType(Tree.DebuggerStatement()),
  "DebuggerStatement");
