...
test(
  ...
  [
    [[null, null], null],
    [["foo", "foo"], null],
    [["foo", "bar"], `Unbound links, got: [{"type":"import","specifier":"bar","source":"source"}]`]]);
// Export //
test(
  ([specifier1, specifier2]) => Tree.ModuleProgram(
    null,
  ...
  [
    ...
    [["foo", "foo"], null],
    [["foo", "bar"], `Unbound links, got: [{"type":"export","specifier":"bar"}]`]]);
...
ArrayLite.forEach(
  ...
  (run) => test(
    run,
    [
      [["foo", "bar", "qux"], `Unbound variables, got: ["qux"]`],
      [["qux", "bar", "qux"], null],
      [["foo", "qux", "qux"], null]]));
    ...
    Tree.ListStatement(
      [
        ...
        Tree.CompletionStatement(
          Tree.PrimitiveExpression(456))])),
  [
    [["foo", "bar"], `Unbound labels, got: ["bar"]`],
    [["foo", "foo"], null]]);
test(
...
test(
  ...
  [
    [null, null],
    ["script", null],
    ["module", `Script program can only be in a script enclave`],
    ["strict-eval", `Script program can only be in a script enclave`],
    ["sloppy-eval", `Script program can only be in a script enclave`]]);
test(
  (enclave) => Tree.EvalProgram(
    ...
    [
      [null, null],
      ["script", `EvalProgram can not be in a module/script enclave`],
      ["module", `EvalProgram can not be in a module/script enclave`],
      ["strict-eval", null],
      ["sloppy-eval", null]]);
test(
  (enclave) => Tree.ModuleProgram(
    ...
    [
      [null, null],
      ["script", `ModuleProgram can only be in a module enclave`],
      ["module", null],
      ["strict-eval", `ModuleProgram can only be in a module enclave`],
      ["sloppy-eval", `ModuleProgram can only be in a module enclave`]]);
    ...
    Tree.ListStatement(
      [
        ...
        Tree.CompletionStatement(
          Tree.PrimitiveExpression(456))])),
  [
    [null, `Illegal enclave_rigid_variable`],
    ["script", null]]);
test(
  (_) => Tree.EvalProgram(
    null,
      ...
      Tree.ListStatement(
        [
          ...
          Tree.CompletionStatement(
            Tree.PrimitiveExpression(456))]))),
  [
    [null, `Illegal enclave_loose_variable`],
    ["sloppy-eval", null],
    ["strict-eval", `Illegal enclave_loose_variable`]]);
test(
  (_) => Tree.ScriptProgram(
    null,
    Tree.CompletionStatement(
...
// enclave_new_target
ArrayLite.forEach(
  ["ReadEnclaveExpression", "TypeofEnclaveExpression"],
  (constructor) => test(
    (enclave) => Tree.EvalProgram(
      enclave,
      [],
      Tree.Block(
        [],
        Tree.CompletionStatement(
          Tree[constructor]("new.target")))),
    [
      [null, `Illegal enclave_new_target`],
      ["sloppy-eval", `Illegal enclave_new_target`],
      ["strict-eval", `Illegal enclave_new_target`],
...
ArrayLite.forEach(
  ...
  (constructor) => test(
    ...
    [
      [null, `Illegal enclave_arguments`],
      ["sloppy-eval", null],
      ["strict-eval", null]]));
ArrayLite.forEach(
  ["ReadEnclaveExpression", "TypeofEnclaveExpression"],
    ...
    Tree.Block(
      ...
      Tree.CompletionStatement(
        Tree.CallSuperEnclaveExpression(
          Tree.PrimitiveExpression(123))))),
  [
    [null, `Illegal enclave_super_call`],
    ["strict-constructor", `Illegal enclave_super_call`],
    ...
    Tree.Block(
      ...
      Tree.CompletionStatement(
        Tree.GetSuperEnclaveExpression(
          Tree.PrimitiveExpression(123))))),
  [
    [null, `Illegal enclave_super_access`],
    ["strict-constructor", null],
    ["strict-derived-constructor", null],
    ["strict-method", null],
    ["strict-function", `Illegal enclave_super_access`]]);
test(
  (sort) => Tree.EvalProgram(
    "strict-method",
    [],
