...
import { MISSING_BINDING_RECORD, makePresentBinding } from "./frame.mjs";
import {
...
/**
 * @type {(plug: "alien" | "reify") => Scope}
 */
export const makeRootScope = (plug) => ({
  type: "root",
  missing: MISSING_BINDING_RECORD[plug],
});
