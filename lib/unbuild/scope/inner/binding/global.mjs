 ...
 * @type {(
 *   context: {
 *     root: import("../../../context.d.ts").ReifyGlobalRoot,
 *   },
 *   binding: import("./binding.d.ts").RootBinding & { kind: "let" | "const" | "var" },
 *   variable: estree.Variable,
 * ) => unbuild.Variable[]}
 */
export const listGlobalBindingVariable = (_context, _binding, _variable) => [];
