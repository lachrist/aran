...
export const listBindingDeclareStatement = (strict, binding, variable) => {
  switch (binding.type) {
    case "import":
      return listImportBindingDeclareStatement(strict, binding, variable);
    case "regular":
      return listRegularBindingDeclareStatement(strict, binding, variable);
    case "global":
      return listGlobalBindingDeclareStatement(strict, binding, variable);
    case "enclave":
      return listEnclaveBindingDeclareStatement(strict, binding, variable);
    default:
      throw new StaticError("invalid binding", binding);
  }
};
...
export const makeBindingReadExpression = (strict, binding, variable) => {
  switch (binding.type) {
    case "import":
      return makeImportBindingReadExpression(strict, binding, variable);
    case "regular":
      return makeRegularBindingReadExpression(strict, binding, variable);
    case "global":
      return makeGlobalBindingReadExpression(strict, binding, variable);
    case "enclave":
      return makeEnclaveBindingReadExpression(strict, binding, variable);
    default:
      throw new StaticError("invalid binding", binding);
  }
};
...
export const makeBindingTypeofExpression = (strict, binding, variable) => {
  switch (binding.type) {
    case "import":
      return makeImportBindingTypeofExpression(strict, binding, variable);
    case "regular":
      return makeRegularBindingTypeofExpression(strict, binding, variable);
    case "global":
      return makeGlobalBindingTypeofExpression(strict, binding, variable);
    case "enclave":
      return makeEnclaveBindingTypeofExpression(strict, binding, variable);
    default:
      throw new StaticError("invalid binding", binding);
  }
};
...
export const makeBindingDiscardExpression = (strict, binding, variable) => {
  switch (binding.type) {
    case "import":
      return makeImportBindingDiscardExpression(strict, binding, variable);
    case "regular":
      return makeRegularBindingDiscardExpression(strict, binding, variable);
    case "global":
      return makeGlobalBindingDiscardExpression(strict, binding, variable);
    case "enclave":
      return makeEnclaveBindingDiscardExpression(strict, binding, variable);
    default:
      throw new StaticError("invalid binding", binding);
  }
};
 ...
 */
export const listBindingWriteEffect = (strict, binding, variable, right) => {
  switch (binding.type) {
    case "import":
      return listImportBindingWriteEffect(strict, binding, variable, right);
    case "regular":
      return listRegularBindingWriteEffect(strict, binding, variable, right);
    case "global":
      return listGlobalBindingWriteEffect(strict, binding, variable, right);
    case "enclave":
      return listEnclaveBindingWriteEffect(strict, binding, variable, right);
    default:
      throw new StaticError("invalid binding", binding);
  }
};
