 ...
 * @type {(
 *   context: {
 *     root: import("../../../context.js").ReifyGlobalRoot,
 *   },
 *   binding: import("./binding.js").RootBinding & { kind: "let" | "const" | "var" },
 *   variable: estree.Variable,
 * ) => unbuild.Variable[]}
 */
export const listReifyBindingVariable = (_context, _binding, _variable) => [];
