 ...
 *   entry: import("../../query/hoist").LifespanHoist,
 *   options: {
 *     mode: "strict" | "sloppy",
 *   },
 ...
 *   [
 *     estree.Variable,
 *     import(".").LifespanExternalBinding,
 *   ],
 * >}
 */
export const bindLifespanExternal = ({}, { variable, kind }, { mode }) =>
  initSequence(
    [
      makeHeaderPrelude({
        type: `declare.${mode}`,
 ...
 */
export const makeLifespanExternalLoadExpression = (
  { path },
  _binding,
  operation,
) => {
 ...
 */
export const listLifespanExternalSaveEffect = (
  { path },
  _binding,
  operation,
) => {
