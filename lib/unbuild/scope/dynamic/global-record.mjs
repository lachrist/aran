 ...
 * >}
 */
export const setupGlobalRecordBinding = ({ path }, { kind, variable }) =>
  initSequence(
    [
 ...
 *   options: {
 *     mode: "strict" | "sloppy",
 *     record: Record<estree.Variable, import(".").BlockKind>,
 *   },
 * ) => import("../../sequence.js").PreludeSequence<
 *   import(".").GlobalRecordFrame,
 * >}
 */
export const setupGlobalRecordFrame = ({ path }, { mode, record }) =>
  mapSequence(
    flatSequence(
      map(listEntry(record), ([variable, kind]) =>
        mapSequence(
          setupGlobalRecordBinding({ path }, { mode, kind, variable }),
