 ...
 * @type {(
 *   site: import("../../site").VoidSite,
 *   hoist: import("../../query/hoist").DeadzoneHoist,
 ...
 * @type {(
 *   site: import("../../site").VoidSite,
 *   hoisting: import("../../query/hoist").DeadzoneHoist[],
 * ) => import("../../sequence").Sequence<
 *   import("../../prelude").NodePrelude,
 *   import(".").GlobalRecordFrame,
 * >}
 */
export const setupGlobalRecordFrame = ({ path }, hoisting) =>
  mapSequence(
    flatSequence(
      map(hoisting, (hoist) => setupGlobalRecordBinding({ path }, hoist)),
    ),
    (entries) => ({
      type: "global-record",
