...
import { listParamPreludeEffect } from "../param-index.mjs";
import {
  extendStaticScope,
...
/**
 * @type {<C extends {strict: boolean, scope: Scope & { type: "static"}, params: Param[]}>(
 *   context: C,
...
const makeContextBody = (context, makeBody, path) => [
  ...map(listParamPreludeEffect(context, path), (effect) =>
...
/**
 * @type {<C extends {strict: boolean, scope: Scope, params: Param[]}>(
 *   context1: C,
 *   frame: Frame,
