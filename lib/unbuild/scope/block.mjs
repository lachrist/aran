 ...
 */
const makeContextBody = (context, makeBody) => [
  ...listScopeDeclareStatement(context),
  ...makeBody(context),
];
 ...
 */
export const makeScopeControlBlock = (context1, frame, labels, makeBody) => {
  const context2 = extendContext(context1, frame);
  const body = makeContextBody(context2, makeBody);
