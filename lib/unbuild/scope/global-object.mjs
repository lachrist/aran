 ...
 */
export const makeClashGlobalObjectExpression = (
  { path },
  _context,
  { variable },
) =>
 ...
 * ) => aran.Expression<unbuild.Atom>}
 */
export const makeDiscardGlobalObjectExpression = (
  { path },
  context,
  { variable },
) =>
 ...
 * ) => aran.Expression<unbuild.Atom>}
 */
export const makeExistGlobalObjectExpression = (
  { path },
  _context,
  { variable },
) =>
 ...
 * ) => aran.Expression<unbuild.Atom>}
 */
export const makeReadGlobalObjectExpression = (
  { path },
  _context,
  { variable },
) =>
 ...
 * ) => aran.Effect<unbuild.Atom>[]}
 */
export const listWriteGlobalObjectEffect = (
  { path },
  context,
  { variable, right },
) => [
