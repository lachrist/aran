...
/**
 * @type {{
 *   [key in import("../../../annotation/hoisting").Baseline]
 *     : import("../../../../lang").Intrinsic
 * }}
 */
const INITIAL_INTRINSIC_RECORD = {
  live: "undefined",
  dead: "aran.deadzone",
  none: "undefined",
};
      ...
      (sloppy_function) =>
        initSequence(
          [
            makeBaseDeclarationPrelude([
              mangleBaseVariable(binding.variable),
              INITIAL_INTRINSIC_RECORD[binding.baseline],
            ]),
          ],
          [
            binding.variable,
            {
              type: "regular",
              baseline: binding.baseline === "dead" ? "dead" : "live",
              write: binding.write,
