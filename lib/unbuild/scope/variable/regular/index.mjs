 ...
 * >}
 */
const rebind = ({ bindings }, { fst, snd }) => ({
  fst,
  snd: {
    type: "regular",
    bindings: [snd, bindings],
  },
});
 ...
 *   meta: import("../../../meta").Meta,
 *   frame: import(".").RegularFrame,
 *   operation: import("../operation").InitializeOperation,
...
export const listRegularWriteSloppyFunctionEffect = (
  ...
  const binding = findTree(bindings, compileMatch(operation.variable));
  if (binding === null) {
    return { type: "failure", data: operation };
  } else {
