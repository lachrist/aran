 ...
 * ) => import("../../../atom").Expression}
 */
export const makeGlobalReadExpression = (hash, _bind, { variable }) =>
  makeApplyExpression(
 ...
 * ) => import("../../../atom").Expression}
 */
export const makeGlobalTypeofExpression = (hash, _bind, { variable }) =>
  makeUnaryExpression(
    "typeof",
    makeApplyExpression(
      makeIntrinsicExpression("Reflect.get", hash),
 ...
 * ) => import("../../../atom").Expression}
 */
export const makeGlobalWriteExpression = (
  hash,
  { mode },
  { variable, right },
) => {
