  ...
  mapSequence(
    ...
    (proxy) =>
      pairup(binding.variable, {
        write: binding.write,
        baseline: binding.baseline === "none" ? "live" : binding.baseline,
        proxy,
      }),
  );
 ...
 *   hash: import("../../../../hash").Hash,
 *   binding: import(".").Binding,
 *   operation: import("../../perform").WriteOperation,
 * ) => import("../../../atom").Effect[]}
 */
 ...
 *   binding: import(".").Binding,
 *   operation: Exclude<
 *     import("../../perform").VariableSaveOperation,
...
/**
 * @type {import("../../perform").ListFrameSaveEffect<
 *   import(".").FakeFrame
 * >}
 */
 ...
 *   hash: import("../../../../hash").Hash,
 *   binding: import(".").Binding,
 *   operation: import("../../perform").VariableLoadOperation,
...
/**
 * @type {import("../../perform").MakeFrameLoadExpression<
 *   import(".").FakeFrame
 * >}
 */
