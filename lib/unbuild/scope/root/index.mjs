...
const listDuplicate = (hoisting) => {
  /** @type {Record<import("../../../estree").Variable, boolean | undefined>}} */
  const record = createRecord();
  /** @type {Record<import("../../../estree").Variable, null>} */
...
const removeDuplicate = (hoisting) => {
  /**
   * @type {Record<import("../../../estree").Variable, import("../../query/hoist").DeclareHoist>}
   */
  const record = createRecord();
  for (const hoist of hoisting) {
