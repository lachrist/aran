...
const setupBinding = ({ meta }, binding) => {
  if (binding.baseline === "import") {
    throw new AranError("fake frame does not support import bindings", {
      binding,
    });
  } else if (
 ...
 * >}
 */
export const listFakeSaveEffect = (site, frame, operation) => {
