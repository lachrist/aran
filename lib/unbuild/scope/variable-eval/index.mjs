 ...
 *     path: unbuild.Path,
 *   },
 *   hoist: import("../../query/hoist").ClosureHoist,
 *   options: {
 *     record: import("../../cache").Cache,
 *   },
 ...
 *   hoisting: import("../../query/hoist").ClosureHoist[],
 * ) => import("../../sequence").Sequence<
 *   import("../../prelude").NodePrelude,
 *   import(".").EvalFrame,
 * >}
 */
export const setupEvalFrame = ({ path, meta }, hoisting) =>
  bindSequence(
    cacheConstant(
      meta,
      makeApplyExpression(
    ...
    (dynamic) =>
      mapSequence(
        flatSequence(
          map(hoisting, (hoist) =>
            setupEvalBinding({ path }, hoist, { record: dynamic }),
          ),
        ),
        (entries) => ({
          type: /** @type {"eval"} */ ("eval"),
