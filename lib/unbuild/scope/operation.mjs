 ...
 * @type {(
 *   mode: "sloppy" | "strict",
 *   input: aran.Expression<import("../atom").Atom>,
 ...
 * @type {(
 *   mode: "sloppy" | "strict",
 *   input: null | aran.Expression<import("../atom").Atom>,
 * ) => import("./operation").LoadOperation}
 */
export const makeWrapResultOperation = (mode, result) => ({
  type: "wrap-result",
  mode,
  result,
});
 ...
 *   right: aran.Expression<import("../atom").Atom> | null,
 * ) => import("./operation").SaveOperation}
 */
export const makeInitializeOperation = (
  mode,
  kind,
  manufactured,
  variable,
 ...
 * @type {(
 *   mode: "sloppy" | "strict",
 *   target: aran.Expression<import("../atom").Atom>,
 *   key: estree.PrivateKey,
 * ) => import("./operation").LoadOperation}
 */
