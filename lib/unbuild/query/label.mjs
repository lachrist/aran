...
/** @type {(node: estree.Node, kind: "break" | "continue") => boolean} */
...
/** @type {(maybe_node: estree.Node | null | undefined, kind: "break" | "continue") => boolean} */
const visitMaybe = (maybe_node, kind) =>
  maybe_node == null ? false : visit(maybe_node, kind);

/** @type {(nodes: estree.Node[], kind: "break" | "continue") => boolean} */
