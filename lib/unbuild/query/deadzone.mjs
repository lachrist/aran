    ...
    return {
      ...
      body: reduce(node.body, (x, y) => accumulateDeclaration(mode, x, y), {
        ...
        scope: {
          ...
          ...reduceEntry(
            map(
              listKey(flatMap(node.body, (node) => hoistBlock(mode, node))),
              makeNegativeEntry,
            ),
          ),
        },
    ...
    return {
      ...
      body: reduce(node.body, (x, y) => accumulateDeclaration(mode, x, y), {
        ...
        scope: {
          ...
          ...reduceEntry(
            map(
              listKey(flatMap(node.body, (node) => hoistClosure(mode, node))),
              makePositiveEntry,
            ),
          ),
        },
    ...
    return {
      ...
      cases: reduce(node.cases, (x, y) => accumulateDeclaration(mode, x, y), {
        ...
        scope: {
          ...
          ...reduceEntry(
            map(
              listKey(flatMap(node.cases, (node) => hoistBlock(mode, node))),
              makeNegativeEntry,
            ),
          ),
        },
