...
const toPublicBinding = (binding) => ({
  ...
  sloppy_function_near_counter:
    binding.kind === "function-sloppy-block" ? 1 : 0,
  sloppy_function_away_counter:
    binding.kind === "function-sloppy-closure" ? 1 : 0,
});
...
const mergeBinding = (binding1, binding2) => {
  if (
    ...
    return {
      ...binding1,
      sloppy_function_away_counter:
        binding1.sloppy_function_away_counter +
        binding2.sloppy_function_away_counter,
      sloppy_function_near_counter:
        binding1.sloppy_function_near_counter +
        binding2.sloppy_function_near_counter,
    };
  } else {
