...
const toPublicBinding = (binding) => ({
  ...
  sloppy_function_near_counter: binding.kind === "function-sloppy-near" ? 1 : 0,
  sloppy_function_away_counter: binding.kind === "function-sloppy-away" ? 1 : 0,
});
...
export const hoist = (node, path, mode) => {
  ...
  console.dir({ report, unbound, hoisting }, { depth: null });
