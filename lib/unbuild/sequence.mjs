...
//  */
// const filterOutEffectPrelude = ({ head }) =>
//   filterNarrow(head, isNotEffectPrelude);
...
//  * ) => aran.Statement<unbuild.Atom>[]}
//  */
// const flatenStatement = ({ head, tail }) => ({
//   ...map(
...
//  * >}
//  */
// export const sequenceStatement = (...sequences) => ({
//   head: flatMap(sequences, filterOutEffectPrelude),
//   tail: flatMap(sequences, flatenStatement),
// });
...
//  * >}
//  */
// export const sequenceEffect = (...sequences) => ({
//   head: flatMap(sequences, filterOutEffectPrelude),
//   tail: flatMap(sequences, flatenEffect),
// });
