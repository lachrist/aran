 ...
 * ) => site is Site<(estree.VariableDeclaration & { kind: "let" | "const "})>}
 */
...
/**
 * @type {(
 *   site: Site<estree.VariableDeclaration | estree.Expression>
 * ) => site is Site<(estree.VariableDeclaration)>}
 */
 ...
 *     | estree.StaticBlock
 *   )>,
 * ) => site is Site<estree.PropertyDefinition & {
 *   key: estree.PrivateIdentifier,
 * }>}
 */
 ...
 *     | estree.StaticBlock
 *   )>,
 * ) => site is Site<estree.MethodDefinition & {
 *   key: estree.PrivateIdentifier,
 *   kind: "method" | "get" | "set",
 * }>}
 */
