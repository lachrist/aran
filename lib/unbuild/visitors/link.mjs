...
/**
 * @type {(
 *   site: import("../site.d.ts").Site<estree.ExportSpecifier>,
 *   context: import("../context.js").Context,
 *   options: {},
 * ) => aran.Link<unbuild.Atom>}
 */
...
/**
 * @type {(
 *   site: import("../site.d.ts").Site<estree.ModuleDeclaration>,
 *   context: import("../context.js").Context,
 *   options: {},
 * ) => (aran.Link<unbuild.Atom>)[]}
 */
  ...
  switch (node.type) {
    case "ImportDeclaration": {
      ...
      if (typeof node.source.value === "string") {
        ...
        return [
          tellLog(makeImportLink(DUMMY_SOURCE, null, path), {
            name: "SyntaxError",
    ...
    case "ExportAllDeclaration": {
      if (typeof node.source.value === "string") {
        ...
        return [
          tellLog(makeAggregateLink(DUMMY_SOURCE, null, null, path), {
            name: "SyntaxError",
            message: `Illegal source type: ${typeof node.source.value}`,
          }),
        ];
