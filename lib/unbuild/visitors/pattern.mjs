...
// This module is the only one where state scope is passed functionally.
// Other modules re-assign the local scope variable instead.
// While re-assign is a side effect, functions from other modules remains pure.
// In the absence of state monad, re-assign is the preferred way.
        ...
        bindSequence(
          ...
          (part1) =>
            bindSequence(
              ...
              ({ 0: part2, 1: scope }) =>
                zeroSequence(tuple2([part1, part2], scope)),
            ),
        ),
    ),
    hash,
                            ...
                            bindSequence(
                              ...
                              ({ 0: part2, 1: scope }) =>
                                bindSequence(
                                  ...
                                  (part3) =>
                                    zeroSequence(
                                      tuple2([part1, part2, part3], scope),
                                    ),
                                ),
                            ),
                        ),
              ...
              (part1) =>
                everyNarrow(node.properties, isPatternProperty)
                  ? mapSequence(
                      ...
                      ({ 0: part2, 1: scope }) => tuple2([part1, part2], scope),
                    )
                  : incorporateFirstEffect(
                      bindSequence(
                        cacheConstant(
