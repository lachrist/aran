 ...
 */
export const makePatternContext = (
  right,
...
const unbuildItem = (
  node,
  meta,
  { digest, scope, annotation, kind, iterator, next, done },
) => {
...
/**
 * @type {(
 *   node: import("../../estree").PatternProperty,
 *   meta: import("../meta").Meta,
 *   context: import("../context").Context & {
 *     kind: "var" | "let" | "const" | null,
...
const unbuildProperty = (
  node,
  meta,
  { digest, scope, annotation, kind, object },
) => {
  const hash = digest(node);
...
const unbuildRestProperty = (
  node,
  meta,
  { digest, scope, annotation, kind, object, keys },
) => {
  const hash = digest(node);
  return incorporateEffect(
    bindSequence(
...
/**
 * @type {(
 *   node: import("../../estree").RestElement,
 *   meta: import("../meta").Meta,
 *   context: import("../context").Context & {
 *     kind: "var" | "let" | "const" | null,
 *     object: import("../cache").Cache,
...
export const unbuildPattern = (
  node,
  meta,
  { digest, scope, annotation, right, kind },
) => {
  const hash = digest(node);
                    ...
                    flatSequence(
                      map(node.properties, (node) =>
                        unbuildProperty(
                          node,
                          forkMeta((meta = nextMeta(meta))),
                          { digest, scope, annotation, kind, object: right },
                        ),
                      ),
                    ),
                  )
