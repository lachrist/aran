 ...
 * >}
 */
const unbuildParameter = (node, meta, { scope, annotation, index }) => {
 ...
 * >}
 */
const listParameterEffect = (nodes, meta, { scope, annotation }) =>
  liftSequenceX(
    flat,
    flatSequence(
      mapIndex(nodes.length, (index) =>
        unbuildParameter(nodes[index], forkMeta((meta = nextMeta(meta))), {
          scope,
          annotation,
          index,
        }),
