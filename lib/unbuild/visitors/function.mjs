 ...
 */
const makePrototypeExpression = ({ path }, { kind, konstructor }) => {
  if (kind === "method") {
    ...
    throw new AranTypeError("invalid prototype closure kind", kind);
  }
};
...
const unbuildParameter = ({ node, path, meta }, context, { index }) =>
  node.type === "RestElement"
    ? unbuildInitializePatternStatement(
    ...
    : unbuildInitializePatternStatement({ meta, node, path }, context, {
