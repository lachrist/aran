 ...
 * ) => boolean}
 */
const isPresent = (_mode, node, variable) => {
  ...
  // var argument; does not shadow arguments
...
const getCallee = (mode, node) => {
  ...
  return isPresent(mode, node, callee) ? callee : null;
};
...
const getInput = (mode, node) => {
  ...
  return isPresent(mode, node, INPUT) ? INPUT : null;
};
