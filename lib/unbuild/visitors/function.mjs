...
/**
 * @type {(node: import("estree-sentry").Pattern<import("../../hash").HashProp>) => boolean}
 */
...
/**
 * @type {(
 *   variable: import("estree-sentry").Variable<import("../../hash").HashProp>,
...
/**
 * @type {(
 *   site: import("../site").Site<import("estree-sentry").Pattern<import("../../hash").HashProp>>,
...
/**
 * @type {(
 *   sites: import("../site").Site<import("estree-sentry").Pattern<import("../../hash").HashProp>[]>,
 *   scope: import("../scope").Scope,
 * ) => import("../../sequence").Sequence<
 *   import("../prelude").BodyPrelude,
 *   import("../atom").Effect[],
...
/**
 * @type {(
 *   node: import("estree-sentry").Pattern<import("../../hash").HashProp>,
...
/**
 * @type {(
 *   site: import("estree-sentry").Function<import("../../hash").HashProp>,
 *   meta: import("../meta").Meta,
 *   context: (
 *     & import("../context").Context
 *     & import("../function").ClosureParam
 *     & {
...
export const unbuildFunction = (
  node,
  meta,
  { scope: parent_scope, annotation, name, ...param },
) => {
