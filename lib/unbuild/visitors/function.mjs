 ...
 *     kind: aran.FunctionKind | "derived",
 *     path: unbuild.Path,
 *   },
 * ) => aran.Effect<unbuild.Atom>[]}
 */
const listThisEffect = ({ strict, self, kind, path }) => {
  switch (kind) {
    case "arrow": {
      return [];
    }
...
const listHeadStatement = (
  ...
  ...map(
    listThisEffect({
      ...
      self,
      kind:
        kind !== "arrow" && context.record["super.constructor"] !== ".illegal"
          ? "derived"
          : kind,
      path,
    }),
                  ...
                  : {
                      ...
                      "new.target":
                        kind === "method"
                          ...
                          : /** @type {aran.Parameter} */ ("new.target"),
                    },
            },
            {
              type: "block",
