 ...
 * >}
 */
const listResetResultStatement = (site, scope) =>
  liftSequenceX_(
    listEffectStatement,
    listScopeSaveEffect(site, scope, {
      type: "update-result",
      mode: getMode(scope),
      result: null,
    }),
 ...
 * >}
 */
const updateResetResultControlBlock = (site, scope, node) =>
  incorporateControlBlock(
    liftSequence__X_(
      makeControlBlock,
      node.labels,
      ...
      liftSequenceX_(
        concatXX,
        listResetResultStatement(site, scope),
        node.body,
      ),
      site.path,
    ),
...
export const unbuildStatement = (
  ...
  switch (node.type) {
    ...
    case "ExpressionStatement": {
      if (willScopeUpdateResult({ path }, scope)) {
        return liftSequenceX_(
          listEffectStatement,
          callSequence__X(
            listScopeSaveEffect,
      ...
      return liftSequenceXX(
        ...
        liftSequenceXXX_(
          ...
          hasTryFinalizer(node)
            ? // TODO investigate if new completion makes this obsolete
              //
              // /**
              //  * @type {(
