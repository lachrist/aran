 ...
 * >}
 */
export const unbuildStatement = (node, meta, context, { labels, loop }) => {
  ...
  switch (node.type) {
    ...
    case "ReturnStatement": {
      if (context.parent === "program" || context.parent === "static-block") {
        return initSequence(
          [
            makeSyntaxErrorPrelude({
        ...
        context.parent === "arrow" ||
        context.parent === "constructor" ||
        ...
        throw new AranTypeError(context.parent);
      }
    }
    case "ExpressionStatement": {
      if (isCompletion(hash, context.annotation)) {
        return liftSequenceX_(
          listEffectStatement,
          callSequence___X(
            listScopeSaveEffect,
            ...
            liftSequence_X(
              makeUpdateResultOperation,
              context.mode,
              unbuildExpression(node.expression, meta, context),
            ),
          ),
          hash,
        );
        ...
        return liftSequenceX_(
          listEffectStatement,
          unbuildEffect(node.expression, meta, context),
          hash,
        );
      }
    }
        ...
        liftSequenceX_(
          ...
          liftSequenceX_(
            ...
            liftSequence__X_(
              ...
              liftSequenceX(
                concat_,
                unbuildExpression(node.argument, meta, context),
              ),
              hash,
            ),
            hash,
      ...
      return liftSequenceX_(
        ...
        callSequence___X(
          ...
          liftSequence__X(
            ...
            context.mode,
            node.id.name,
            unbuildClass(node, forkMeta((meta = nextMeta(meta))), context, {
              type: "assignment",
              variable: node.id.name,
            }),
          ),
    ...
    case "ExportNamedDeclaration": {
      if (hasExportDeclaration(node)) {
        return unbuildStatement(node.declaration, meta, context, {
          labels: EMPTY,
          loop,
        });
      } else {
    ...
    case "ExportDefaultDeclaration": {
      return unbuildDefault(node.declaration, meta, context);
    }
    case "ExportAllDeclaration": {
      return zeroSequence(EMPTY);
    }
    case "LabeledStatement": {
      return unbuildStatement(node.body, meta, context, {
    ...
    case "BlockStatement": {
      return liftSequenceX(
        ...
        liftSequenceX_(
          makeBlockStatement,
          unbuildSegmentBody(node, meta, context, {
                            ...
                            mapSequence(
                              ...
                              (cache) =>
                                pairup(
                                  cache,
                                  /**
                                   * @type {(import("../scope/perform").InitializeOperation)}
                                   */ ({
                                    type: "initialize",
                                    mode,
                                    variable,
 ...
 * >}
 */
export const unbuildBody = (nodes, meta, context, labeling) =>
  liftSequenceXX(
    concatXX,
    liftSequenceX(
      flat,
