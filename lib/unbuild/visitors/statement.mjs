...
import { lookupDeadzone, updateDeadzoneStatement } from "../deadzone.mjs";
...
export const unbuildStatement = (
  { node, path, meta },
  { scope, deadzone, origin, hoisting, labels, loop },
) => {
  switch (node.type) {
    case "EmptyStatement": {
    ...
    case "ExpressionStatement": {
      if (shouldUpdateCompletion(scope, path)) {
        ...
        return liftSequenceX_(
          listEffectStatement,
          unbuildEffect(drillSite(node, path, meta, "expression"), {
            scope,
            deadzone,
          }),
          path,
        ...
        liftSequenceX_(
          ...
          liftSequenceX_(
            ...
            liftSequence__X_(
              ...
              liftSequenceX(
                concat_,
                unbuildExpression(drillSite(node, path, meta, "argument"), {
                  scope,
                  deadzone,
                }),
              ),
        ...
        callSequence__X(
          ...
          liftSequence__X(
            ...
            unbuildClass(
              ...
              { scope, deadzone, name: { type: "assignment", variable } },
            ),
          ),
        ),
        path,
    ...
    case "ExportNamedDeclaration": {
      if (hasExportDeclaration(node)) {
        return unbuildStatement(drillSite(node, path, meta, "declaration"), {
          scope,
          deadzone,
          origin,
          hoisting,
    ...
    case "ExportDefaultDeclaration": {
      return unbuildDefault(drillSite(node, path, meta, "declaration"), {
        scope,
        deadzone,
        origin,
        hoisting,
    ...
    case "LabeledStatement": {
      return unbuildStatement(drillSite(node, path, meta, "body"), {
        scope,
        deadzone,
        hoisting,
        labels: [
              ...
              liftSequence__X_(
                ...
                bindSequence(
                  ...
                  (scope) =>
                    liftSequenceXX(
                      concatXX,
                      unbuildStatement(drillSite(node, path, meta, "init"), {
                        scope,
                        deadzone,
                        hoisting,
                        labels: EMPTY,
 ...
 * >}
 */
export const unbuildBody = (sites, context) => {
  ...
  return liftSequenceXX(
    ...
    liftSequenceX(
      flat,
      flatSequence(
        map(sites1, (site) => unbuildHoistedStatement(site, context)),
      ),
    ),
    liftSequenceX(
      flat,
      flatSequence(
        mapReduce(
          sites2,
          (deadzone, site) => unbuildStatement(site, { ...context, deadzone }),
          (deadzone, { node }) => updateDeadzoneStatement(deadzone, node),
          context.deadzone,
        ),
      ),
    ),
