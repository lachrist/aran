 ...
 */
const makeUndefinedCompletion = (completion) =>
...
export const unbuildStatement = (
  ...
  switch (node.type) {
    ...
    case "WithStatement": {
      ...
      return [
        ...makeUndefinedCompletion(completion),
        makeEffectStatement(
          makeWriteEffect(
            frame,
        ...
        ...wrapBlock(
          ...
          (context) => {
            ...
            return [
              ...
              makeEffectStatement(
                makeWriteEffect(matched, makePrimitiveExpression(false), true),
              ),
              ...flatMap(
                filter(
                  flatMap(
                  ...
                  unbuildCase(pair, context, {
                    ...
                    completion:
                      completion === null
                        ? null
                        : {
                            // TODO: use path to improve completion update
