...
import { makeReturnArgumentExpression } from "../param/closure/other.mjs";
import { makeReadCatchErrorExpression } from "../param/catch-error.mjs";
 ...
 *   frame: import("../scope/index.mjs").NodeFrame,
 *   makeBody: (
                  ...
                  makeEffectStatement(
                    makeExpressionEffect(
                      makeApplyExpression(
                        makeIntrinsicExpression("aran.throw", path),
                        makePrimitiveExpression({ undefined: null }, path),
                        [makeReadCatchErrorExpression(context, { path })],
                        path,
                      ),
                      path,
                    ),
    ...
    case "ForInStatement": {
      ...
      return [
        ...
        ...wrapBlock(
          ...
          { root: false, link: null, kinds: hoistBlock([node.left]) },
          (context) => [
                              ...
                              makeEffectStatement(
                                makeExpressionEffect(
                                  makeApplyExpression(
                                    ...
                                    [
                                      makeReadCatchErrorExpression(context, {
                                        path,
                                      }),
                                    ],
                                    path,
