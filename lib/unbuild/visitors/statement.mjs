      ...
      if (node.label == null) {
        if (loop.break === null) {
          return [
            makeEffectStatement(
              makeExpressionEffect(
                makeEarlyErrorExpression("Illegal break statement", path),
                path,
              ),
              path,
            ),
      ...
      if (node.label == null) {
        if (loop.continue === null) {
          return [
            makeEffectStatement(
              makeExpressionEffect(
                makeEarlyErrorExpression("Illegal continue statement", path),
                path,
              ),
              path,
            ),
                  ...
                  reduce(
                    getMode(scope) === "strict"
                      ? [
                          {
                            guard: null,
                            message: "'with' is illegal in strict mode",
                            path,
                          },
                        ]
                      : [],
