 ...
 * >}
 */
const unbuildMemberCallee = (node, meta, { digest, scope, annotation }) => {
 ...
 * >}
 */
const unbuildChainMemberCallee = (
  node,
  meta,
...
export const unbuildChainCallee = (
  ...
  if (node.type === "ChainExpression") {
    ...
    return unbuildChainMemberCallee(node, meta, { digest, scope, annotation });
  } else {
    return liftSequenceX_(
      makeRegularCallee,
      unbuildChainElement(node, meta, { digest, scope, annotation }),
 ...
 * >}
 */
export const unbuildCallee = (node, meta, { digest, scope, annotation }) => {
  const hash = digest(node);
  if (node.type === "Super") {
    return zeroSequence(SUPER_CALLEE);
  } else if (node.type === "Identifier") {
    ...
    return unbuildMemberCallee(node, meta, { digest, scope, annotation });
  } else if (
