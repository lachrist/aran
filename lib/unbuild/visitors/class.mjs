                ...
                makeScopeClosureBlock(
                  {
                    ...
                    record: {
                      ...
                      "function.arguments": /** @type {aran.Parameter} */ (
                        "function.arguments"
                      ),
                    },
                  },
        ...
        return map(
          [
            makeWriteEffect(
              this_,
              makeGetExpression(
                makeFunctionArgumentsExpression(context.record, path),
            ...
            ...listDeclarePrivateEffect(context, this_, path),
            ...flatMap(callbacks, (callback) => callback(context, this_)),
          ],
      ...
      makeScopeClosureBlock(
        {
          ...
          record: {
            ...context.record,
            "this": /** @type {"this"} */ ("this"),
            "new.target": /** @type {"new.target"} */ ("new.target"),
            "function.arguments": /** @type {"function.arguments"} */ (
              "function.arguments"
            ),
          },
        ...
        (context) =>
          makeConditionalExpression(
            makeNewTargetExpression(context.record, path),
            makeCallSuperExpression(
              context.record,
              makeFunctionArgumentsExpression(context.record, path),
              path,
  ...
  makeExpressionEffect(
    makeApplyExpression(
      ...
      [
        ...
        makeDataDescriptorExpression(
          {
            value: makeNameExpression(name, path),
            writable: false,
            enumerable: false,
            configurable: true,
          },
 ...
 *   context: import("../context.js").Context,
 *   options: {
 *     "super.constructor": ".illegal" | unbuild.Variable,
 *     name: import("../name.mjs").Name,
 *   },
 * ) => aran.Expression<unbuild.Atom>}
 */
export const unbuildClassBody = (
  { node, path },
  parent_context,
  { name, "super.constructor": super_constructor },
) => {
      ...
      ...listConstructorEffect(
        split.constructors,
        {
          ...
          record: {
            ...context.record,
            "super.prototype": prototype,
            "super.constructor": super_constructor,
            "class.field": main.post.length === 0 ? ".none" : post,
          },
        },
        { self, name, path },
      ),
      ...
      makeExpressionEffect(
        makeApplyExpression(
          ...
          [
            ...
            super_constructor === ".illegal"
              ? makeIntrinsicExpression("Object.prototype", path)
              : makeGetExpression(
                  makeReadExpression(super_constructor, path),
                  makePrimitiveExpression("prototype", path),
                  path,
                ),
          ],
