 ...
 * ) => Element}
 */
const prependClassElement = (head, tail, _path) => ({
  ...tail,
  head: [head, ...tail.head],
});
    ...
    case "PropertyDefinition": {
      ...
      return initCache(
        ...
        (key) => {
          ...
          return {
            head: listKeySetupEffect({ path }, context, {
              key,
              static: node.static,
            }),
            body: [],
          ...
          listDefinePrivateEffect(
            ...
            makeMethodDescriptor(
              ...
              unbuildFunction(sites.value, context, {
                ...
                proto: node.static ? constructor_ : prototype,
              }),
              path,
            ),
            { path },
...
const makeFieldClosureExpression = (
  context,
  { constructor: constructor_, callbacks },
  { path, meta },
) =>
  makeFunctionExpression(
    false,
                            ...
                            makeExpressionEffect(
                              makeApplyExpression(
                                makeFieldClosureExpression(
                                  context,
                                  { constructor: self, callbacks: main.static },
                      ...
                      ...(main.instance.length === 0
                        ...
                        : [
                            makeWriteCacheEffect(
                              ...
                              makeFieldClosureExpression(
                                context,
                                { constructor: self, callbacks: main.instance },
