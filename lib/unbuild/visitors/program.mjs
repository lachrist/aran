 ...
 *   mode: "strict" | "sloppy",
 * ) => import("../scope/variable").LateDeclareVariableOperation}
 */
  ...
  if (mode === "sloppy") {
    if (binding.baseline === "live") {
      ...
      throw new AranExecError(
        "Cannot late-declare variable with dead baseline",
        {
          binding,
          mode,
        },
      );
    } else if (binding.baseline === "none") {
      throw new AranExecError(
        "Cannot late-declare variable with none baseline",
        {
          binding,
          mode,
        },
 ...
 *   scope: import("../scope").RootContext,
 *   options: {
