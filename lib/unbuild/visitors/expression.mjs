...
/**
 * @type {(
 *   site: import("../site").Site<import("../../estree").Property | import("../../estree").SpreadElement>,
 * ) => site is import("../site").Site<import("../../estree").InitProperty>}
 */
 ...
 * @type {(
 *   site: import("../site").Site<import("../../estree").Property | import("../../estree").SpreadElement>,
 * ) => site is import("../site").Site<import("../../estree").ProtoProperty>}
 */
...
const makeNumberPrimitiveExpression = (value, path) => {
  if (value === NEGATIVE_INFINITY) {
    ...
    throw new AranError("Literal should not be able to create NaN", {
      value,
      path,
    });
  } else if (value === 0 && 1 / value === NEGATIVE_INFINITY) {
    throw new AranError("Literal should not be able to create negative zero", {
      value,
      path,
    });
  } else {
    ...
    case "ObjectExpression": {
      return bindSequence(
        ...
        ({ prototype, properties }) => {
          if (
            every(properties, isInitPropertySite) &&
