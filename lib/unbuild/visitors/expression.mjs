...
/**
 * @type {(
 *   node: import("estree-sentry").AssignmentExpression<import("../../hash").HashProp>,
 * ) => node is import("estree-sentry").AssignmentExpression<import("../../hash").HashProp> & {
...
/**
 * @type {(
 *   node: import("estree-sentry").BinaryExpression<import("../../hash").HashProp>,
 * ) => node is import("estree-sentry").PrivateBinaryExpression<import("../../hash").HashProp>}
 */
 ...
 *   )>,
 * ) => site is import("../site").Site<
 *   import("estree-sentry").InitObjectProperty<import("../../hash").HashProp>
 * >}
 */
 ...
 *   )>,
 * ) => site is import("../site").Site<
 *   import("estree-sentry").ProtoObjectProperty<import("../../hash").HashProp>
 * >}
 */
...
/**
 * @type {(
 *   site: import("../site").Site<import("estree-sentry").ObjectExpression<import("../../hash").HashProp>>,
      ...
      if (node.operator === "=") {
        ...
        if (/** @type {any} */ (node).left.type === "CallExpression") {
          return liftSequenceX__(
            ...
            unbuildEffect(
              drillSite(
                /** @type {{left: import("estree-sentry").Expression<import("../../hash").HashProp>}} */ (
                  node
                ),
                hash,
                forkMeta((meta = nextMeta(meta))),
