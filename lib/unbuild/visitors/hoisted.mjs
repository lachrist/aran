 ...
 * >}
 */
export const unbuildHoistedStatement = (node, meta, context) => {
  ...
  switch (node.type) {
    ...
    case "LabeledStatement": {
      return unbuildHoistedStatement(node.body, meta, context);
    }
    case "ExportNamedDeclaration": {
      return node.declaration != null
        ? unbuildHoistedStatement(node.declaration, meta, context)
        : EMPTY_SEQUENCE;
    }
