 ...
 * >}
 */
export const unbuildDefault = (node, meta, context) => {
      ...
      return liftSequenceX(
        ...
        liftSequenceX_(
          ...
          liftSequence_X_(
            makeExportEffect,
            DEFAULT_SPECIFIER,
            unbuildClass(node, meta, context, DEFAULT_NAME),
            hash,
          ),
          hash,
        ),
      ...
      return liftSequenceX(
        ...
        liftSequenceX_(
          ...
          liftSequence_X_(
            makeExportEffect,
            DEFAULT_SPECIFIER,
            unbuildFunction(node, meta, context, FUNCTION_PARAM, DEFAULT_NAME),
            hash,
          ),
          hash,
        ),
    ...
    return liftSequenceX(
      ...
      liftSequenceX_(
        ...
        liftSequence_X_(
          makeExportEffect,
          DEFAULT_SPECIFIER,
          unbuildNameExpression(node, meta, context, DEFAULT_NAME),
          hash,
        ),
        hash,
      ),
