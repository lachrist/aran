...
import { unbuildUpdateLeftEffect } from "./update.mjs";
        ...
        return unbuildUpdateLeftEffect(sites.left, context, {
          kontinue: (context, { name, old_value, kontinue }) => {
            ...
            switch (node.operator) {
              ...
              case "||=": {
                return [makeConditionalEffect(old_value, [], proceed(), path)];
              }
              case "&&=": {
                return [makeConditionalEffect(old_value, proceed(), [], path)];
              }
    ...
    case "UpdateExpression": {
      ...
      return unbuildUpdateLeftEffect(sites.argument, context, {
        kontinue: (context, { old_value, kontinue }) =>
          kontinue(context, {
            new_value: makeInitCacheExpression(
              "constant",
              old_value,
              ...
              (old_value) =>
                makeInitCacheExpression(
                  "constant",
                  makeConvertNumberExpression(old_value, path),
