 ...
 */
export const makeThisExpression = (context, { serial }) =>
  makeReadExpression(context.record.this, serial);
 ...
 * ) => aran.Expression<unbuild.Atom<S>>}
 */
export const makeImportMetaExpression = (context, { serial }) =>
  makeReadExpression(context.record["import.meta"], serial);
...
export const makeNewTargetExpression = (context, { serial, origin }) => {
  switch (context.record["new.target"]) {
    case ".illegal":
      throw new DynamicSyntaxAranError("illegal new.target", origin);
    default:
...
export const makeGetSuperExpression = (context, key, { serial, origin }) => {
  switch (context.record["super.prototype"]) {
    case ".illegal":
      throw new DynamicSyntaxAranError("illegal super access", origin);
    case ".enclave":
...
export const makeCallSuperExpression = (
  ...
  switch (context.record["super.constructor"]) {
    case ".illegal":
      throw new DynamicSyntaxAranError("illegal super call", origin);
    case ".enclave":
      return makeApplyExpression(
