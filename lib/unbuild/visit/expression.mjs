import { DynamicError, flatMap, slice } from "../../util/index.mjs";
...
export const unbuildExpression = (node, context, name) => {
  ...
  switch (node.type) {
    ...
    case "ArrowFunctionExpression":
      return unbuildFunction(node, context, { kind: "arrow", name });
    case "FunctionExpression":
      return unbuildFunction(node, context, { kind: "function", name });
