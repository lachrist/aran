 ...
 */
export const makeReadEnclaveExpression = ({ situ }, variable, { path }) => {
  switch (situ) {
    case "local": {
 ...
 * ) => aran.Expression<unbuild.Atom>}
 */
export const makeTypeofEnclaveExpression = ({ situ }, variable, { path }) => {
  switch (situ) {
    case "local": {
      return makeApplyExpression(
 ...
 * ) => aran.Expression<unbuild.Atom>}
 */
export const makeDidscardEnclaveExpression = ({ situ }, variable, { path }) =>
  logEnclaveLimitation(
