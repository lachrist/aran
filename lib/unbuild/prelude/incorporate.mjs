 ...
 *   >}
 */
export const incorporateProgram = (node, hash) =>
  mapSequence(
        ...
        makeRoutineBlock(
          ...
          [
            ...flatMap(
              ...
              (external) => listPreludeReifyExternalStatement(external),
            ),
            ...map(
 ...
 * >}
 */
export const incorporateSegmentBlock = (node, hash) =>
  mapSequence(
...
/**
 * @type {<S, P extends import("./index").Prelude>(
 *   node: import("../../sequence").Sequence<
 *     P,
 *     [import("../atom").Effect[], S],
 *   >,
 *   hash: import("../../hash").Hash,
 * ) => import("./index").PrefixPrelude extends P
 *   ? import("../../sequence").Sequence<
 ...
 *   : unknown}
 */
export const incorporateFirstEffect = (node, _hash) =>
  mapSequence(filterSequence(node, isNotPrefixPrelude), (tail) =>
    tuple2(
      [
        ...map(filterNarrow(listenSequence(node), isPrefixPrelude), getData),
