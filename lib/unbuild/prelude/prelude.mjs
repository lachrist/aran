...
import { packScope } from "../scope/index.mjs";
 ...
 */
export const makeRebootPrelude = (hash, meta, scope) => ({
  type: "reboot",
  data: [
    hash,
    {
 ...
 * @type {(
 *   prelude: import(".").Prelude,
 * ) => null | [import("../../hash").Hash, import("../../reboot").Reboot]}
 */
export const getPreludeReboot = (prelude) =>
  prelude.type === "reboot" ? prelude.data : null;
