...
/**
 * @type {(
 *   arguments_: import("./visitors/argument.mjs").ArgumentList,
 *   path: unbuild.Path,
 ...
 *   options: {
 *     callee: import("./visitors/callee.mjs").Callee,
 *     argument_list: import("./visitors/argument.mjs").ArgumentList,
 *   },
 * ) => aran.Expression<unbuild.Atom>}
 */
  ...
  switch (callee.type) {
    case "super": {
      return makeCallSuperExpression(
        context,
        concatArgument(argument_list, path),
        { path, meta },
      );
    }
    case "normal": {
