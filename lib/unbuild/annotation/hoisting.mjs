  ...
  switch (node.type) {
    case "FunctionDeclaration": {
      if (node.id == null) {
        ...
        const kind = simple ? "param-legacy" : "param";
        return scopeHoisting(
      ...
      if (node.body.type === "BlockStatement") {
        ...
        return scopeHoisting(
          ...
          scopeHoisting(
            simple ? SIMPLE_CLOSURE_BODY_SCOPING : CLOSURE_BODY_SCOPING,
            [
              map(node.params, (child) => hoistPattern(child, "param", mode)),
              map(node.body.body, (child) => hoistStatement(child, mode)),
            ],
            node.body._hash,
          ),
...
const WRITE_KIND_RECORD = {
  ...
  "error": "perform",
  "param": "perform",
  "param-legacy": "perform",
  "error-legacy": "perform",
 ...
 * @type {{
 *   [key in import("./hoisting-private").Kind]
 *     : import("./hoisting").Baseline
 * }}
 */
const BASELINE_KIND_RECORD = {
  "let": "dead",
  "const": "dead",
  "class": "dead",
  "error": "dead",
  ...
  "param-legacy": "live",
  "error-legacy": "live",
  "function-strict": "live",
  "function-sloppy-near": "live",
  "function-sloppy-away": "live",
  "function-self-strict": "none",
  "function-self-sloppy": "none",
  "arguments": "none",
};
 ...
 * }}
 */
const SLOPPY_FUNCTION_KIND_RECORD = {
  "function-sloppy-near": "near",
  "function-sloppy-away": "away",
  "error-legacy": "nope",
  "var": "nope",
  "function-strict": "nope",
  "let": "nope",
  "const": "nope",
  "class": "nope",
  "param": "nope",
  ...
  "param-legacy": "nope",
  "import": "nope",
  "function-self-sloppy": "nope",
  "function-self-strict": "nope",
  "class-self": "nope",
  "arguments": "nope",
};
...
const toPublicBinding = (binding, bindings) => {
  ...
  return {
    ...
    baseline: BASELINE_KIND_RECORD[kind],
    sloppy_function: SLOPPY_FUNCTION_KIND_RECORD[kind],
  };
};
