 ...
 */
export const makeClosureBlock = (body, completion, tag) => ({
  head: [
    ...filterNarrow(body.head, isBlockPrelude),
    ...filterNarrow(completion.head, isBlockPrelude),
  ],
  tail: {
    type: "ClosureBlock",
    variables: map(
      [
        ...filterNarrow(body.head, isDeclarationPrelude),
        ...filterNarrow(completion.head, isDeclarationPrelude),
      ],
      getData,
    ),
    statements: body.tail,
