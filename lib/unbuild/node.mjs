...
import { compileGet, filterNarrow, flat, map } from "../util/index.mjs";
import {
...
export const makeProgram = (sort, body, tag) =>
  mapSequence(filterSequence(body, isNotHeaderPrelude), (inner) => ({
    type: "Program",
    sort,
    head: map(filterNarrow(listenSequence(body), isHeaderPrelude), getData),
    body: inner,
    tag,
  }));
...
/**
 * @type {<
 *   P1 extends import("./prelude").NodePrelude,
 *   P2 extends import("./prelude").BodyPrelude,
 * >(
 *  prelude: import("./sequence").Sequence<
 *    P1,
 *    aran.Statement<unbuild.Atom>[],
 *  >,
 *  main: import("./sequence").Sequence<
 *    P2,
 ...
 * >}
 */
export const prependClosureBody = (prelude, body) =>
  mapTwoSequence(prelude, body, (prelude, { content, completion }) => ({
 ...
 * >}
 */
export const prependControlBody = (prelude, body) =>
  mapTwoSequence(prelude, body, (prelude, { content }) => ({
    content: [...prelude, ...content],
  }));
 ...
 * @type {<
 *   P1 extends import("./prelude").NodePrelude,
 *   P2 extends import("./prelude").NodePrelude,
 * >(
 *   content: import("./sequence").Sequence<
 *     P1,
 *     aran.Statement<unbuild.Atom>[],
...
export const makeControlBlock = (labels, body, tag) =>
  mapSequence(filterSequence(body, isNotDeclarationPrelude), ({ content }) => ({
    type: "ControlBlock",
    labels,
...
export const makeClosureBlock = (body, tag) =>
  mapSequence(
    filterSequence(body, isNotDeclarationPrelude),
    ({ content, completion }) => ({
      type: "ClosureBlock",
      frame: reportDuplicateVariable([
        ...map(filterNarrow(body.head, isMetaDeclarationPrelude), getData),
 ...
 *   P1 extends import("./prelude").NodePrelude,
 *   P2 extends import("./prelude").NodePrelude,
 *   P3 extends import("./prelude").NodePrelude,
 * >(
 *   test: import("./sequence").Sequence<
 *     P1,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   then_: import("./sequence").Sequence<
 *     P2,
 *     aran.ControlBlock<unbuild.Atom>,
 *   >,
 *   else_: import("./sequence").Sequence<
 *     P3,
 *     aran.ControlBlock<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
 ...
 *   P3 extends import("./prelude").NodePrelude,
 * >(
 *   try_: import("./sequence").Sequence<
 *     P1,
 *     aran.ControlBlock<unbuild.Atom>,
 *   >,
 *   catch_: import("./sequence").Sequence<
 *     P2,
 *     aran.ControlBlock<unbuild.Atom>,
 *   >,
 *   finally_: import("./sequence").Sequence<
 *     P3,
 *     aran.ControlBlock<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
...
/**
 * @type {<P extends import("./prelude").NodePrelude>(
 *   discard: import("./sequence").Sequence<
 *     P,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
 ...
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   positive: import("./sequence").Sequence<
 *     P2,
 *     aran.Effect<unbuild.Atom>[],
 *   >,
 *   negative: import("./sequence").Sequence<
 *     P3,
 *     aran.Effect<unbuild.Atom>[],
 *   >,
 *   tag: unbuild.Path,
 ...
 *   value: import("./sequence").Sequence<
 *     P,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
...
/**
 * @type {<P extends import("./prelude").NodePrelude>(
 *   promise: import("./sequence").Sequence<
 *     P,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
 ...
 *   P2 extends import("./prelude").NodePrelude,
 * >(
 *   head: import("./sequence").Sequence<
 *     P1,
 *     aran.Effect<unbuild.Atom>[],
 *   >,
 *   tail: import("./sequence").Sequence<
 *     P2,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
 ...
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   consequent: import("./sequence").Sequence<
 *     P2,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   alternate: import("./sequence").Sequence<
 *     P3,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   tag: unbuild.Path,
 ...
 *   P3 extends import("./prelude").NodePrelude,
 * >(
 *   callee: import("./sequence").Sequence<
 *     P1,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   this_: import("./sequence").Sequence<
 *     P2,
 *     aran.Expression<unbuild.Atom>,
 *   >,
 *   arguments_: import("./sequence").Sequence<
 *     P3,
 *     aran.Expression<unbuild.Atom>,
 *   >[],
 *   tag: unbuild.Path,
