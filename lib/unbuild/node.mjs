...
import {
  ...
  makeClosureBlock as makeClosureBlockGeneric,
...
/**
 * @type {typeof import("../node.mjs").makeClosureBlock<import("./atom").Atom>}
 */
export const makeClosureBlock = makeClosureBlockGeneric;
...
/**
 * @type {(
 *   nodes: aran.Effect<unbuild.Atom>[],
 *   tag: unbuild.Path
