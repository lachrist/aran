...
/**
 * @type {<S>(node: aran.Node<unbuild.Atom<S>>) => S}
 */
export const getSerial = ({ tag: { serial } }) => serial;

/**
 * @type {<S>(
 *   node: aran.Node<unbuild.Atom<S>> & { type: "WriteEffect" },
 * ) => boolean}
 */
...
/**
 * @type {<S>(
 *   node: aran.Node<unbuild.Atom<S>> & { type: "EvalExpression" },
...
export const makeScriptProgram = (body, serial) => ({
  type: "ScriptProgram",
  body,
  tag: { serial, initialization: null, context: null },
});
 ...
 * ) => aran.Statement<unbuild.Atom<S>>}
 */
export const makeDeclareGlobalStatement = (kind, variable, right, serial) => ({
 ...
 * ) => aran.Effect<unbuild.Atom<S>>}
 */
export const makeWriteGlobalEffect = (variable, right, serial) => ({
 ...
 * ) => aran.Expression<unbuild.Atom<S>>}
 */
export const makeReadGlobalExpression = (variable, serial) => ({
 ...
 * ) => aran.Expression<unbuild.Atom<S>>}
 */
export const makeTypeofGlobalExpression = (variable, serial) => ({
 ...
 * ) => aran.Expression<unbuild.Atom<S>>}
 */
export const makeEvalExpression = (code, serial, context) => ({
  type: "EvalExpression",
  code,
  tag: { serial, initialization: null, context },
});
