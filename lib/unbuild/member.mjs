...
export const makeGetMemberExpression = (
  ...
  if (object === "super") {
    ...
    if (typeof key === "string") {
      return makeGetPrivateExpression(context, object, key, { path, meta });
    } else {
...
export const listSetMemberEffect = (
  ...
  if (object === "super") {
    ...
    if (typeof key === "string") {
      return listSetPrivateEffect(context, object, key, value, { path, meta });
    } else {
      return [
        makeExpressionEffect(
...
export const makeSetMemberExpression = (
  ...
  if (object === "super") {
    ...
    if (typeof key === "string") {
      return makeSetPrivateExpression(context, object, key, value, {
        path,
        meta,
      });
    } else {
