 ...
 * }}
 */
export const makeGetMemberContext = (scope, object, key) => ({
  scope,
  object,
  key,
});
 ...
 * }}
 */
export const makeSetMemberContext = (scope, object, key, value) => ({
  scope,
  object,
  key,
  value,
...
export const makeGetMemberExpression = (
  ...
  if (object.type === "super") {
    if (key.access === "private") {
      return initErrorExpression("Illegal private member of super", path);
      ...
      switch (key.access) {
        case "private": {
          return liftSequenceX(
            ...
            liftSequenceX_(
              makeExpressionEffect,
              initErrorExpression("Illegal private member of super", path),
              path,
            ),
          );
        }
