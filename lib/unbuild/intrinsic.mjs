...
/**
 * @type {(
 *   elements: aran.Expression<import("./atom").Atom>[],
 ...
 *   argument: aran.Expression<import("./atom").Atom>,
 *   tag: import("../path").Path,
 * ) => aran.Expression<import("./atom").Atom>}
 */
 ...
 *   left: aran.Expression<import("./atom").Atom>,
 *   right: aran.Expression<import("./atom").Atom>,
 *   tag: import("../path").Path,
 * ) => aran.Expression<import("./atom").Atom>}
 */
...
/**
 * @type {(
 *   object: aran.Expression<import("./atom").Atom>,
 *   key: aran.Expression<import("./atom").Atom>,
 *   tag: import("../path").Path,
 * ) => aran.Expression<import("./atom").Atom>}
 */
...
/**
 * @type {(
 *   error: aran.Expression<import("./atom").Atom>,
 *   tag: import("../path").Path,
 * ) => aran.Expression<import("./atom").Atom>}
 */
 ...
 * @type {(
 *   key: string,
 *   value: null | boolean | aran.Expression<import("./atom").Atom>,
 *   tag: import("../path").Path,
 * ) => aran.Expression<import("./atom").Atom>[]}
 */
 ...
 * @type {(
 *   descriptor: {
 *     value: null | aran.Expression<import("./atom").Atom>,
 *     writable: null | boolean | aran.Expression<import("./atom").Atom>,
 *     enumerable: null | boolean | aran.Expression<import("./atom").Atom>,
 *     configurable: null | boolean | aran.Expression<import("./atom").Atom>,
 *   },
 *   tag: import("../path").Path,
 * ) => aran.Expression<import("./atom").Atom>}
 */
 ...
 * @type {(
 *   descriptor: {
 *     get: null | aran.Expression<import("./atom").Atom>,
 *     set: null | aran.Expression<import("./atom").Atom>,
 *     enumerable: null | boolean | aran.Expression<import("./atom").Atom>,
 *     configurable: null | boolean | aran.Expression<import("./atom").Atom>,
 *   },
 *   tag: import("../path").Path,
