...
/** @type {(variables: Variable[]) => EstreeVariableDeclaration[]} */
...
/** @type {(node: ControlBlock<unknown>) => EstreeBlockStatement} */
...
/** @type {(node: ControlBlock<unknown>) => EstreeStatement} */
...
/** @type {(node: PseudoBlock<unknown>) => EstreeStatement[]} */
export const revertPseudoBlock = (node) =>
  map(node.statements, revertStatement);

/** @type {(node: ClosureBlock<unknown>) => EstreeBlockStatement} */
...
/** @type {(directive: string) => EstreeStatement} */
...
/** @type {(node: Node<unknown>) => EstreeProgram} */
