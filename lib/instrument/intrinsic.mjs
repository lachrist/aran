...
/** @type {<X>(expression1: Expression<Variable[]>, expression2: Expression<Variable[]>) => Expression<Variable[]>} */
...
/** @type {<X>(expression1: Expression<Variable[]>[]) => Expression<Variable[]>} */
...
/** @type {<X>(entry: [string, Json]) => [Expression<Variable[]>, Expression<Variable[]>]} */
