...
import { getNodeTag, PARAMETER_ENUM, unpackPrimitive } from "../node.mjs";
...
/** @type {<S>(node: Link<S>) => Link<Variable[]>} */
      ...
      return makeTrapExpression(
        {
          type: "read.after",
          variable: parseVariable(node.variable),
          value: makeReadExpression(mangleOriginalVariable(node.variable)),
          serial: node.tag,
        },
        context,
      );
