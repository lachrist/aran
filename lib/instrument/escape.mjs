...
/** @type {(escape: string, variable: Variable) => Variable} */
...
/** @type {<X>(node: ControlBlock<Variable[]>, escape: string, variables: string[]) => ControlBlock<Variable[]>} */
...
/** @type {<X>(node: ClosureBlock<Variable[]>, escape: string, variables: string[]) => ClosureBlock<Variable[]>} */
...
/** @type {<X>(node: PseudoBlock<Variable[]>, escape: string, variables: string[]) => PseudoBlock<Variable[]>} */
...
/** @type {<X>(node: Statement<Variable[]>, escape: string, variables: string[]) => Statement<Variable[]>} */
...
/** @type {<X>(node: Effect<Variable[]>, escape: string, variables: string[]) => Effect<Variable[]>} */
...
/** @type {<X>(node: Expression<Variable[]>, escape: string, variables: string[]) => Expression<Variable[]>} */
