...
const callbacks = {
        ...
        combine(
          ...
          ArrayLite.map(
            ...
            (_, index) => Tree._allign(
              ...
              callbacks)))))),
  // Statement //
  Lift: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".lift-expression",
    expression1,
    expression2,
    callbacks),
  Return: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".return-argument",
    expression1,
    expression2,
    callbacks),
  Break: (path, node1, node2, label1, label2) => check(path + ".break-label", label1, label2, null, EMPTY),
  Continue: (path, node1, node2, label1, label2) => check(path + ".continue-label", label1, label2, null, EMPTY),
  Debugger: (path, node1, node2) => ({__proto__:null}),
  Lone: (path, node1, node2, labels1, block1, labels2, block2) => check_all(
    path + ".lone-labels",
    labels1,
    labels2,
    null,
    () => Tree._allign(
      ...
      block2,
      callbacks)),
  If: (path, node1, node2, labels1, expression1, block11, block12, labels2, expression2, block21, block22) => check_all(
    path + ".if-labels",
    labels1,
    labels2,
    null,
    () => combine(
      ...
      [
        ...
        Tree._allign(
          ...
          block22,
          callbacks)])),
  While: (path, node1, node2, labels1, expression1, block1, labels2, expression2, block2) => check_all(
    path + ".if-labels",
    labels1,
    labels2,
    null,
    () => combine(
      ...
      [
        ...
        Tree._allign(
          ...
          block2,
          callbacks)])),
  Try: (path, node1, node2, labels1, block11, block12, block13, labels2, block21, block22, block23) => check_all(
    path + ".if-labels",
    labels1,
    labels2,
    null,
    () => combine(
      ...
      [
        ...
        Tree._allign(
          ...
          callbacks)])),
  // Expression //
  primitive: (path, node1, node2, primitive1, primitive2) => check(
    path + ".primitive-body",
    primitive1,
    primitive2,
    null,
    EMPTY),
  intrinsic: (path, node1, node2, intrinsic1, intrinsic2) => check(
    path + ".intrinsic-body",
    intrinsic1,
    intrinsic2,
    null,
    EMPTY),
  arrow: (path, node1, node2, block1, block2) => Tree._allign(
    path + ".arrow-body",
    block1,
    block2,
    callbacks),
  function: (path, node1, node2, block1, block2) => Tree._allign(
    path + ".function-body",
    block1,
    block2,
    callbacks),
  method: (path, node1, node2, block1, block2) => Tree._allign(
    path + ".method-body",
    block1,
    block2,
    callbacks),
  constructor: (path, node1, node2, block1, block2) => Tree._allign(
    path + ".constructor-body",
    block1,
    block2,
    callbacks),
  read: (path, node1, node2, identifier1, identifier2) => (
    (
  ...
  write: (path, node1, node2, identifier1, expression1, identifier2, expression2, _callback) => (
    (
      is_parameter(identifier1) ||
      is_parameter(identifier2)) ?
    check(
  ...
  export: (path, node1, node2, specifier1, expression1, specifier2, expression2) => check(
    ...
    () => Tree._allign(
      ...
      expression2,
      callbacks)),
  enclave_read: (path, node1, node2, enclave_read_identifier_1, enclave_read_identifier_2) => check(
    path + ".enclave-read-specifier",
    enclave_read_identifier_1,
    enclave_read_identifier_2,
    null,
    EMPTY),
  enclave_typeof: (path, node1, node2, enclave_read_identifier_1, enclave_read_identifier_2) => check(
  ...
  enclave_write: (path, node1, node2, strict1, enclave_write_identifier_1, expression1, strict2, enclave_write_identifier_2, expression2, _callback) => check(
    ...
    () => check(
      ...
      () => Tree._allign(
        ...
        expression2,
        callbacks))),
  enclave_super_invoke: (path, node1, node2, expression11, expression12, expression21, expression22) => combine(
    path,
    [
      Tree._allign(
        path + ".enclave-super-invoke-key",
        expression11,
        expression21,
        callbacks),
      Tree._allign(
        path + ".enclave-super-invoke-arguments",
        expression12,
        expression22,
        callbacks)]),
  enclave_super_call: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".enclave-super-call-arguments",
    expression1,
    expression2,
    callbacks),
  enclave_super_member: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".enclave-super-member-key",
    expression1,
    expression2,
    callbacks),
  sequence: (path, node1, node2, expression11, expression12, expression21, expression22) => combine(
    path,
    [
      Tree._allign(
        path + ".sequence-first",
      ...
      Tree._allign(
        ...
        expression22,
        callbacks)]),
  conditional: (path, node1, node2, expression11, expression12, expression13, expression21, expression22, expression23) => combine(
    path,
    [
      Tree._allign(
      ...
      Tree._allign(
        ...
        expression23,
        callbacks)]),
  throw: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".throw-argument",
    expression1,
    expression2,
    callbacks),
  eval: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".eval-argument",
    expression1,
    expression2,
    callbacks),
  apply: (path, node1, node2, expression11, expression12, expressions1, expression21, expression22, expressions2) => check(
      ...
      ArrayLite.concat(
        ...
        ArrayLite.map(
          ...
          (_, index) => Tree._allign(
            ...
            expressions2[index],
            callbacks))))),
  construct: (path, node1, node2, expression1, expressions1, expression2, expressions2) => check(
      ...
      ArrayLite.concat(
        ...
        ArrayLite.map(
          ...
          (_, index) => Tree._allign(
            ...
            expressions2[index],
            callbacks))))),
  import: (path, node1, node2, specifier1, source1, specifier2, source2) => check(
    path + ".import-specifier",
    specifier1,
    specifier2,
    null,
    () => check(
      ...
      null,
      EMPTY)),
  require: (path, node1, node2, expression1, expression2) => Tree._allign(
    path + ".require-source",
    expression1,
    expression2,
    callbacks),
  unary: (path, node1, node2, operator1, expression1, operator2, expression2) => check(
    path + ".unary-operator",
    operator1,
    operator2,
    null,
    () => Tree._allign(
      ...
      expression2,
      callbacks)),
  binary: (path, node1, node2, operator1, expression11, expression12, operator2, expression21, expression22) => check(
    ...
    () => combine(
      ...
      [
        ...
        Tree._allign(
          ...
          expression22,
          callbacks)])),
  object: (path, node1, node2, expression1, properties1, expression2, properties2) => check(
