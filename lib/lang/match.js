...
const proceed = (mapping, node1, node2, generate, callback) => {
  ...
  try {
    ...
    // diff(generate(node1), generate(node2));
...
exports._program = (program1, program2, callback) => proceed(
  Tree._allign_program(program_callback_object, "program", program1, program2),
  program1,
  program2,
  Generate._program,
  callback);

exports._prelude = (prelude1, prelude2, callback) => proceed(
  Tree._allign_prelude(prelude_callback_object, "prelude", prelude1, prelude2),
  prelude1,
  prelude2,
  Generate._prelude,
  callback);
...
const prelude_callback_object = {
  __type_mismatch__: type_mismatch,
  _import: (path, node1, node2, specifier1, source1, specifier2, source2) => check(
  ...
  _export: (path, node1, node2, specifier1, specifier2) => check(
    ...
    null,
    EMPTY),
  _aggregate: (path, node1, node2, specifier11, source1, specifier12, specifier21, source2, specifier22) => check(
...
const expression_callback_object = {
  ...
  primitive: (path, expression1, expression2, primitive1, primitive2) => check(
    ...
    null,
    EMPTY),
  builtin: (path, expression1, expression2, builtin1, builtin2) => check(
    path + ".builtin-body",
    builtin1,
    builtin2,
    null,
      ...
      ArrayLite.concat(
        ...
        ArrayLite.map(
          ...
          (_, index) => Tree._allign_expression(
            ...
            expressions1[index],
            expressions2[index]))))),
  import: (path, expression1, expression2, specifier1, source1, specifier2, source2) => check(
    path + ".import-specifier",
    specifier1,
    specifier2,
    null,
    () => check(
      ...
      null,
      EMPTY)),
  require: (path, expression1, expression2, expression11, expression21) => Tree._allign_expression(
    expression_callback_object,
    path + ".require-source",
    expression11,
    expression21),
