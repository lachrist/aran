...
///////////////
{
  ...
  // Aggregate //
  failure(`aggregate "foo";`, `aggregate "bar";`, /^Structural mismatch .* "foo" and "bar"\n/);
  success(`aggregate "foo";`, `aggregate "foo";`, {__proto__:null});
  // Exports //
...
////////////////
{
  ...
  // Import //
  failure(`import "foo"`, `import "bar"`, /^Structural mismatch .* "foo" and "bar"\n/);
  success(`import "foo"`, `import "foo"`, {__proto__:null});
  // unary //
