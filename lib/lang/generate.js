...
const statement_callback_object = {
  ...
  Bundle: (indent, statement, statements) => ArrayLite.join(
    ArrayLite.map(
      statements,
      (statement) => generate_statement(statement, indent)),
    ""),
...
const expression_callback_object = {
  ...
  sequence: (indent, expression, first_expression, second_expression) => (
    ...
    (
      ...
      ",\n" +
      indent +
      generate_expression(indent + STEP, second_expression) +
      ")")),
  ...
  object: (indent, expression, prototype_expression, properties) => (
    ...
    (
      ...
      indent +
      "__proto__: " +
      generate_expression(indent + STEP, prototype_expression) +
      ArrayLite.join(
        ArrayLite.map(
          properties,
          (property) => (
...
const is_simple_expression_callback_object = {
  ...
  eval: (unit, expression, argument_expression, identifiers) => is_expression_simple(argument_expression),
  apply: FALSE,
