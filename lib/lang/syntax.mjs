...
/** @type {(primitive: import("./syntax").Primitive) => primitive is {bigint: string}} */
...
/** @type {<A extends import("./syntax").Atom>(node: import("./syntax").Node<A>) => import("./syntax").Node<A>[]} */
export const listChild = (node) => {
  switch (node.type) {
    ...
    case "RoutineBlock": {
      return [...(node.head ?? EMPTY), ...node.body, node.tail];
    }
    // Statement //
