...
/** @type {Record<import("./syntax").Parameter, null>} */
...
/** @type {Record<import("./syntax").AranIntrinsic, null>} */
export const ARAN_INTRINSIC_RECORD = {
  "aran.global": null,
  "aran.record": null,
  "aran.transpileEval": null,
  "aran.retropileEval": null,
  ...
  "aran.declareGlobal": null,
  "aran.createObject": null,
  "aran.readGlobalVariable": null,
  "aran.writeGlobalStrict": null,
  "aran.writeGlobalSloppy": null,
  "aran.typeofGlobal": null,
  "aran.discardGlobal": null,
};

/** @type {Record<import("./syntax").Intrinsic, null>} */
...
/** @type {(primitive: import("./syntax").SyntaxPrimitive) => primitive is {bigint: string}} */
...
/**
 * @type {(
 *   primitive: import("./syntax").SyntaxPrimitive,
...
/**
 * @type {<
 *   A extends import("./syntax").Atom,
 *   N extends import("./syntax").Node<A>,
 * >(node: N, tag: A["Tag"]) => N}
 */
...
/**
 * @type {<A extends import("./syntax").Atom>(
 *   block: import("./syntax").RoutineBlock<A>,
 * ) => block is import("./syntax").HeadlessRoutineBlock<A>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   block: import("./syntax").RoutineBlock<A>,
 * ) => block is import("./syntax").HeadfulRoutineBlock<A>}
 */
 ...
 *     | X
 *   ),
 * ) => input is import("./syntax").Parameter}
 */
 ...
 * @type {(
 *   input: string,
 * ) => input is import("./syntax").Intrinsic}
 */
 ...
 * @type {(
 *   input: string,
 * ) => input is import("./syntax").AranIntrinsic}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 * ) => node is import("./syntax").Program<A>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 * ) => node is import("./syntax").SegmentBlock<A>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 * ) => node is import("./syntax").RoutineBlock<A>}
 */
export const isRoutineBlockNode = (node) => node.type === "RoutineBlock";

/**
 * @type {Record<import("./syntax").Statement<any>["type"], null>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 * ) => node is import("./syntax").Statement<A>}
 */
export const isStatementNode = (node) =>
  hasNarrowKey(STATEMENT_TYPE_RECORD, node.type);

/**
 * @type {Record<import("./syntax").Effect<any>["type"], null>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 * ) => node is import("./syntax").Effect<A>}
 */
export const isEffectNode = (node) =>
  hasNarrowKey(EFFECT_TYPE_RECORD, node.type);

/**
 * @type {Record<import("./syntax").Expression<any>["type"], null>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 * ) => import("../util/tree").Tree<import("./syntax").Node<A>>}
 */
 ...
 * @type {<A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 *   predicate: (child: import("./syntax").Node<A>) => boolean,
 * ) => boolean}
 */
...
/**
 * @type {<X, A extends import("./syntax").Atom>(
 *   node: import("./syntax").Node<A>,
 *   accumulate: (
 *     accumulation: X,
 *     node: import("./syntax").Node<A>,
