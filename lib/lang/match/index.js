...
exports._match = (node1, node2, callback) => Result._checkout(
  Tree._allign("root", node1, node2, callbacks),
  (mapping1, mapping2) => callback(true, [mapping1, mapping2]),
  (message) => {
...
const callbacks = {
  ...
  _aggregate: (path, node1, node2, nullabe_specifier_11, source1, nullabe_specifier_12, nullabe_specifier_21, source2, nullabe_specifier_22) => Result._check(
    ...
    () => Result._check(
      ...
      () => Result._check(
        ...
        Result._empty))),
  // Block //
  BLOCK: (path, block1, block2, identifiers1, statements1, identifiers2, statements2) => Result._bind_identifier(
    path + ".block-header",
    identifiers1,
    identifiers2,
    allign_all(
  ...
  Break: (path, node1, node2, label1, label2) => Result._single_label(
    ...
    label1,
    label2),
  Continue: (path, node1, node2, label1, label2) => Result._single_label(
    path + ".label",
    label1,
    label2),
  Debugger: (path, node1, node2) => Result._empty(),
  Lone: (path, node1, node2, labels1, block1, labels2, block2) => Result._bind_label(
    path + ".lone-header",
    labels1,
    labels2,
    allign(
      ...
      block1,
      block2)),
  If: (path, node1, node2, labels1, expression1, block11, block12, labels2, expression2, block21, block22) => Result._bind_label(
    path + ".if-labels",
    labels1,
    labels2,
    Result._combine(
      ...
      Result._combine(
        ...
        allign(
          ...
          block12,
          block22)))),
  While: (path, node1, node2, labels1, expression1, block1, labels2, expression2, block2) => Result._bind_label(
    path + ".while-labels",
    labels1,
    labels2,
    Result._combine(
      ...
      allign(
        ...
        block1,
        block2))),
  Try: (path, node1, node2, labels1, block11, block12, block13, labels2, block21, block22, block23) => Result._bind_label(
    path + ".if-labels",
    labels1,
    labels2,
    Result._combine(
  ...
  intrinsic: (path, node1, node2, intrinsic1, intrinsic2) => Result._check(
    ...
    intrinsic2,
    Result._empty),
  arrow: (path, node1, node2, block1, block2) => allign(
    path + ".arrow-body",
    block1,
    block2),
  function: (path, node1, node2, block1, block2) => allign(
    path + ".function-body",
    block1,
    block2),
  method: (path, node1, node2, block1, block2) => allign(
    path + ".method-body",
    block1,
    block2),
  constructor: (path, node1, node2, block1, block2) => allign(
