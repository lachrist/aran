...
const callbacks = {
  // Program //
  ScriptProgram: (path, node1, node2, enclave1, statement1, enclave2, statement2) => Result.check(
    path + ".script-enclave",
    enclave1,
    enclave2,
    () => allign_all(
      ...
      flaten(statement1),
      flaten(statement2))),
  EvalProgram: (path, node1, node2, enclave1, identifiers1, block1, enclave2, identifiers2, block2) => Result.check(
    path + ".eval-enclave",
    enclave1,
    enclave2,
    () => Result.check(
      ...
      () => ArrayLite.reduce(
        ...
        allign(
          ...
          block1,
          block2)))),
  ModuleProgram: (path, node1, node2, enclave1, links1, block1, enclave2, links2, block2) => Result.check(
    path + ".module-enclave",
    enclave1,
    enclave2,
    () => Result.combine(
      ...
      allign(
        ...
        block2))),
  // Prelude //
  ImportLink: (path, node1, node2, specifier1, source1, specifier2, source2) => Result.check(
  ...
  ExportLink: (path, node1, node2, specifier1, specifier2) => Result.check(
    ...
    specifier2,
    Result.Empty),
  AggregateLink: (path, node1, node2, specifier11, source1, specifier12, specifier21, source2, specifier22) => Result.check(
  ...
  CallSuperEnclaveExpression: (path, node1, node2, expression1, expression2) => allign(
    ...
    expression1,
    expression2),
  GetSuperEnclaveExpression: (path, node1, node2, expression1, expression2) => allign(
    path + ".enclave-super-get-key",
    expression1,
    expression2),
  SetSuperEnclaveExpression: (path, node1, node2, expression11, expression12, expression21, expression22) => Result.combine(
    path,
    allign(
      path + ".enclave-super-set-key",
      expression11,
      expression21),
    allign(
      path + ".enclave-super-set-value",
      expression12,
      expression22)),
  ...
  AwaitExpression: (path, node1, node2, expression1, expression2) => allign(
    ...
    expression1,
    expression2),
  EvalExpression: (path, node1, node2, enclave1, identifiers1, expression1, enclave2, identifiers2, expression2) => Result.check(
    path + ".eval-head-length",
    identifiers1.length,
    identifiers2.length,
    () => Result.check(
      path + "eval-head-enclave",
      enclave1,
      enclave2,
      () => ArrayLite.reduce(
        identifiers1,
