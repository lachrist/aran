  ...
  AggregateLink: (path, node1, node2, nullabe_specifier_11, source1, nullabe_specifier_12, nullabe_specifier_21, source2, nullabe_specifier_22) => Result.check(
    ...
    () => Result.check(
      ...
      () => Result.check(
        ...
        Result.Empty))),
  // Branch //
  Branch: (path, node1, node2, labels1, block1, labels2, block2) => Result.bindLabel(
    ...
    allign(
      ...
      block2)),
  // Block //
  Block: (path, node1, node2, identifiers1, statement1, identifiers2, statement2) => Result.bindIdentifier(
    path + ".block-head",
    identifiers1,
    identifiers2,
    allign_all(
