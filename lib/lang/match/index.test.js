...
///////////////
{
  ...
  // BlockLess //
  // EnclaveDeclare //
  success(`enclave var foo = x1;`, `enclave var foo = x2;`, Mapping._single("x1", "x2"), Mapping._empty());
  failure(`enclave var foo = 123;`, `enclave let foo = 123;`, /^Structural mismatch .* between "var" and "let"$/);
  failure(`enclave var foo = 123;`, `enclave var bar = 123;`, /^Structural mismatch .* between "foo" and "bar"$/);
  // Lift //
