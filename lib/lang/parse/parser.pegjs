...
ApplyTail
  ...
  / _ "("       e1:Expression es:ComaExpression* _ ")" { return [Tree.primitive(void 0), [e1].concat(es)] }
  / _ "("                                        _ ")" { return [Tree.primitive(void 0), []] }
...
Expression
  ...
  { return xs.reduce((e, x) => Tree.binary(x[0], e, x[1]), e) }
...
NonApplyNonBinaryExpression
  ...
  / /* Builtin */     _ "#" _ i:Identifier is:DotIdentifier*                            { return Tree.builtin([i].concat(is).join(".")) }
  ...
  / /* Construct */   _ "new" __ e:NonApplyNonBinaryExpression es:ConstructTail         { return Tree.construct(e, es) }
