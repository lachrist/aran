...
Program = ps:_Prelude* _ b:Block { return Tree._program(ps, b) }
...
Block = "{" _ b:BlockBody { return b; }

BlockBody
  = "let" __ _ i:Identifier is:_ComaIdentifier* _ ";" ss:(_Statement*) _ "}" { return Tree.BLOCK([i].concat(is), ss); }
  /                                                   ss:(_Statement*) _ "}" { return Tree.BLOCK([], ss); }
...
Statement
  = ls:_LabelColon* _ f:CompoundStatement { return f(ls); }
  / "return"   __ _ e:Expression _ ";"    { return Tree.Return(e) }
  / "break"    __ _ l:Label      _ ";"    { return Tree.Break(l) }
  / "continue" __ _ l:Label      _ ";"    { return Tree.Continue(l) }
...
CompoundStatement
  = "if" _ & "(" _ e:Expression _ b1:Block _ "else" _ b2:Block   { return (ls) => Tree.If(ls, e, b1, b2) }
  / "while" _ & "(" _ e:Expression _ b:Block                     { return (ls) => Tree.While(ls, e, b) }
  / "try" _ b1:Block _ "catch" _ b2:Block _ "finally" _ b3:Block { return (ls) => Tree.Try(ls, b1, b2, b3) }
  / b:Block                                                      { return (ls) => Tree.Lone(ls, b) }
...
EnclaveSuper
  = "["         _ e:Expression _ "]" _ f:EnclaveSuperTail { return f(e); }
  / "(" _ "..." _ e:Expression _ ")"                      { return Tree.enclave_super_call(e); }

EnclaveSuperTail
  = "(" _ "..." _ e2:Expression _ ")" { return (e1) => Tree.enclave_super_invoke(e1, e2); }
  / ""                                { return (e) => Tree.enclave_super_member(e); }
...
NonApplyExpression
  ...
  / /* Arrow */              "arrow"_ "(" _ ")" _ b:Block                                  { return Tree.arrow(b); }
  ...
  / /* Eval */               "eval" __ _ e:Expression _                                        { return Tree.eval(e); }
  / /* Require */            "require" __ _ e:Expression _                                     { return Tree.require(e); }
