...
NonApplyExpression
  ...
  / /* Arrow */              "arrow"_ "(" _ ")" b:_Block                                  { return Tree.arrow(b); }
  / /* Function */           "function" _ "(" _ ")" b:_Block                               { return Tree.function(b); }
  / /* Constructor */        "constructor" _ "(" _ ")" b:_Block                            { return Tree.constructor(b); }
  / /* Constructor */        "method" _ "(" _ ")" b:_Block                                 { return Tree.method(b); }
