...
ComaIdentifier = _ "," _ s:Identifier { return s }

Block
  = _ "{" _ "let" __ _ s:Identifier ss:ComaIdentifier* _ ";" xs:(Statement*) _ "}" { return Tree.BLOCK([s].concat(ss), xs) }
...
ComaProperty
  ...
  /  _ "," _ s:String                _ ":" e2:Expression { return [Tree.primitive(s), e2] }
  /  _ "," _ i:IdentifierName        _ ":" e2:Expression  { return [Tree.primitive(i), e2] }
...
NonApplyExpression
  ...
  / /* Intrinsic */     _ "#" _ s:String                                                  { return Tree.intrinsic(s) }
  / /* Intrinsic */     _ "#" _ s:IdentifierName ss:DotIdentifierName*                    { return Tree.intrinsic([s].concat(ss).join(".")) }
