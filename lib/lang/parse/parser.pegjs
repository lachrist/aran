...
Statement
  ...
  / /* Import */    _ "import" _ "*" _ "as" _ i:Identifier _ "from" _ s:String _ ";"           { return Tree.Import(i, s) }
  / /* Aggregate */ _ "export" _ "*" _ "from" _ s:String _ ";"                                 { return Tree.Aggregate(s) }
  / /* Export */    _ "export" _ i:IdentifierName _ ":" e:Expression _ ";"                     { return Tree.Export(i, e) }
...
NonApplyExpression
  ...
  / /* Import */      _ "import" e:Expression                                           { return Tree.import(e) }
