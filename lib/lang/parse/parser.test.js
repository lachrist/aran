...
// Arrow //
Assert.deepEqual(Parser.parse(" arrow ( ) l: { let x; } ", {startRule:"StartExpression"}), Tree.arrow(Tree.BLOCK(["l"], ["x"], [])));
// Function //
Assert.deepEqual(Parser.parse(" function ( ) l: { let x; } ", {startRule:"StartExpression"}), Tree.function(Tree.BLOCK(["l"], ["x"], [])));
// Constructor //
Assert.deepEqual(Parser.parse(" constructor ( ) l: { let x; } ", {startRule:"StartExpression"}), Tree.constructor(Tree.BLOCK(["l"], ["x"], [])));
// Method //
Assert.deepEqual(Parser.parse(" method ( ) l: { let x; } ", {startRule:"StartExpression"}), Tree.method(Tree.BLOCK(["l"], ["x"], [])));
// Import //
