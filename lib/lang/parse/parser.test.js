...
// Aggregate //
Assert.deepEqual(Parser.parse(" export * from \"*foobar*\" ; ", {startRule:"StartStatement"}), Tree.Aggregate("*foobar*"));
// Import //
Assert.deepEqual(Parser.parse(" import * as foo from \"*bar*\" ; ", {startRule:"StartStatement"}), Tree.Import("foo", "*bar*"));
// Export //
