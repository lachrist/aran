...
// Arrow //
Assert.deepEqual(Parser.parse(" arrow ( ) { } ", {startRule:"StartExpression"}), Tree.arrow(Tree.BLOCK([], [])));
// Function //
...
// Enclave - SuperInvoke //
Assert.deepEqual(Parser.parse(" enclave super [ 123 ] ( ... 456 ) ", {startRule:"StartExpression"}), Tree.enclave_super_invoke(Tree.primitive(123), Tree.primitive(456)));
