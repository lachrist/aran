...
["Label", "Identifier"].forEach((rule) => {
  ...
  Assert.throws(() => Parser.parse("callee", {startRule:rule}), Parser.SyntaxError);
});
...
Assert.deepEqual(Parser.parse(" aggregate * from \"source\" as var ; ", {startRule:"StartPrelude"}), Tree._aggregate(null, "source", "var"));
