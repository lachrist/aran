...
/**
 * @type {(
 *   node: import("./syntax").Node<import("./syntax").Atom>,
 * ) => boolean}
 */
...
const compileHasClosureParameter = (parameter) => {
  /**
   * @type {(node: import("./syntax").Node<import("./syntax").Atom>) => boolean}
   */
...
/**
 * @type {{
 *   [key in import("./syntax").Parameter]: (node: import("./syntax").Node<import("./syntax").Atom>) => boolean
 * }}
 */
const predicates = {
 ...
 * @type {(
 *   node: import("./syntax").Node<import("./syntax").Atom>,
 *   parameter: import("./syntax").Parameter,
 * ) => boolean}
 */
