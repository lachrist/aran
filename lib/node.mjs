 ...
 */
export const makeControlBlock = (labels, bindings, body, tag) => ({
  type: "ControlBlock",
  labels,
 ...
 */
export const makeRoutineBlock = (bindings, body, tail, tag) => ({
  type: "RoutineBlock",
  bindings: reportDuplicateVariable(bindings),
  body,
  tail,
 ...
 *  tail: import("./lang").Expression<A>,
 *  tag: A["Tag"],
 * ) => import("./lang").PreludeBlock<A>}
 */
export const makePreludeBlock = (bindings, head, body, tail, tag) => ({
  type: "PreludeBlock",
  bindings: reportDuplicateVariable(bindings),
  head,
  body,
 ...
 * ) => import("./lang").Expression<A>}
 */
export const makeArrowExpression = (asynchronous, body, tag) => ({
 ...
 * ) => import("./lang").Expression<A>}
 */
export const makeFunctionExpression = (asynchronous, body, tag) => ({
  type: "ClosureExpression",
  kind: "function",
  asynchronous,
  body,
 ...
 * @type {<A extends import("./lang").Atom>(
 *   asynchronous: boolean,
 *   body: import("./lang").PreludeBlock<A>,
 *   tag: A["Tag"],
 * ) => import("./lang").Expression<A>}
 */
export const makeGeneratorExpression = (asynchronous, body, tag) => ({
  type: "ClosureExpression",
  kind: "generator",
  asynchronous,
  body,
...
export const makeClosureExpression = (kind, asynchronous, body, tag) => {
  if (kind === "arrow" || kind === "function") {
    if (body.type === "RoutineBlock") {
      return {
        type: "ClosureExpression",
        kind,
        asynchronous,
      ...
      throw new AranError("illegal body in closure expression", {
        kind,
        asynchronous,
        body,
      });
