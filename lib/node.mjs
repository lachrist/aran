...
import {
  isDeclareLookupHeader,
  isDeclareLookupPrivateHeader,
  isLookupPrivateHeader,
  isModuleLookupHeader,
} from "./header.mjs";
...
export const makeProgram = (kind, situ, head, body, tag) => {
  switch (kind) {
    case "module": {
      if (situ === "global") {
        if (every(head, isModuleLookupHeader)) {
          return {
            type: "Program",
            kind,
            situ,
    ...
    case "script": {
      if (situ === "global") {
        if (every(head, isDeclareLookupHeader)) {
          return {
            type: "Program",
            kind,
            situ,
    ...
    case "eval": {
      switch (situ) {
        ...
        case "local.deep": {
          if (every(head, isLookupPrivateHeader)) {
            return {
              type: "Program",
              kind,
              situ,
        ...
        case "local.root": {
          if (every(head, isDeclareLookupPrivateHeader)) {
            return {
              type: "Program",
              kind,
              situ,
