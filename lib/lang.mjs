...
/** @type {Record<import("./lang").Parameter, null>} */
...
/** @type {Record<import("./lang").AranIntrinsic, null>} */
...
/** @type {Record<import("./lang").Intrinsic, null>} */
...
/** @type {(primitive: import("./lang").Primitive) => primitive is {bigint: string}} */
...
/**
 * @type {<
 *   A extends import("./lang").Atom,
 *   N extends import("./lang").Node<A>,
 * >(node: N, tag: A["Tag"]) => N}
 */
 ...
 *     | X
 *   ),
 * ) => input is import("./lang").Parameter}
 */
 ...
 * @type {(
 *   input: string,
 * ) => input is import("./lang").Intrinsic}
 */
 ...
 * @type {(
 *   input: string,
 * ) => input is import("./lang").AranIntrinsic}
 */
 ...
 * @type {<A extends import("./lang").Atom>(
 *   node: import("./lang").Node<A>,
 * ) => node is import("./lang").ControlBlock<A>}
 */
 ...
 * @type {<A extends import("./lang").Atom>(
 *   node: import("./lang").Node<A>,
 * ) => node is import("./lang").RoutineBlock<A>}
 */
 ...
 * @type {<A extends import("./lang").Atom>(
 *   node: import("./lang").Node<A>,
 * ) => node is import("./lang").PreludeBlock<A>}
 */
export const isPreludeBlockNode = (node) => node.type === "PreludeBlock";

/**
 * @type {Record<import("./lang").Statement<any>["type"], null>}
 */
 ...
 * @type {<A extends import("./lang").Atom>(
 *   node: import("./lang").Node<A>,
 * ) => node is import("./lang").Effect<A>}
 */
export const isEffectNode = (node) =>
  hasNarrowKey(EFFECT_TYPE_RECORD, node.type);

/**
 * @type {Record<import("./lang").Expression<any>["type"], null>}
 */
...
/** @type {<A extends import("./lang").Atom>(node: import("./lang").Node<A>) => import("./lang").Node<A>[]} */
 ...
 * @type {<A extends import("./lang").Atom>(
 *   node: import("./lang").Node<A>,
 *   predicate: (child: import("./lang").Node<A>) => boolean,
 * ) => boolean}
 */
export const someChild = (node, predicate) => {
  switch (node.type) {
    ...
    case "PreludeBlock": {
      return some(node.head, predicate) || predicate(node.body);
    }
    case "RoutineBlock": {
      return some(node.body, predicate) || predicate(node.tail);
    }
    // Statement //
    case "EffectStatement": {
...
/**
 * @type {<X, A extends import("./lang").Atom>(
 *   node: import("./lang").Node<A>,
 *   accumulate: (
 *     accumulation: X,
 *     node: import("./lang").Node<A>,
...
export const reduceChild = (node, accumulate, initial) => {
  switch (node.type) {
    ...
    case "PreludeBlock": {
      return accumulate(reduce(node.head, accumulate, initial), node.body);
    }
    case "RoutineBlock": {
      return reduce(node.body, accumulate, accumulate(initial, node.tail));
    }
    // Statement //
    case "EffectStatement": {
