...
export const ARAN_INTRINSIC_ENUM = {
  ...
  "aran.get": null,
  "aran.set.strict": null,
  "aran.set.sloppy": null,
  "aran.delete.strict": null,
  "aran.delete.sloppy": null,
  "aran.deadzone": null,
  "aran.private": null,
...
export const hasParameter = (nodes, parameter) => {
  ...
  const accumulate = (has, node) => {
    if (has) {
      ...
      if (type === "ReadExpression" || type === "WriteEffect") {
      ...
      } else if (parameter === "catch.error" && type === "TryStatement") {
        return (
        ...
        return false;
      } else if (parameter === "new.target" && type === "FunctionExpression") {
        return false;
      } else if (
        (parameter === "function.arguments" && type === "FunctionExpression") ||
        ...
        return false;
      } else if (parameter === "import.meta" && type === "ModuleProgram") {
        return false;
      } else if (
