...
exports.toggleDebugMode = () => {
  ...
  const closures = ((() => {
    ...
    const effects = {
      ...
      "confined":                   ["enclave_variable"],
      "strict-program":             ["enclave_variable", "enclave_this", "enclave_arguments"],
      ...
      "sloppy-program":             ["enclave_variable", "enclave_this", "enclave_arguments", "enclave_loose_variable"],
