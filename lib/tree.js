...
exports._builtin_identifier = "BUILTIN";

exports._eval_check_identifier = "EVAL_CHECK";
...
exports._aran_reserved_word_object = {
  "method": "method",
  "constructor": "constructor",
  "root": "root",
  "arguments": "arguments",
  "eval": "eval",
  "eval-check": "evalcheck"
};
...
const predicates = {
  ...
  identifier: (node) => (
    predicates.label(node) &&
    node !== "arguments" &&
    node !== "eval" &&
    node !== "method" &&
    node !== "constructor" &&
    node !== exports._builtin_identifier &&
    node !== exports._eval_check_identifier),
  declarable: (node) => (
    predicates.identifier(node) &&
    node !== exports._parameters["error"] &&
    node !== exports._parameters["this"] &&
    node !== exports._parameters["new.target"] &&
    node !== exports._parameters["callee"])};
