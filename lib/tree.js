...
const syntax = {
  ...
  Block: {
    __proto__: null,
    Block: [["Identifier"], ["Statement"], "Expression"]
  },
  Statement: {
    __proto__: null,
    // BlockLess //
    ...
    DebuggerStatement: [],
    BundleStatement: [["Statement"]],
    DeclareEnclaveStatement: ["Kind", "WriteEnclaveIdentifier", "Expression"],
    // BlockFull //
    BlockStatement: ["LabelBlock"],
    IfStatement: ["Expression", "LabelBlock", "LabelBlock"],
    WhileStatement: ["Expression", "LabelBlock"],
    TryStatement: ["LabelBlock", "LabelBlock", "LabelBlock"]
  },
  Expression: {
    __proto__: null,
    // Producer //
...
const flaten = (statement) => statement[0] === "BundleStatement" ? statement[1] : [statement];
...
exports.toggleNormalMode = () => {
  ...
  exports.BundleStatement = (statements) => ["BundleStatement", ArrayLite.flatMap(statements, flaten)];
  exports.Block = (identifiers, statements, expression) => ["Block", identifiers, ArrayLite.flatMap(statements, flaten), expression];
};
  ...
  ArrayLite.forEach(global_Reflect_ownKeys(syntax), (type) => {
    ArrayLite.forEach(global_Reflect_ownKeys(syntax[type]), (constructor) => {
      exports[constructor] = (...fields) => {
        ...
        if (constructor === "BundleStatement") {
...
exports.dispatch = (context, node, callbacks) => (
  node.length === 1 ?
...
exports.allign = (context, node1, node2, callbacks) => (
  node1[0] === node2[0] ?
