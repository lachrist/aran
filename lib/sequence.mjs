 ...
 * @type {<W, X, Y, Z>(
 *   array: X[],
 *   accumulate: (value: X, state: Z) => import("./sequence").Sequence<W, [Y, Z]>,
 *   state: Z,
 * ) => import("./sequence").Sequence<W, [Y[], Z]>}
 */
export const mapReduceSequence = (array, accumulate, state) => {
  ...
  for (let index = 0; index < length; index++) {
    ...
    apply(push, head, sequence.head);
    tail[index] = sequence.tail;
  }
 ...
 *   pure4: X4,
 *   sequence5: import("./sequence").Sequence<W5, X5>,
 * ) => import("./sequence").Sequence<W5 | W, X>}
 */
export const callSequence____X = (
  ...
  const { head, tail } = callee(tail1, tail2, tail3, tail4, tail5);
  return { head: concatXX(head5, head), tail };
};
 ...
 *   pure4: X4,
 *   pure5: X5,
 *   sequence6: import("./sequence").Sequence<W6, X6>,
 * ) => import("./sequence").Sequence<W6 | W, X>}
 */
export const callSequence_____X = (
  ...
  tail4,
  tail5,
  { head: head6, tail: tail6 },
) => {
  const { head, tail } = callee(tail1, tail2, tail3, tail4, tail5, tail6);
  return { head: concatXX(head6, head), tail };
};
