...
/**
 * @type {import("./sequence").Sequence<never, null>}
 */
...
/**
 * @type {<W1, W2, X>(
 *   write: import("./util/tree").Tree<W1>,
 ...
 *   sequence: import("./sequence").Sequence<W, X>,
 *   predicate: (word: W) => word is V,
 * ) => import("./sequence").Sequence<Exclude<W, V>, [V[], X]>}
 */
