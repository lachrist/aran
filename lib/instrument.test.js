...
test(
  ...
  `{
      return () => {
        ...
        ${block("script", {serial:0, labels:[]}, null, [], `
          ${trap("debugger", "1")};
          debugger;
...
test(
  ...
  `{
    return () => {
      let ${advice_identifier}, ${parameters_identifier};
      ${advice_identifier} = #Reflect.get(arguments, 0);
      ${block("script", {serial:0, labels:[]}, null, ["x"], `
        ${trap("drop",
...
test(
  ...
  `{
    return () => {
      let ${advice_identifier}, ${parameters_identifier};
      ${advice_identifier} = #Reflect.get(arguments, 0);
      ${block("script", {serial:0, labels:[]}, null, [callee_identifier + "0", callee_identifier + "1", callee_identifier + "2", callee_identifier + "3"], `
        ${trap("drop", `(
