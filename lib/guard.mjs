 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./global_property_key").GlobalPropertyKey}
 */
export const guardGlobalPropertyKey = (report, candidate) => {
  if (typeof candidate !== "string") {
    throw new AranInputError({
      conditions: [],
      target: report,
  ...
  return /** @type {import("./global_property_key").GlobalPropertyKey} */ (
    candidate
  );
};
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/source").GlobalSitu}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/source").DeepLocalSitu}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/source").RootLocalSitu}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/config").LooseEstreeProgram}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/config-internal").InternalFile}
 */
export const guardFile = (report, candidate) => {
  ...
  return {
    ...
    path: /** @type {import("./trans/hash").FilePath} */ (get(object, "path")),
  };
};

/**
 * @type {import("./trans/config-internal").InternalDigest}
 */
const digestDefault = (_node, node_path, file_path, _kind) =>
  /** @type {import("./trans/hash").Hash} */ (`${file_path}#${node_path}`);

/**
 * @type {(
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/config-internal").InternalDigest}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./setup-internal").InternalConfig}
 */
export const guardSetupConfig = (report, candidate) => {
  ...
  return {
    ...
    intrinsic_global_variable: guardGlobalPropertyKey(
 ...
 *   path: string,
 *   candidate: unknown,
 * ) => import("./weave/standard/aspect-internal").InternalPointcut}
 */
 ...
 * ) => import("./weave/flexible/aspect-internal").PointcutEntry}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./weave/flexible/aspect-internal").Pointcut}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => null | import("./weave/flexible/aspect-internal").Pointcut}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./trans/config-internal").InternalConfig}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./weave/standard/config-internal").InternalConfig}
 */
export const guardStandardWeaveConfig = (report, candidate) => {
  ...
  return {
    ...
    advice_global_variable: guardGlobalPropertyKey(
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./weave/flexible/config-internal").InternalConfig}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./retro/config").InternalConfig}
 */
 ...
 *   report: string,
 *   candidate: unknown,
 * ) => import("./instrument-internal").InternalConfig}
 */
