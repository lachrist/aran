 ...
 *   aspect: import("../../type/advice").EmptyAspect
...
const trapBlockSetup = (
  ...
  const cut = pointcut(origin, parent, root);
  if (cut == null) {
    return result;
  } else {
    return makeApplyExpression(
      ...
      concat_X(result, map(cut, makeJsonExpression)),
    );
  }
};
 ...
 *     intrinsic: import("../../type/aran").Intrinsic,
 *   ],
 * ) => [
 *   import("./atom").ResVariable,
 *   import("../../type/aran").Intrinsic,
...
/**
 * @type {(
 *   parameter: import("../../type/aran").Parameter,
 * ) => [
 *   import("./atom").ResExpression,
 *   import("./atom").ResExpression,
 * ]}
...
/**
 * @type {(
 *   parameters: import("../../type/aran").Parameter[],
      ...
      setup.length === 0
        ...
        : [
            pairup(
              ...
              /** @type {import("../../type/aran").Intrinsic} */ ("undefined"),
            ),
          ],
