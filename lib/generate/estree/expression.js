...
exports.primordial = ({1:name}, namespace) => ({
...
exports.apply = ({1:expression1, 2:expression2, 3:expressions}, namespace) => {
  if (expression2[0] === "primitive" && expression2[1] === void 0) {
    if (expression1[0] === "primordial" && expression1[1] === "Array.of") {
      return {
    ...
    if (expression1[0] === "primordial" && expression1[1] === "Object.fromEntries" && expressions.length === 1) {
    ...
    if (expression1[0] === "primordial" && expression1[1] === "Reflect.get" && expressions.length === 2) {
      return {
        type: "MemberExpression",
        computed: true,
