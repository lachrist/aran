...
exports.ArrayExpression = (node, scope, name) => (
  ...
  Build.apply(
    Build.primordial("Array.prototype.concat"),
...
exports.ObjectExpression = (node, scope, name) => Scope.token(
  scope,
  Build.apply(
    Build.primordial("Object.create"),
    Build.primitive(void 0),
    [
      Build.primitive(null)]),
  (token1) => Scope.token(
    scope,
    Build.primordial("Object.prototype"),
    (token2) => Build.sequence(
      Build.apply(
        Build.primordial("Reflect.setPrototypeOf"),
        Build.primitive(void 0),
        [
                      ...
                      ArrayLite.every(
                        ...
                        (property2, index2) => (
                          ...
                          (
                            !property1.computed &&
                            !property2.computed &&
                            property1.key.name !== property2.key.name))) ?
                      Build.apply(
                        ...
                        [
                          ...
                          (
                            ...
                            Build.primitive(property1.key.name)),
                          Visit.node(
                            property1.value,
                            scope,
                            (
                              ...
                              property1.key.name))]) :
                      Build.apply(
                        Build.primordial("Reflect.defineProperty"),
                        Build.primitive(void 0),
                        [
                          Scope.read(scope, token1),
                          (
                                ...
                                Visit.node(
                                  ...
                                  (
                                    ...
                                    (
                                      ...
                                      property1.kind) :
                                    property1.kind + " " + property1.key.name))]),
                            Build.sequence(
                              Build.apply(
                                Build.primordial("Reflect.set"),
                                Build.primitive(void 0),
...
exports.UnaryExpression = (node, scope, name) => (
  ...
  (
    ...
    (
      ...
      Build.conditional(
        Build.apply(
          Build.primordial("Reflect.deleteProperty"),
          Build.primitive(void 0),
          [
            Scope.token(
              scope,
...
exports.NewExpression = (node, scope, name) => (
  ...
  Build.apply(
    Build.primordial("Reflect.construct"),
    Build.primitive(void 0),
    [
      Visit.node(node.callee, scope, ""),
      Build.apply(
...
exports.CallExpression = (node, scope) => (
  ...
  Scope.token(
    ...
    (
      ...
      Build.primitive(void 0)),
    (token) => Build.apply(
      Build.primordial("Reflect.apply"),
      Build.primitive(void 0),
      [
        (
          node.callee.type === "MemberExpression" ?
...
exports.TaggedTemplateExpression = (node, scope, name) => Build.apply(
  ...
  ArrayLite.concat(
    [
      Build.apply(
        Build.primordial("Object.freeze"),
        Build.primitive(void 0),
        [
          Scope.token(
            scope,            
              ...
              ArrayLite.concat(
                ...
                (
                  ...
                  Scope.Assign(
                    ...
                    node.params[node.params.length-1].argument,
                    Build.apply(
                      Build.primordial("Array.prototype.slice"),
                      Scope.read(scope, "arguments"),
                      [
                        Build.primitive(node.params.length-1)])) :
                  []),
                    ...
                    Build.Expression(
                      Build.apply(
                        ...
                        [
                          ...
                          (
                            Scope.GetStrict(scope) ?
                            Build.primordial("Reflect.getOwnPropertyDescriptor(Function.prototype,\"arguments\").get") :
                            Scope.read(scope, token1))])),
                    Build.Expression(
                      Build.apply(
                        Build.primordial("Reflect.set"),
                        ...
                        [
                          ...
                          (
                            Scope.GetStrict(scope) ?
                            Build.primordial("Reflect.getOwnPropertyDescriptor(Function.prototype,\"arguments\").set") :
                            Build.primitive(true))])),
                    Build.Expression(
                      Build.apply(
                        Build.primordial("Reflect.set"),
                    ...
                    Build.Expression(
                      Build.apply(
                        ...
                        [
                          Scope.read(scope, token3),
                          Build.primitive("value"),
                          Build.primordial("Array.prototype.values")])),
                    Build.Expression(
                      Build.apply(
                        Build.primordial("Reflect.set"),
                        Build.primitive(void 0),
