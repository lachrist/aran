...
helpers["HelperThrowReferenceError"] = (scope) => Build.closure(
  Scope.BLOCK(
    ...
    (scope) => ArrayLite.concat(
      ...
      Build.Throw(
        Build.construct(
          Build.primordial("ReferenceError"),
          [
            Scope.read(scope, "message")])))));
      ...
      Build.While(
        ...
        Scope.BLOCK(
          ...
          (scope) => Build.If(
            [],
            Build.apply(
              Build.primordial("Reflect.getOwnPropertyDescriptor"),
            ...
            Scope.BLOCK(
              ...
              (scope) => Scope.Write(
                ...
                "object",
                Build.apply(
                  Build.primordial("Reflect.getPrototypeOf"),
                  Build.primitive(void 0),
                  [
                    Scope.read(scope, "object")])))))),
      Build.Return(
        ...
        Scope.BLOCK(
          ...
          (scope) => ArrayLite.concat(
            ...
            Build.If(
              [],
              Build.apply(
                Build.primordial("Array.prototype.includes"),
