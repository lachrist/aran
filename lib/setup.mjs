            ...
            makeBlockStatement([
              makeThrowStatement(
                makeNewExpression(makeVariableIdentifier("SyntaxError"), [
                  makeSimpleLiteral(
                    "aran.transpile must be overriden to support direct eval calls",
                  ),
                ]),
              ),
            ]),
          ...
          makeArrowFunctionExpression(
            ...
            makeBlockStatement([
              makeThrowStatement(
                makeNewExpression(makeVariableIdentifier("SyntaxError"), [
                  makeSimpleLiteral(
                    "aran.retropile must be overriden to support direct eval calls",
                  ),
                ]),
              ),
            ]),
...
/**
 * @type {(
 *   config: import("./setup").InternalConfig,
 * ) => import("estree-sentry").ScriptProgram<{}>}
 */
