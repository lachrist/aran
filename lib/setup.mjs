 ...
 *   ... input: [
 *     computed: true,
 *     key: import("./estree").Expression,
 *     value: import("./estree").FunctionExpression,
 *   ] | [
 *     computed: false,
 *     key: import("./estree").Identifier,
 *     value: import("./estree").FunctionExpression,
 *   ]
 * ) => import("./estree").MethodDefinition}
 */
const _makeMethodDefinition = (kind, _static, computed, key, value) => ({
      ...
      [
        makeObjectPattern([
          makeAssignmentProperty(
            false,
            makeIdentifier("eval"),
            makeIdentifier(params.global_eval),
          ),
        ]),
        makeIdentifier(params.cache),
      ],
      makeArrowFunctionExpression(
        [
          makeIdentifier(params.variable),
          makeIdentifier(params.additional),
          makeIdentifier(params.optimization),
        ],
          ...
          makeCallExpression(
            makeLogicalExpression(
              ...
              makeAssignmentExpression(
                ...
                makeCallExpression(makeIdentifier(params.global_eval), [code]),
              ),
            ),
            [],
          ),
  ...
  switch (intrinsic) {
          ...
          makeTryStatement(
            makeBlockStatement([
              makeExpressionStatement(
                makeClassExpression(makeIdentifier("value"), makeClassBody([])),
              ),
              makeReturnStatement(
                makeBinaryExpression(
                  "!==",
          ...
          makeArrowFunctionExpression(
            ...
            makeBlockStatement([
              makeVariableDeclaration(
                "const",
                makeIdentifier("keys"),
                makeCallExpression(makeIdentifier("ownKeys"), [
                  makeIdentifier("object"),
                ]),
              ),
              makeVariableDeclaration(
                ...
                makeBlockStatement([
                  ...
                  makeIfStatement(
                    makeLogicalExpression(
                      ...
                      makeUnaryExpression(
                        "!",
                        makeCallExpression(makeIdentifier("hasOwn"), [
                          makeIdentifier("exclusion"),
                          makeIdentifier("key"),
                        ]),
                      ),
                      makeMemberExpression(
          ...
          [
            makeObjectPattern([
              makeAssignmentProperty(
                false,
                makeIdentifier("eval"),
                makeIdentifier("global_eval"),
              ),
            ]),
          ],
          makeArrowFunctionExpression(
            [makeIdentifier("variables")],
            makeCallExpression(makeIdentifier("global_eval"), [
    ...
    case "aran.readGlobal": {
      return makeAccessGlobalExpression(
        ...
        makeConcatExpression("+", [
          makeSimpleLiteral("(() => "),
          makeIdentifier(ACCESS_GLOBAL_PARAM_RECORD.variable),
          makeSimpleLiteral(");"),
        ]),
      );
    }
