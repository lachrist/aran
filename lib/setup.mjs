...
import { AranTypeError, map, reduce } from "./util/index.mjs";
        ...
        makeSequenceExpression([
          makeCallExpression(
            makeMemberExpression(
              ...
              makeSimpleLiteral(/** @type {aran.Intrinsic} */ ("Reflect.set")),
            ),
            [
              makeCallExpression(
                makeMemberExpression(
                  ...
                  makeSimpleLiteral(/** @type {aran.Intrinsic} */ ("Object")),
                ),
                [makeIdentifier("object")],
              ),
              makeIdentifier("key"),
      ...
      return makeArrowFunctionExpression(
        ...
        makeCallExpression(
          makeMemberExpression(
            ...
            makeSimpleLiteral(
              /** @type {aran.Intrinsic} */ ("Reflect.deleteProperty"),
            ),
          ),
          [
            makeCallExpression(
 ...
 */
export const generateSetup = (namespace, global) =>
  makeProgram("script", [
    ...
    makeExpressionStatement(
      makeAssignmentExpression(
        ...
        generateSetupExpression(namespace, global),
      ),
    ),
  ]);
