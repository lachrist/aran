  ...
  switch (intrinsic) {
    ...
    case "aran.throw": {
      return makeArrowFunctionExpression(
        getIntrinsicFunctionName("aran.throw"),
        { asynchronous: false },
    ...
    case "aran.get": {
      return makeArrowFunctionExpression(
        getIntrinsicFunctionName("aran.get"),
        { asynchronous: false },
    ...
    case "aran.unary": {
      return makeArrowFunctionExpression(
        getIntrinsicFunctionName("aran.unary"),
        { asynchronous: false },
        [
    ...
    case "aran.binary": {
      return makeArrowFunctionExpression(
        getIntrinsicFunctionName("aran.binary"),
        { asynchronous: false },
        [
          makeVariableIdentifier("operator"),
    ...
    case "aran.listRest": {
      return makeCallExpression(
        makeArrowFunctionExpression(
          ...
          makeArrowFunctionExpression(
            getIntrinsicFunctionName("aran.listRest"),
            { asynchronous: false },
            [
              makeVariableIdentifier("iterator"),
    ...
    case "aran.declareGlobal": {
      return makeCallExpression(
        makeArrowFunctionExpression(
          ...
          makeArrowFunctionExpression(
            getIntrinsicFunctionName("aran.declareGlobal"),
            { asynchronous: false },
    ...
    case "aran.readGlobal": {
      return makeAccessGlobalExpression(
        getIntrinsicFunctionName("aran.readGlobal"),
    ...
    case "aran.typeofGlobal": {
      return makeAccessGlobalExpression(
        getIntrinsicFunctionName("aran.typeofGlobal"),
        ACCESS_GLOBAL_PARAM_RECORD,
        makeConcatExpression("+", [
    ...
    case "aran.discardGlobal": {
      return makeAccessGlobalExpression(
        getIntrinsicFunctionName("aran.discardGlobal"),
        ACCESS_GLOBAL_PARAM_RECORD,
        makeConcatExpression("+", [
    ...
    case "aran.writeGlobalSloppy": {
      return makeAccessGlobalExpression(
        getIntrinsicFunctionName("aran.writeGlobalSloppy"),
        ACCESS_GLOBAL_PARAM_RECORD,
        makeConcatExpression("+", [
          makeSimpleLiteral("(("),
          makeConditionalExpression(
    ...
    case "aran.writeGlobalStrict": {
      return makeAccessGlobalExpression(
        getIntrinsicFunctionName("aran.writeGlobalStrict"),
        ACCESS_GLOBAL_PARAM_RECORD,
        makeConcatExpression("+", [
    ...
    case "aran.transpileEval": {
      return makeCallExpression(
        makeArrowFunctionExpression(
          ...
          makeArrowFunctionExpression(
            getIntrinsicFunctionName("aran.transpileEval"),
            { asynchronous: false },
    ...
    case "aran.retropileEval": {
      return makeCallExpression(
        makeArrowFunctionExpression(
          ...
          makeArrowFunctionExpression(
            getIntrinsicFunctionName("aran.retropileEval"),
            { asynchronous: false },
