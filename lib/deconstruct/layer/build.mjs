...
/** @typedef {import("./variable_old.mjs").MetaVariable} MetaVariable */

/** @typedef {import("./variable_old.mjs").BaseVariable} BaseVariable */

export const makeParameterReadExpression =
  /** @type {<T>(variable: Parameter, tag: T) => Expression<T>} */ (
    /** @type {unknown} */ (makeReadExpression)
  );

export const makeParameterWriteEffect =
  /** @type {<T>(variable: Parameter, right: Expression<T>, tag: T) => Effect<T>} */ (
