...
/** @type {<T>(strict: boolean, binding: Binding, variable: estree.Variable, tag: T) => aran.Statement<unbuild.Atom<T>>[]} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: estree.Variable, expression: aran.Expression<unbuild.Atom<T>>, tag: T) => aran.Statement<unbuild.Atom<T>>[]} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: estree.Variable, tag: T) => aran.Expression<unbuild.Atom<T>>} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: estree.Variable, pure: aran.Expression<unbuild.Atom<T>>, tag: T) => aran.Effect<unbuild.Atom<T>>[]} */
