...
/** @type {<B extends Binding, T>(binding: B) => BindingModule<B, T>} */
const getBindingModule = (binding) =>
  /** @type {any} */ (Bindings[binding.type]);

/** @type {(strict: boolean, binding: Binding, variable: Variable) => Variable[]} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: Variable, tag: T) => Statement<T>[]} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: Variable, expression: Expression<T>, tag: T) => Statement<T>[]} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: Variable, tag: T) => Expression<T>} */
...
/** @type {<T>(strict: boolean, binding: Binding, variable: Variable, pure: Expression<T>, tag: T) => Effect<T>[]} */
