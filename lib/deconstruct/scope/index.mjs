 ...
 *   dynamic: aran.Expression<unbuild.Atom<T>> | null;
 * }} Frame
 */
...
/** @type {<T>(strict: boolean, scope: Scope<T>, tag: T) => aran.Statement<unbuild.Atom<T>>[]} */
...
/** @type {<T>(strict: boolean, scope: Scope<T>, variable: estree.Variable, right: aran.Expression<unbuild.Atom<T>>, tag: T) => aran.Statement<unbuild.Atom<T>>[]} */
 ...
 * @param {(
 *   strict: boolean,
 *   dynamic: aran.Expression<unbuild.Atom<T>>,
 *   variable: estree.Variable,
 *   tag: T,
...
const compileMakeScopeLookupExpresison = (
  ...
  /** @type {(strict: boolean, scope: Scope<T>, variable: estree.Variable, tag: T) => aran.Expression<unbuild.Atom<T>>} */
