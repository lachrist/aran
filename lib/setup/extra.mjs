 ...
 * @type {(
 *   layout: {
 *     name: keyof import("../lang/naming.d.ts").IntrinsicFunctionNaming,
 *     dependencies: import("../util/tree.d.ts").Tree<import("./layout.d.ts").Dependency>,
 *     setup: import("../util/tree.d.ts").Tree<import("estree-sentry").Statement<{}>>,
...
/**
 * @type {(
 *   name: import("../lang/syntax.d.ts").AranIntrinsic,
 * ) => import("./layout.d.ts").Layout}
 */
