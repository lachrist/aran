...
exports._match_expression = (expression1, expression2) => Lang._allign_expression(block_callback_object, "expression", expression1, expression2);

exports._match_statement = (satement1, statement2) => Lang._allign_expression(block_callback_object, "statement", statement1, statement2);
...
const block_callback_object = {
  ...
  BLOCK: (path, block1, block2, identifiers1, statements1, identifiers2, statements2) => (
