...
export const AranDoubleTypeError = class extends AranError {
  constructor(/** @type {never} */ data1, /** @type {never} */ data2) {
    const message = `Typescript loophole: ${print(data1)} and ${print(data2)}}`;
    super(message, { data1, data2 });
    this.name = "AranTypeError";
    this._aran_bug = true;
  }
};
...
export const AranPoincutError = class extends Error {
  constructor(/** @type {import("./estree").Variable[]} */ conflicts) {
    super(
