...
export const AranSyntaxError = class extends SyntaxError {
  constructor(
    /** @type {string} */ message,
    /** @type {import("./error.d.ts").SyntaxErrorCause} */ cause,
  ) {
    super(message);
...
/**
 * @type {(
 *   cause: import("./error.d.ts").InputErrorCause,
 * ) => string}
 */
...
export const AranInputError = class extends Error {
  constructor(/** @type {import("./error.d.ts").InputErrorCause} */ cause) {
...
/**
 * @type {(
 *   cause: import("./error.d.ts").PointcutErrorCause,
 * ) => string}
 */
...
export const AranPointcutError = class extends Error {
  constructor(/** @type {import("./error.d.ts").PointcutErrorCause} */ cause) {
...
/**
 * @type {(
 *  clash: import("./error.d.ts").ClashErrorCause,
 * ) => string}
 */
...
export const AranClashError = class extends Error {
  constructor(/** @type {import("./error.d.ts").ClashErrorCause} */ cause) {
