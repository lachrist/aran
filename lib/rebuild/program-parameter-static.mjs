...
const PRIVATE_PARAM = {
  object: /** @type {estree.Variable} */ ("object"),
  key: /** @type {estree.Variable} */ ("key"),
  value: /** @type {estree.Variable} */ ("value"),
};
