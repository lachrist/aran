 ...
 * ][]}
 */
export const makeLookupDeclarator = (
  dynamic,
  mode,
  operation,
  head,
 ...
 * ][]}
 */
export const listLookupDeclarator = (dynamic, head, config) =>
  flatMap(MODE, (mode) =>
    flatMap(OPERATION, (operation) =>
      makeLookupDeclarator(dynamic, mode, operation, head, config),
    ),
  );
