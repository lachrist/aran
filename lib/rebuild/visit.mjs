 ...
 * @type {(
 *   link: aran.Link<rebuild.Atom>,
 * ) => [string, aran.Link<rebuild.Atom>]}
 */
const makeLinkEntry = (link) => [hashLink(link), link];

/**
 * @type {(
 *   links: aran.Link<rebuild.Atom>[],
 * ) => aran.Link<rebuild.Atom>[]}
 */
const removeDuplicateLink = (links) =>
  toArray(apply(listMapValue, new Map(map(links, makeLinkEntry)), []));
  ...
  switch (node.type) {
    ...
    case "ModuleProgram": {
      return {
        ...
        sourceType: "module",
        body: [
          ...flatMap(removeDuplicateLink(node.links), (child) =>
            rebuildLink(child, context),
          ),
          ...prelude,
 ...
 *   context: import("./visit.js").Context,
 * ) => estree.Statement}
 */
          ...
          specifiers: [
            node.import === null
              ...
              : {
                  ...
                  imported: makeSpecifier(node.import),
                },
          ],
          source: {
            type: "Literal",
          ...
          specifiers: [
            {
              ...
              exported: makeSpecifier(node.export),
            },
          ],
        },
      ];
        ...
        return [
          {
            ...
            exported: node.export === null ? null : makeSpecifier(node.export),
            source: {
              type: "Literal",
              value: node.source,
            },
        ...
        return [
          {
            ...
            specifiers: [
              {
                type: "ExportSpecifier",
                local: makeSpecifier(node.import),
                exported: makeSpecifier(node.export),
              },
            ],
            source: {
