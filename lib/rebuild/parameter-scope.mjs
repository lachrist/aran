...
const CACHE_VARIABLE = /** @type {import("../estree").Variable} */ (
  "__ARAN_CACHE__"
);

const VARIABLE_VARIABLE = /** @type {import("../estree").Variable} */ (
  "__ARAN_VARIABLE__"
);

const ADDITIONAL_VARIABLE = /** @type {import("../estree").Variable} */ (
  "__ARAN_ADDITIONAL__"
);

const OPTIMIZATION_VARIABLE = /** @type {import("../estree").Variable} */ (
  "__ARAN_OPTIMIZATION__"
);
      ...
      properties: [
        {
          ...
          key: {
            type: "Identifier",
            name: /** @type {import("../estree").PublicKey} */ ("__proto__"),
          },
          value: {
            type: "Literal",
            value: null,
