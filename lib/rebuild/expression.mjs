...
import { rebuildRoutineBlock } from "./block.mjs";
...
/**
 * @type {(
 *   node: aran.Expression<rebuild.Atom> & { type: "ClosureExpression" },
  ...
  switch (node.kind) {
        ...
        body: {
          ...
          body: concatXXX(
            ...
            hasParameter(node.body, "this")
              ...
              : [],
            rebuildRoutineBlock(node.body, config, {
              completion: "return",
            }),
          ),
        },
    ...
    case "arrow": {
      return {
        ...
        body: {
          type: "BlockStatement",
          body: rebuildRoutineBlock(node.body, config, {
            completion: "return",
          }),
        },
      };
