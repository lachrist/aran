...
NAMESPACE.builtins.AranGet = function AranGet (object, key) {
  return object[key];
};
...
NAMESPACE.builtins.AranUnary = function AranUnary (operator, argument) {
  switch (operator) {
...
NAMESPACE.builtins.AranBinary = function AranBinary (operator, left, right) {
  switch (operator) {
