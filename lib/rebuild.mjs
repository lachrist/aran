...
/**
 * @type {Record<aran.Parameter, (context: Context) => estree.Expression>}
 */
export const initializers = {
  ...
  "scope.read": (context) => ({
    ...
    params: [
      {
        type: "Identifier",
        name: encodeArgument(context.prefix, "var"),
      },
    ],
    body: {
      type: "CallExpression",
      ...
      arguments: [
        {
          ...
          quasis: [
            ...
            },
            {
              type: "TemplateElement",
              value: {
                cooked: ` = ${encodeArgument(context.prefix, "val")}`,
                raw: ` = ${encodeArgument(context.prefix, "val")}`,
              },
              tail: false,
            },
            {
  ...
  "private.get": (context) => ({
    ...
    params: [
      {
        type: "Identifier",
        name: encodeArgument(context.prefix, "obj"),
      },
      {
        type: "Identifier",
        name: encodeArgument(context.prefix, "key"),
          ...
          quasis: [
            {
              type: "TemplateElement",
              value: {
                cooked: `(${encodeArgument(context.prefix, "obj")}.#`,
                raw: `(${encodeArgument(context.prefix, "obj")}.#`,
              },
              tail: false,
            },
            {
 ...
 */
const makeParameterDeclarator = (parameter, context) => {
  const initializer = initializers[parameter];
  return {
 ...
 * ) => estree.VariableDeclarator[]}
 */
const listParameterDeclarator = (node, parameter, context) =>
  hasParameter(node, parameter)
    ? [makeParameterDeclarator(parameter, context)]
    : [];
    ...
    case "ScriptProgram":
      return {
        ...
        body: [
          ...
          // accros multiple script programs.
          ...
          ...cleanVariableDeclaration({
            ...
            declarations: map(
              filter(
                ...
                (parameter) => hasParameter(node, parameter),
              ),
              (parameter) => makeParameterDeclarator(parameter, context),
            ),
          }),
