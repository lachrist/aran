...
const diff_estree_loop = (path, node1, node2) => {
  ...
  if (global.Array.isArray(node1)) {
    ...
    for (let key of global.Reflect.ownKeys(node1)) {
      Assert.ok(global.Reflect.getOwnPropertyDescriptor(node2, key) !== void 0, `${path} >> key missing`);
  ...
  diff_estree(
    Generate(
      ...
      global.Object.assign(
        {build:"estree"},
        options)),
    Parse[options.sort === "module" ? "module" : "script"](code)));
...
test(
  ...
  Tree._program(
    ...
    Tree.BLOCK([], [])),
  `
    "use strict"; const BUILTIN = this["__aran_intrinsic__"]; ((() =>
...
test(
  ...
  Tree._program(
    ...
    Tree.BLOCK([], [])),
  `
    "use strict"; const BUILTIN = this["__aran_intrinsic__"]; let EXPORT_spc2;
