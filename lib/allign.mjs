...
/**
 * @template V1, T1, V2, T2
 * @typedef {{
 *   type: "failure",
 *   path: string,
 *   pair: [aran.Node<V1, T1>, aran.Node<V2, T2>],
 * } | {
 *   type: "success",
 *   labels: [aran.Label, aran.Label][],
 *   variables: [V1, V2][],
 * }} Result
 */
 ...
 *   path: string,
 *   parents: [aran.Node<V1, T1>, aran.Node<V2, T2>],
 * ) => Result<V1, T1, V2, T2>}
 */
...
/**
 * @template V1, T1, V2, T2
 * @param {Result<V1, T1, V2, T2>[]} results
 * @param {string} path
 * @param {[aran.Node<V1, T1>, aran.Node<V2, T2>]} parents
 * @returns {Result<V1, T1, V2, T2>}
 */
const combineAllResult = (results, path, parents) => {
  /** @type {[aran.Label, aran.Label][]} */
  const labels = [];
  /** @type {[V1, V2][]} */
  const variables = [];
 ...
 * @template {string} V2
 * @template T2
 * @param {[aran.Node<V1, T1>, aran.Node<V2, T2>]} pair
 * @param {string} path
 * @returns {Result<V1, T1, V2, T2>[]}
 */
 ...
 * @template {string} V2
 * @template T2
 * @param {aran.Node<V1, T1>} node1
 * @param {aran.Node<V2, T2>} node2
 * @returns {Result<V1, T1, V2, T2> | null}
 */
export const allign = (node1, node2) => {
  /** @type {[aran.Node<V1, T1>, aran.Node<V2, T2>]} */
