 ...
 * ) => import("./atom").ResExpression}
 */
const makeUnsafeParameterExpression = (parameter, dynamic, root) => {
            ...
            case "local.root": {
              ...
              return {
                ...
                record: {
                  ...
                  "scope.typeof": makeReadExpression("scope.typeof"),
                  "scope.discard": makeReadExpression("scope.discard"),
                  "super.get": makeUnsafeParameterExpression(
                    "super.get",
                    dynamic,
                    parent,
                  ),
                  "super.set": makeUnsafeParameterExpression(
                    "super.set",
                    dynamic,
                    parent,
                  ),
                  "super.call": makeUnsafeParameterExpression(
                    "super.call",
                    dynamic,
                    parent,
                  ),
                  "import.meta": makeUnsafeParameterExpression(
                    "super.call",
                    dynamic,
                    parent,
                  ),
                  "new.target": makeUnsafeParameterExpression(
                    "new.target",
                    dynamic,
                    parent,
                  ),
