 ...
 *   initial_state: import("../../util/util").Json,
 *   kind: import("../parametrization").ProgramKind,
 *   tag: import("../atom").Tag,
 * ) => import("../../util/tree").Tree<import("../atom").ResEffect>}
 */
export const trapProgramBlockSetup = (
  { "program-block@setup": predicate },
  depth,
  initial_state,
  kind,
  tag,
  ...
  makeWriteEffect(
    ...
    predicate(kind, tag)
      ? makeTrapExpression(
          "program-block@setup",
          [
            makeJsonExpression(initial_state, tag),
 ...
 * ) => import("../../util/tree").Tree<import("../atom").ResEffect>}
 */
export const trapClosureBlockSetup = (
  { "closure-block@setup": predicate },
  depth,
  kind,
  tag,
) =>
