 ...
 * ]}
 */
const extractPointcutEntry = ([key, val]) => {
 ...
 * @type {<
 *   S,
 *   A extends import("../../lang/syntax").Atom,
 *   V extends import("./aspect").Valuation,
 * >(
 *   aspect: import("./aspect").Aspect<S, A, V>,
 * ) => import("./aspect").ObjectPointcut<A>}
 */
