import { Intrinsic, RuntimePrimitive } from "../../lang";
import { DeepLocalContext } from "../../program";
import { Label, ArgVariable as Variable } from "../atom";
...
export type ObjectAdvice<L> = {
  ...
  "primitive@after"?: (primitive: RuntimePrimitive, location: L) => unknown;
  "import@after"?: (
    source: string,
