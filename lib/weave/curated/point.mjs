 ...
 * @type {<V, L>(
 *   value: V,
 *   context: import("../../program").DeepLocalContext,
 *   location: L,
 * ) => import("./point").Point<V, L>}
 */
...
/**
 * @type {<V, L>(
 *   frame: import("./frame").Frame<V>,
 *   location: L,
 * ) => import("./point").Point<V, L> & { type: "block.enter"} }
 */
 ...
 * ) => import("./point").Point<V, L>}
 */
export const makeBlockLeavePoint = (
 ...
 * ) => import("./point").Point<V, L>}
 */
export const makeBlockFailurePoint = (
  { record: _record, ...frame },
  value,
  location,
) => ({
 ...
 * ) => import("./point").Point<V, L>}
 */
export const makeBlockCompletionPoint = (
  { record: _record, ...frame },
  value,
  location,
) => ({
