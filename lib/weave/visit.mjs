...
import { map, flatMap, filter, includes, some, unzip } from "../util/index.mjs";
...
import { kindSitu } from "../situ.mjs";
import { listHeadParameter } from "../header.mjs";
 ...
 *   },
 *   options: import("./visit.d.ts").Options<L>,
 *   situ: import("../situ.js").Situ,
 * ) => aran.Program<weave.ResAtom>}
 */
export const weaveProgram = ({ node, path }, options, situ) =>
  makeProgram(
    node.head,
...
/**
 * @type {(
 *   parent: import("./visit.d.ts").Parent,
 * ) => aran.Parameter[]}
 */
const listParentParameter = (parent) => {
  switch (parent.type) {
    ...
    case "program": {
      return listHeadParameter(parent.head);
    }
    default: {
      throw new AranTypeError(parent);
    }
 ...
 *   },
 *   options: import("./visit.d.ts").Options<L>,
 *   parent: import("./visit.d.ts").Parent & { type: "program" | "closure" },
