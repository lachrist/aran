import { reduce, filterOut, includes } from "../util/index.mjs";
...
export const recordFree = ({ tag }) => tag;
 ...
 * ) => weave.Free}
 */
export const combineFree = (free, node) => ({ ...free, ...node.tag });
...
export const makePseudoBlock = (statements, completion) => ({
  ...
  statements,
  completion,
  tag: { ...reduce(statements, combineFree, {}), ...completion.tag },
});
...
export const makeClosureBlock = (variables, statements, completion) => ({
  ...
  tag: reduceEntry(
    filterOut(
      listEntry({ ...reduce(statements, combineFree, {}), ...completion.tag }),
...
export const makeControlBlock = (labels, variables, statements) => ({
  ...
  statements,
  tag: reduceEntry(
    filterOut(listEntry(reduce(statements, combineFree, {})), ([key, _val]) =>
...
export const makeModuleProgram = (links, body) => ({
  ...
  links,
  body,
  tag: { ...body.tag, ...reduce(links, combineFree, {}) },
});
...
export const makeConditionalEffect = (condition, positive, negative) => ({
  ...
  tag: {
    ...condition.tag,
    ...reduce(positive, combineFree, {}),
    ...reduce(negative, combineFree, {}),
  },
});
 ...
 * ) => aran.Expression<weave.ResAtom>}
 */
export const makeFunctionExpression = (kind, asynchronous, generator, body) =>
  kind === "arrow"
    ? {
...
export const makeApplyExpression = (callee, this_, arguments_) => ({
  ...
  tag: { ...callee.tag, ...this_.tag, ...reduce(arguments_, combineFree, {}) },
});
...
export const makeConstructExpression = (callee, arguments_) => ({
  ...
  callee,
  arguments: arguments_,
  tag: { ...callee.tag, ...reduce(arguments_, combineFree, {}) },
});
