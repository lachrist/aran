...
/**
 * @template S
 * @typedef {import("./advice.js").ObjectPointcut<S>} ObjectPointcut
 */
...
/** @type {<S>(pointcut: ObjectPointcut<S>, point: Point<S>,) => boolean} */
const cutObject = (pointcut, point) => {
  switch (point.type) {
    ...
    case "function.failure":
      return cut3(pointcut["function.failure"], point.kind, null, point.serial);
    ...
    case "function.leave":
      return cut2(pointcut["function.leave"], point.kind, point.serial);
    case "block.enter":
      return cut4(
    ...
    case "eval.before":
      return cut3(pointcut["eval.before"], null, point.context, point.serial);
    case "eval.after":
    ...
    case "global.read.before":
      return cut2(pointcut["global.read.before"], point.variable, point.serial);
    ...
    case "global.write.after":
      return cut2(pointcut["global.write.after"], point.variable, point.serial);
