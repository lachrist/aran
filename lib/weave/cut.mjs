...
/**
 * @template L
 * @typedef {import("./advice.js").ObjectPointcut<L>} ObjectPointcut
 */

/**
 * @template L
 * @typedef {import("./advice.js").Point<L>} Point
 */

/**
 * @template L
 * @typedef {import("./advice.js").Pointcut<L>} Pointcut
 */
...
/** @type {<L>(pointcut: ObjectPointcut<L>, point: Point<L>) => boolean} */
const cutObject = (pointcut, point) => {
  switch (point.type) {
    ...
    case "program.leave":
      return cut2(pointcut["program.leave"], point.kind, point.location);
    case "function.enter":
      return cut4(
        pointcut["function.enter"],
        point.kind,
        null,
        reduceEntry(
          map(
    ...
    case "function.completion":
      return cut3(
        pointcut["function.completion"],
        point.kind,
        null,
        point.location,
      );
    case "function.leave":
      return cut2(pointcut["function.leave"], point.kind, point.location);
    case "block.enter":
      return cut4(
    ...
    case "global.read.before":
      return cut2(
        pointcut["global.read.before"],
        point.variable,
        point.location,
      );
    case "global.read.after":
      return cut3(
        pointcut["global.read.after"],
        point.variable,
        null,
        point.location,
      );
    case "global.typeof.before":
      return cut2(
        pointcut["global.typeof.before"],
        point.variable,
        point.location,
      );
    case "global.typeof.after":
      return cut3(
        pointcut["global.typeof.after"],
        point.variable,
        null,
        point.location,
      );
    ...
    case "global.write.after":
      return cut2(
        pointcut["global.write.after"],
        point.variable,
        point.location,
      );
    case "global.declare.before":
      return cut4(
        pointcut["global.declare.before"],
        point.kind,
        point.variable,
        null,
        point.location,
...
/** @type {<L>(point: Point<L>, Pointcut: Pointcut<L>) => boolean} */
