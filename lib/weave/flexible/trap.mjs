import { AranDuplicateCutError } from "../../report.mjs";
...
const trapAllConflict = (name, input, target, context, entries) => {
  ...
  if (results.length === 0) {
    ...
    throw new AranDuplicateCutError({
      advice: name,
 ...
 *   situ: import("../../source").DeepLocalSitu,
