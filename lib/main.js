...
module.exports = (options = {}) => {
  ...
  if (Reflect_apply(String_prototype_trim, options.namespace, []) !== options.namespace)
    throw new Error("options.namespace should not contain triming whitespaces");
  try {
    new Function(options.namespace, "var "+options.namespace);
  } catch (error) {
