                      ...
                      Lexical.EXTEND(
                        ...
                        ArrayLite.concat(
                          (
                            (
                              node.id &&
                              !ArrayLite.includes(node.AranParamNames, node.id.name)) ?
                            [node.id.name] :
                            []),
                          ["this", "new.target"],
                          (
                            ArrayLite.includes(node.AranParamNames, "arguments") ?
                            [] :
                            ["arguments"]),
                          node.AranParamNames),
                      ...
                      (
                        ...
                        ArrayLite.concat(
                          Build.Block(
                            ...
                            Lexical.EXTEND(
                              false,
                              ArrayLite.concat(node.AranVarNames, node.AranLetNames),
                              node.AranConstNames,
                              (scope) => ArrayLite.concat(
                                ArrayLite.flatMap(
                                  node.AranVariableNames,
                                  (name) => Lexical.Declare(
                                    ...
                                    Build.primitive(void 0),
                                    scope)),
                                Visit.Statements(node.body.body, scope)),
                              scope))))),
                    scope)),
                Build.primitive("length"),
                Build.primitive(node.AranLength),
