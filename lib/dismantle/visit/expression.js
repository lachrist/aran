...
exports.MemberExpression = (node, scope, name) => Build.get(
...
exports.Identifier = (node, scope, name) => Scope.read(node.name, scope);
                        ...
                        (token2) => (
                          (
                            ...
                            Query.IsArgumentsFree(
                              ArrayLite.concat(nodes.params [node]))) ?
                          ArrayLite.concat(
                            ArrayLite.flatMap(
                              node.params,
                              (pattern, index) => (
