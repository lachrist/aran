...
/** @type {(node: Program, mapper: Mapper) => Program} */
...
/** @type {(node: Block, mapper: Mapper) => Block} */
...
/** @type {(node: Statement, mapper: Mapper) => Statement} */
...
/** @type {(node: Effect, mapper: Mapper) => Effect} */
export const mapEffect = (node, { expression: transformExpression }) => {
  switch (node.type) {
    case "WriteEffect":
      return {
        ...node,
