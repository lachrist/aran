import { StaticError, some, reduce } from "./util/index.mjs";

/**
 * @type {<V, T, X>(
 *   node: aran.Node<V, T>,
 *   combine: (current: X, node: aran.Node<V, T>) => X,
 *   initial: X,
 * ) => X}
 */
...
/** @type {<V, T>(node: aran.Node<V, T>) => aran.Node<V, T>[]} */
...
/** @type {<V, T>(node: aran.Node<V, T>) => boolean} */
