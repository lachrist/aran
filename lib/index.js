...
ArrayLite.forEach(["primitive", "intrinsic", "read", "arrow", "constructor", "function", "method", "eval", "write", "sequence", "conditional", "throw", "unary", "binary", "object", "construct", "apply"], type => {
...
const extract_intrinsic_name_expression_callback_object = {
  __proto__: null_expression_callback_object,
  intrinsic: (context, node, intrinsic) => intrinsic
};
...
const apply = (visit, expression1, expression2, expressions, _call, _nullable_identifier) => Tree._dispatch_expression(extract_intrinsic_name_expression_callback_object, null, expression1) === "Array.of" && Tree._dispatch_expression(is_primitive_expression_callback_object, void 0, expression2) ? {
  type: "ArrayExpression",
  elements: ArrayLite.map(expressions, visit)
} : (_call = Tree._dispatch_expression(extract_call_expression_callback_object, null, expression1), _call !== null && Tree._dispatch_expression(extract_intrinsic_name_expression_callback_object, null, _call.callee) === "Reflect.get" && Tree._dispatch_expression(is_primitive_expression_callback_object, void 0, _call.this) && _call.arguments.length === 2 && Tree._dispatch_expression(extract_read_identifier_expression_callback_object, null, _call.arguments[0]) === "advice" && Tree._dispatch_expression(extract_read_identifier_expression_callback_object, null, expression2) === "advice" ? {
  type: "CallExpression",
  optional: false,
  callee: {
      ...
      "body": [{
        ...
        "expression": {
          ...
          "properties": [{
            ...
            "key": {
              "type": "Literal",
              "value": "#globalLexicalFrame",
              "raw": "\"#globalLexicalFrame\""
            },
            "value": {
              "type": "ObjectExpression",
              "properties": [{
            ...
            "key": {
              "type": "Literal",
              "value": "#globalVariableNames",
              "raw": "\"#globalVariableNames\""
            },
            "value": {
              "type": "ArrayExpression",
              "elements": []
...
global_Reflect_defineProperty(prototype, "weave", {
  __proto__: null,
  configurable: true,
  value: function weave(estree, pointcut, context, _nullable_scope, _serials, _closure) {
    return (context = context === null || context === void 0 ? {
      __proto__: null,
      mode: "script"
      ...
      mode: "local-eval",
      serial: context
    } : typeof context === "object" && context !== null ? context : signal("The context should either be null/undefined (for 'script' mode), a string (for 'script' mode or 'global-eval' mode), a number (for 'local-eval' mode), or an object"), context.mode !== "script" && context.mode !== "global-eval" && context.mode !== "local-eval" ? signal("The mode should either be 'script', 'global-eval', or 'local-eval'") : null, context.mode === "local-eval" ? typeof context.serial !== "number" ? signal("In 'local-eval' mode, the serial should be a number") : context.serial !== context.serial ? signal("In 'local-eval' mode, the serial should not be NaN") : global_Math_round(context.serial) !== context.serial ? signal("In 'local-eval' mode, the serial should be an integer") : context.serial < 0 ? signal("In 'local-eval' mode, the serial should be a positive integer") : !global_Reflect_getOwnPropertyDescriptor(this.scopes, context.serial) ? signal("In 'local-eval' mode, the serial should refer to a node representing a direct eval call") : null : null, pointcut = global_Array_isArray(pointcut) ? ArrayLite.reduce(pointcut, (object, name) => (object[name] = true, object), {
      __proto__: null
      ...
      __proto__: null
    }) : typeof pointcut === "object" && pointcut !== null ? pointcut : signal("The pointcut must be either an array, a closure, a boolean, or an object"), _serials = new global_Map(), Generate(Instrument(Normalize(estree, context, {
      __proto__: null,
      nodes: this.nodes,
      scopes: this.scopes,
      serials: _serials
