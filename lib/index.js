...
const unmangle_instrument_options = {
  ...
  identifier: (identifier, _type) => (_type = Identifier._is_meta(identifier) ? 'deadzone' : Identifier._is_base(identifier) ? Identifier._is_meta(Identifier._get_body(identifier)) ? 'meta' : 'base' : 'input', {
    __proto__: null,
    raw: identifier,
    type: _type,
    name: _type === 'input' ? null : Identifier._get_body(Identifier._get_body(identifier))
  })
};
