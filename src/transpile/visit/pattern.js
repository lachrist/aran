...
const empty = (surrounding) => (
  surrounding === "statement" ?
  Tree.ListStatement([]) :
  Tree.PrimitiveExpression(void 0));

const lift = (surrounding, aran_node) => (
  surrounding === "statement" ?
  Tree.ExpressionStatement(aran_node) :
  aran_node);

const sequence = (surrounding, aran_node_1, aran_node_2) => (
  surrounding === "statement" ?
...
const boxify = (surrounding, scope, writable, identifier, expression, callback) => Scope[surrounding === "statement" ? "makeBoxStatement" : "makeBoxExpression"](
  scope,
  writable,
  identifier,
  expression,
