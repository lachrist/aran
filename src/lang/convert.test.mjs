...
// );
// assertDeepEqual(
//   parseExpression("123n"),
//   makePrimitiveExpression({bigint: "123"}),
// );
//
...
//   makeWhileStatement(makePrimitiveExpression(123), makeBlock(["foo"], [], [])),
// );
//
// assertDeepEqual(
//   parseStatement(
...
// );
//
// assertDeepEqual(parseLink("export { foo };"), makeExportLink("foo"));
// assertDeepEqual(
//   parseLink("export { _ as function };"),
...
//
// assertDeepEqual(
//   parseProgram("module; import 'source'; { debugger; }"),
//   makeModuleProgram(
//     [makeImportLink("'source'", null)],
