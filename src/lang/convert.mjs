...
const convertParameter = partialxx__(
  dispatchObjectNode0,
  {
    __proto__: null,
    Identifier: (node) => {
...
export const convertProgram = partialxx_(
  dispatchObjectNode0,
  {
    __proto__: null,
    Program: (node) => {
...
export const convertLink = partialxx_(
  dispatchObjectNode0,
  {
    __proto__: null,
...
export const convertBlock = partialxx__(
  dispatchObjectNode1,
  {
    __proto__: null,
...
export const convertStatement = partialxx_(
  dispatchObjectNode0,
  {
    __proto__: null,
    BlockStatement: (node) => {
...
export const convertEffect = partialxx_(
  dispatchObjectNode0,
  {
    __proto__: null,
...
export const convertExpression = partialxx_(
  dispatchObjectNode0,
  {
    __proto__: null,
    Literal: (node) => {
