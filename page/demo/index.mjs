...
document$1.getElementById("clear").addEventListener("click", (_event) => {
  log.textContent = "";
});
...
const analysis_select = document$1.getElementById("analysis-select");
