...
[demo/dead/apply](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/dead-apply-factorial.html) demonstrates these concepts.
...
This is the case for [instrument/apply-regular-api.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-apply-regular-api-factorial.html) which performs the same analysis as [demo/dead/apply](demo/dead/apply).
...
This simpler API is demonstrated at [demo/live/instrument/apply-live-api.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-apply-live-api-factorial.html).

## Demonstrators

* [demo/live/instrument/empty.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-empty-empty.html): Do nothing.
  Empty advice.
  Can be used to inspect how Aran desugars JavaScript.
* [demo/live/instrument/forward.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-forward-empty.html):
...
* [demo/live/instrument/sandbox.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-sandbox-global.html):
  Demonstrate sandboxing by restricting access to `Date`.
* [demo/live/instrument/eval.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-eval-dynamic.html):
...
* [demo/live/instrument/shadow-value.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-shadow-value-delta.html):
  Track program values across the value stack and the environment but not the store (the shadow value way).
* [demo/local/instrument/shadow-state.js](https://cdn.rawgit.com/lachrist/aran/40e658af/demo/output/live-shadow-state-delta.html):
