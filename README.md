...
[demo/remote/apply](https://cdn.rawgit.com/lachrist/aran/02322862/demo/output/remote-apply-factorial.html) demonstrates these concepts.
...
As shown in [demo/local/apply](https://cdn.rawgit.com/lachrist/aran/02322862/demo/output/local-apply-factorial.html), Aran can also be used to perform *local* instrumentation -- i.e.: the instrumentation is performed on the process that also evaluates the instrumented code.
...
* [demo/local/sandbox](https://cdn.rawgit.com/lachrist/aran/02322862/demo/output/local-sandbox-global.html):
...
* [demo/local/eval](https://cdn.rawgit.com/lachrist/aran/02322862/demo/output/local-eval-dynamic.html):
...
* [demo/local/shadow-value](https://cdn.rawgit.com/lachrist/aran/02322862/demo/output/local-shadow-value-delta.html):
  Track program values across the value stack and the environment but not the store (the shadow value way).
* [demo/local/shadow-state](https://cdn.rawgit.com/lachrist/aran/02322862/demo/output/local-shadow-state-delta.html):
